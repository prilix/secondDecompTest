...
public class ExpandableLayout extends FrameLayout {
    ...
    public ExpandableLayout(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C2975R.styleable.ExpandableLayout);
            this.duration = obtainStyledAttributes.getInt(C2975R.styleable.ExpandableLayout_el_duration, 300);
            int i = 0;
            this.expansion = obtainStyledAttributes.getBoolean(C2975R.styleable.ExpandableLayout_el_expanded, false) ? 1.0f : 0.0f;
            this.orientation = obtainStyledAttributes.getInt(C2975R.styleable.ExpandableLayout_android_orientation, 1);
            this.parallax = obtainStyledAttributes.getFloat(C2975R.styleable.ExpandableLayout_el_parallax, 1.0f);
