...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        ...
        if (Intrinsics.areEqual((Object) Constants.HttpMethods.GET, (Object) request.method())) {
    ...
    public synchronized void onReadPing(okio.ByteString r2) {
        ...
        L_0x0029:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p018ws.RealWebSocket.onReadPing(okio.ByteString):void");
    }
    ...
    private final synchronized boolean send(okio.ByteString r7, int r8) {
        ...
        L_0x003e:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p018ws.RealWebSocket.send(okio.ByteString, int):boolean");
    }
    ...
    public final synchronized boolean close(int r9, java.lang.String r10, long r11) {
        /*
            r8 = this;
            monitor-enter(r8)
            okhttp3.internal.ws.WebSocketProtocol r0 = okhttp3.internal.p018ws.WebSocketProtocol.INSTANCE     // Catch:{ all -> 0x005e }
            r0.validateCloseCode(r9)     // Catch:{ all -> 0x005e }
            r0 = 0
            r1 = r0
            ...
            okio.ByteString r0 = r0.encodeUtf8(r10)     // Catch:{ all -> 0x005e }
        ...
        L_0x0022:
            ...
            goto L_0x0042
        L_0x0025:
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ all -> 0x005e }
            r9.<init>()     // Catch:{ all -> 0x005e }
            java.lang.String r11 = "reason.size() > 123: "
            r9.append(r11)     // Catch:{ all -> 0x005e }
            r9.append(r10)     // Catch:{ all -> 0x005e }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x005e }
            java.lang.IllegalArgumentException r10 = new java.lang.IllegalArgumentException     // Catch:{ all -> 0x005e }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x005e }
            r10.<init>(r9)     // Catch:{ all -> 0x005e }
            java.lang.Throwable r10 = (java.lang.Throwable) r10     // Catch:{ all -> 0x005e }
            throw r10     // Catch:{ all -> 0x005e }
        L_0x0042:
            boolean r10 = r8.failed     // Catch:{ all -> 0x005e }
            if (r10 != 0) goto L_0x005c
            boolean r10 = r8.enqueuedClose     // Catch:{ all -> 0x005e }
            if (r10 == 0) goto L_0x004b
            goto L_0x005c
        L_0x004b:
            r8.enqueuedClose = r2     // Catch:{ all -> 0x005e }
            java.util.ArrayDeque<java.lang.Object> r10 = r8.messageAndCloseQueue     // Catch:{ all -> 0x005e }
            okhttp3.internal.ws.RealWebSocket$Close r1 = new okhttp3.internal.ws.RealWebSocket$Close     // Catch:{ all -> 0x005e }
            r1.<init>(r9, r0, r11)     // Catch:{ all -> 0x005e }
            r10.add(r1)     // Catch:{ all -> 0x005e }
            r8.runWriter()     // Catch:{ all -> 0x005e }
            monitor-exit(r8)
            return r2
        L_0x005c:
            monitor-exit(r8)
        ...
        L_0x005e:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p018ws.RealWebSocket.close(int, java.lang.String, long):boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x0079, code lost:
        if ((r0 instanceof okhttp3.internal.p018ws.RealWebSocket.Message) == false) goto L_0x00b2;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x007b, code lost:
        r2 = ((okhttp3.internal.p018ws.RealWebSocket.Message) r0).getData();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:44:0x0087, code lost:
        r0 = okio.Okio.buffer(r1.newMessageSink(((okhttp3.internal.p018ws.RealWebSocket.Message) r0).getFormatOpcode(), (long) r2.size()));
        r0.write(r2);
        r0.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x00b4, code lost:
        if ((r0 instanceof okhttp3.internal.p018ws.RealWebSocket.Close) == false) goto L_0x00e0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:56:0x00b6, code lost:
        r0 = (okhttp3.internal.p018ws.RealWebSocket.Close) r0;
     */
    ...
    public final boolean writeOneFrame$okhttp() throws java.io.IOException {
        /*
            ...
            r1 = r0
            okhttp3.internal.ws.RealWebSocket$Streams r1 = (okhttp3.internal.p018ws.RealWebSocket.Streams) r1
            monitor-enter(r11)
        ...
        L_0x000f:
            ...
            boolean r6 = r5 instanceof okhttp3.internal.p018ws.RealWebSocket.Close     // Catch:{ all -> 0x00f1 }
            ...
            r7 = r0
            okhttp3.internal.ws.RealWebSocket$Streams r7 = (okhttp3.internal.p018ws.RealWebSocket.Streams) r7     // Catch:{ all -> 0x00f1 }
        ...
        L_0x0046:
            ...
            r8 = r5
            okhttp3.internal.ws.RealWebSocket$Close r8 = (okhttp3.internal.p018ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00f1 }
        ...
        L_0x0073:
            ...
            goto L_0x00d7
        L_0x0077:
            boolean r3 = r0 instanceof okhttp3.internal.p018ws.RealWebSocket.Message     // Catch:{ all -> 0x00e8 }
            if (r3 == 0) goto L_0x00b2
            r2 = r0
            okhttp3.internal.ws.RealWebSocket$Message r2 = (okhttp3.internal.p018ws.RealWebSocket.Message) r2     // Catch:{ all -> 0x00e8 }
            okio.ByteString r2 = r2.getData()     // Catch:{ all -> 0x00e8 }
            if (r1 != 0) goto L_0x0087
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x00e8 }
        L_0x0087:
            okhttp3.internal.ws.RealWebSocket$Message r0 = (okhttp3.internal.p018ws.RealWebSocket.Message) r0     // Catch:{ all -> 0x00e8 }
        ...
        L_0x00b2:
            boolean r3 = r0 instanceof okhttp3.internal.p018ws.RealWebSocket.Close     // Catch:{ all -> 0x00e8 }
            if (r3 == 0) goto L_0x00e0
            okhttp3.internal.ws.RealWebSocket$Close r0 = (okhttp3.internal.p018ws.RealWebSocket.Close) r0     // Catch:{ all -> 0x00e8 }
        ...
        L_0x00f1:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p018ws.RealWebSocket.writeOneFrame$okhttp():boolean");
    }

    @Metadata(mo36736bv = {1, 0, 3}, mo36737d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, mo36738d2 = {"Lokhttp3/internal/ws/RealWebSocket$PingRunnable;", "Ljava/lang/Runnable;", "(Lokhttp3/internal/ws/RealWebSocket;)V", "run", "", "okhttp"}, mo36739k = 1, mo36740mv = {1, 1, 15})
    ...
    public final void writePingFrame$okhttp() {
        ...
        L_0x005e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p018ws.RealWebSocket.writePingFrame$okhttp():void");
    }
    ...
    public final void failWebSocket(java.lang.Exception r4, okhttp3.Response r5) {
        ...
        L_0x000c:
            ...
            r1 = 0
            r2 = r1
            okhttp3.internal.ws.RealWebSocket$Streams r2 = (okhttp3.internal.p018ws.RealWebSocket.Streams) r2     // Catch:{ all -> 0x0044 }
        ...
        L_0x0044:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p018ws.RealWebSocket.failWebSocket(java.lang.Exception, okhttp3.Response):void");
    }

    @Metadata(mo36736bv = {1, 0, 3}, mo36737d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0000\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u000b"}, mo36738d2 = {"Lokhttp3/internal/ws/RealWebSocket$Message;", "", "formatOpcode", "", "data", "Lokio/ByteString;", "(ILokio/ByteString;)V", "getData", "()Lokio/ByteString;", "getFormatOpcode", "()I", "okhttp"}, mo36739k = 1, mo36740mv = {1, 1, 15})
    ...
    @Metadata(mo36736bv = {1, 0, 3}, mo36737d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\b\b\u0000\u0018\u00002\u00020\u0001B\u001f\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bR\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0013\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e¨\u0006\u000f"}, mo36738d2 = {"Lokhttp3/internal/ws/RealWebSocket$Close;", "", "code", "", "reason", "Lokio/ByteString;", "cancelAfterCloseMillis", "", "(ILokio/ByteString;J)V", "getCancelAfterCloseMillis", "()J", "getCode", "()I", "getReason", "()Lokio/ByteString;", "okhttp"}, mo36739k = 1, mo36740mv = {1, 1, 15})
    ...
    @Metadata(mo36736bv = {1, 0, 3}, mo36737d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\b\b&\u0018\u00002\u00020\u0001B\u001d\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e¨\u0006\u000f"}, mo36738d2 = {"Lokhttp3/internal/ws/RealWebSocket$Streams;", "Ljava/io/Closeable;", "client", "", "source", "Lokio/BufferedSource;", "sink", "Lokio/BufferedSink;", "(ZLokio/BufferedSource;Lokio/BufferedSink;)V", "getClient", "()Z", "getSink", "()Lokio/BufferedSink;", "getSource", "()Lokio/BufferedSource;", "okhttp"}, mo36739k = 1, mo36740mv = {1, 1, 15})
    ...
    @Metadata(mo36736bv = {1, 0, 3}, mo36737d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, mo36738d2 = {"Lokhttp3/internal/ws/RealWebSocket$CancelRunnable;", "Ljava/lang/Runnable;", "(Lokhttp3/internal/ws/RealWebSocket;)V", "run", "", "okhttp"}, mo36739k = 1, mo36740mv = {1, 1, 15})
    ...
    @Metadata(mo36736bv = {1, 0, 3}, mo36737d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u0007X\u0004¢\u0006\u0002\n\u0000¨\u0006\t"}, mo36738d2 = {"Lokhttp3/internal/ws/RealWebSocket$Companion;", "", "()V", "CANCEL_AFTER_CLOSE_MILLIS", "", "MAX_QUEUE_SIZE", "ONLY_HTTP1", "", "Lokhttp3/Protocol;", "okhttp"}, mo36739k = 1, mo36740mv = {1, 1, 15})
