...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r9) throws java.io.IOException {
        ...
        L_0x0016:
            ...
            okhttp3.Response r0 = r9.proceed(r0, r1, r2)     // Catch:{ RouteException -> 0x00ba, IOException -> 0x00a8 }
        ...
        L_0x00a8:
            r6 = move-exception
            boolean r7 = r6 instanceof okhttp3.internal.http2.ConnectionShutdownException     // Catch:{ all -> 0x00a6 }
        ...
        L_0x00af:
            r7 = 0
        L_0x00b0:
            boolean r7 = r8.recover(r6, r1, r7, r0)     // Catch:{ all -> 0x00a6 }
            if (r7 == 0) goto L_0x00b7
            goto L_0x00c5
        L_0x00b7:
            java.lang.Throwable r6 = (java.lang.Throwable) r6     // Catch:{ all -> 0x00a6 }
            throw r6     // Catch:{ all -> 0x00a6 }
        L_0x00ba:
            r6 = move-exception
            java.io.IOException r7 = r6.getLastConnectException()     // Catch:{ all -> 0x00a6 }
            boolean r7 = r8.recover(r7, r1, r3, r0)     // Catch:{ all -> 0x00a6 }
            if (r7 == 0) goto L_0x00ca
        L_0x00c5:
            r1.exchangeDoneDueToException()
            goto L_0x0016
        L_0x00ca:
            java.io.IOException r9 = r6.getFirstConnectException()     // Catch:{ all -> 0x00a6 }
            java.lang.Throwable r9 = (java.lang.Throwable) r9     // Catch:{ all -> 0x00a6 }
    ...
    private final Request followUpRequest(Response response, Route route) throws IOException {
        ...
        if (code == 307 || code == 308) {
            if (!(!Intrinsics.areEqual((Object) method, (Object) Constants.HttpMethods.GET)) || !(!Intrinsics.areEqual((Object) method, (Object) "HEAD"))) {
    ...
    private final Request buildRedirectRequest(Response response, String str) {
        ...
        if (HttpMethod.permitsRequestBody(str)) {
            ...
            if (HttpMethod.INSTANCE.redirectsToGet(str)) {
                newBuilder.method(Constants.HttpMethods.GET, (RequestBody) null);
            } else {
            ...
            if (!redirectsWithBody) {
                ...
                newBuilder.removeHeader(Constants.NetworkParams.CONTENT_TYPE);
            }
        }
    ...
    @Metadata(mo36736bv = {1, 0, 3}, mo36737d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo36738d2 = {"Lokhttp3/internal/http/RetryAndFollowUpInterceptor$Companion;", "", "()V", "MAX_FOLLOW_UPS", "", "okhttp"}, mo36739k = 1, mo36740mv = {1, 1, 15})
    /* compiled from: RetryAndFollowUpInterceptor.kt */
