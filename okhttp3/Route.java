...
public final class Route {
    ...
    public final Address m3152deprecated_address() {
        return this.address;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "proxy", imports = {}))
    /* renamed from: -deprecated_proxy  reason: not valid java name */
    public final Proxy m3153deprecated_proxy() {
        return this.proxy;
    }
    ...
    public final InetSocketAddress m3154deprecated_socketAddress() {
        return this.socketAddress;
    }
    ...
    public int hashCode() {
        return ((((C1662R2.attr.flow_firstVerticalBias + this.address.hashCode()) * 31) + this.proxy.hashCode()) * 31) + this.socketAddress.hashCode();
    }
