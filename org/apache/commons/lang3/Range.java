...
public final class Range<T> implements Serializable {
    ...
    /* renamed from: is */
    public static <T extends Comparable<T>> Range<T> m733is(T t) {
        return between(t, t, (Comparator) null);
    }

    /* renamed from: is */
    public static <T> Range<T> m734is(T t, Comparator<T> comparator2) {
    ...
    public int hashCode() {
        ...
        int hashCode2 = ((((C1662R2.attr.itemIconTint + getClass().hashCode()) * 37) + this.minimum.hashCode()) * 37) + this.maximum.hashCode();
