...
public class EntityArrays {
    ...
    static {
        ...
        String[][] strArr2 = new String[C1662R2.attr.behavior_draggable][];
        ...
        String[][] strArr5 = {new String[]{"\b", "\\b"}, new String[]{StringUtils.f715LF, "\\n"}, new String[]{"\t", "\\t"}, new String[]{"\f", "\\f"}, new String[]{StringUtils.f714CR, "\\r"}};
