...
public class NumberUtils {
    ...
    public static final Double DOUBLE_ZERO = Double.valueOf(C1030Utils.DOUBLE_EPSILON);
    ...
    public static double toDouble(String str) {
        return toDouble(str, (double) C1030Utils.DOUBLE_EPSILON);
    }
    ...
    public static double toDouble(BigDecimal bigDecimal) {
        return toDouble(bigDecimal, (double) C1030Utils.DOUBLE_EPSILON);
    }
    ...
    public static BigInteger createBigInteger(String str) {
        ...
        if (str.startsWith("0x", startsWith ? 1 : 0) || str.startsWith("0X", startsWith)) {
            ...
            i = startsWith + true;
        } else if (!str.startsWith(StatusCode.BUILTIN_WIRELESS, startsWith) || str.length() <= (i2 = startsWith + true)) {
            i = startsWith;
            i3 = 10;
        } else {
            i = i2;
