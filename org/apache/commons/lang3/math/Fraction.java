...
public final class Fraction extends Number implements Comparable<Fraction> {
    ...
    public static Fraction getFraction(double d) {
        int i;
        int i2;
        int i3 = d < C1030Utils.DOUBLE_EPSILON ? -1 : 1;
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = ((getNumerator() + C1662R2.attr.itemIconTint) * 37) + getDenominator();
        }
    ...
    public String toProperString() {
        if (this.toProperString == null) {
            int i = this.numerator;
            if (i == 0) {
                this.toProperString = StatusCode.BUILTIN_WIRELESS;
            } else {
