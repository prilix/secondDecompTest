...
public abstract class WebSocketServer extends AbstractWebSocket implements Runnable {
    ...
    public static final Logger log = LoggerFactory.getLogger((Class<?>) WebSocketServer.class);
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:49:0x0081 */
    /* JADX WARNING: Removed duplicated region for block: B:49:0x0081 A[EDGE_INSN: B:49:0x0081->B:50:? ?: BREAK  , PHI: r0 r2 
      PHI: (r0v8 int) = (r0v3 int), (r0v9 int), (r0v9 int), (r0v9 int), (r0v9 int) binds: [B:13:0x001c, B:24:0x0043, B:46:0x007b, B:47:?, B:28:0x004f] A[DONT_GENERATE, DONT_INLINE]
      PHI: (r2v4 int) = (r2v1 int), (r2v5 int), (r2v5 int), (r2v5 int), (r2v5 int) binds: [B:13:0x001c, B:24:0x0043, B:46:0x007b, B:47:?, B:28:0x004f] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC, Splitter:B:49:0x0081] */
    /* JADX WARNING: Removed duplicated region for block: B:54:0x008d A[Catch:{ RuntimeException -> 0x009b, all -> 0x0099 }] */
    /* JADX WARNING: Removed duplicated region for block: B:57:? A[ExcHandler: ClosedByInterruptException (unused java.nio.channels.ClosedByInterruptException), SYNTHETIC, Splitter:B:13:0x001c] */
    /* JADX WARNING: Removed duplicated region for block: B:8:? A[ExcHandler: CancelledKeyException (unused java.nio.channels.CancelledKeyException), PHI: r0 r2 
      PHI: (r0v11 int) = (r0v3 int), (r0v9 int), (r0v9 int), (r0v9 int), (r0v9 int) binds: [B:13:0x001c, B:24:0x0043, B:46:0x007b, B:47:?, B:28:0x004f] A[DONT_GENERATE, DONT_INLINE]
      PHI: (r2v7 int) = (r2v1 int), (r2v5 int), (r2v5 int), (r2v5 int), (r2v5 int) binds: [B:13:0x001c, B:24:0x0043, B:46:0x007b, B:47:?, B:28:0x004f] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC, Splitter:B:13:0x001c] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void run() {
        /*
            r7 = this;
        ...
        L_0x0011:
            r3 = 0
            java.lang.Thread r4 = r7.selectorthread     // Catch:{ RuntimeException -> 0x009b }
            boolean r4 = r4.isInterrupted()     // Catch:{ RuntimeException -> 0x009b }
            if (r4 != 0) goto L_0x009f
            if (r2 == 0) goto L_0x009f
            java.util.concurrent.atomic.AtomicBoolean r4 = r7.isclosed     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0089, InterruptedException -> 0x0081 }
            boolean r4 = r4.get()     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0089, InterruptedException -> 0x0081 }
            if (r4 == 0) goto L_0x0025
            r0 = 5
        L_0x0025:
            java.nio.channels.Selector r4 = r7.selector     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0089, InterruptedException -> 0x0081 }
            long r5 = (long) r0     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0089, InterruptedException -> 0x0081 }
            int r4 = r4.select(r5)     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0089, InterruptedException -> 0x0081 }
        ...
        L_0x0038:
            java.nio.channels.Selector r4 = r7.selector     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0089, InterruptedException -> 0x0081 }
            java.util.Set r4 = r4.selectedKeys()     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0089, InterruptedException -> 0x0081 }
            java.util.Iterator r4 = r4.iterator()     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0089, InterruptedException -> 0x0081 }
            r5 = r3
        L_0x0043:
            boolean r6 = r4.hasNext()     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x007f, InterruptedException -> 0x0081 }
            if (r6 == 0) goto L_0x007b
            java.lang.Object r6 = r4.next()     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x007f, InterruptedException -> 0x0081 }
            java.nio.channels.SelectionKey r6 = (java.nio.channels.SelectionKey) r6     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x007f, InterruptedException -> 0x0081 }
            boolean r5 = r6.isValid()     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0078, InterruptedException -> 0x0081 }
            if (r5 != 0) goto L_0x0056
            goto L_0x0076
        L_0x0056:
            boolean r5 = r6.isAcceptable()     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0078, InterruptedException -> 0x0081 }
            if (r5 == 0) goto L_0x0060
            r7.doAccept(r6, r4)     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0078, InterruptedException -> 0x0081 }
            goto L_0x0076
        L_0x0060:
            boolean r5 = r6.isReadable()     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0078, InterruptedException -> 0x0081 }
            if (r5 == 0) goto L_0x006d
            boolean r5 = r7.doRead(r6, r4)     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0078, InterruptedException -> 0x0081 }
            if (r5 != 0) goto L_0x006d
            goto L_0x0076
        L_0x006d:
            boolean r5 = r6.isWritable()     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0078, InterruptedException -> 0x0081 }
            if (r5 == 0) goto L_0x0076
            r7.doWrite(r6)     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x0078, InterruptedException -> 0x0081 }
        L_0x0076:
            r5 = r6
            goto L_0x0043
        L_0x0078:
            ...
            goto L_0x008b
        L_0x007b:
            r7.doAdditionalRead()     // Catch:{ CancelledKeyException -> 0x0011, ClosedByInterruptException -> 0x0095, IOException -> 0x007f, InterruptedException -> 0x0081 }
            goto L_0x0011
        L_0x007f:
            r4 = move-exception
            goto L_0x008b
        L_0x0081:
            java.lang.Thread r4 = java.lang.Thread.currentThread()     // Catch:{ RuntimeException -> 0x009b }
            r4.interrupt()     // Catch:{ RuntimeException -> 0x009b }
            goto L_0x0011
        L_0x0089:
            r4 = move-exception
            r5 = r3
        L_0x008b:
            ...
            r5.cancel()     // Catch:{ RuntimeException -> 0x009b }
        L_0x0090:
            r7.handleIOException(r5, r3, r4)     // Catch:{ RuntimeException -> 0x009b }
            goto L_0x0011
        L_0x0095:
            r7.doServerShutdown()
            return
        ...
        L_0x009b:
            r0 = move-exception
            r7.handleFatal(r3, r0)     // Catch:{ all -> 0x0099 }
        L_0x009f:
            r7.doServerShutdown()
            return
        L_0x00a3:
    ...
    public boolean removeConnection(WebSocket webSocket) {
        ...
        synchronized (this.connections) {
            if (this.connections.contains(webSocket)) {
                ...
                log.trace("Removing connection which is not in the connections collection! Possible no handshake recieved! {}", (Object) webSocket);
                z = false;
            }
        }
    ...
    private void doBroadcast(Object obj, Collection<WebSocket> collection) {
        ...
        if (str != null || byteBuffer != null) {
            ...
            for (WebSocket next : collection) {
                if (next != null) {
                    Draft draft = next.getDraft();
                    fillFrames(draft, hashMap, str, byteBuffer);
                    try {
                        next.sendFrame((Collection<Framedata>) (Collection) hashMap.get(draft));
        ...
        public WebSocketWorker() {
            ...
            setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler(WebSocketServer.this) {
                public void uncaughtException(Thread thread, Throwable th) {
                    WebSocketServer.log.error("Uncaught exception in thread {}: {}", (Object) thread.getName(), (Object) th);
                }
            });
        }
