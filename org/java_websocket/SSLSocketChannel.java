...
public class SSLSocketChannel implements WrappedByteChannel, ByteChannel {
    ...
    public synchronized int read(ByteBuffer byteBuffer) throws IOException {
        ...
        if (this.peerNetData.hasRemaining()) {
            ...
            try {
                ...
                int i = C30351.$SwitchMap$javax$net$ssl$SSLEngineResult$Status[unwrap.getStatus().ordinal()];
                if (i == 1) {
                    this.peerAppData.flip();
                    return ByteBufferUtils.transferByteBuffer(this.peerAppData, byteBuffer);
                } else if (i == 2) {
    ...
    public synchronized int write(ByteBuffer byteBuffer) throws IOException {
        ...
        while (byteBuffer.hasRemaining()) {
            ...
            int i2 = C30351.$SwitchMap$javax$net$ssl$SSLEngineResult$Status[wrap.getStatus().ordinal()];
            if (i2 == 1) {
                this.myNetData.flip();
    ...
    private boolean doHandshake() throws IOException {
        ...
        boolean z = false;
        while (!z) {
            int i = C30351.$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[handshakeStatus2.ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i == 3) {
                        this.myNetData.clear();
                    ...
                    try {
                        ...
                        int i3 = C30351.$SwitchMap$javax$net$ssl$SSLEngineResult$Status[unwrap.getStatus().ordinal()];
                        if (i3 != 1) {
                            if (i3 == 2) {
    ...
    static /* synthetic */ class C30351 {
        ...
        static {
            ...
            L_0x006d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.java_websocket.SSLSocketChannel.C30351.<clinit>():void");
        }
    }
