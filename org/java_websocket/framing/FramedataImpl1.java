...
public abstract class FramedataImpl1 implements Framedata {
    ...
    /* renamed from: org.java_websocket.framing.FramedataImpl1$1 */
    static /* synthetic */ class C30361 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.java_websocket.framing.FramedataImpl1.C30361.<clinit>():void");
        }
    }

    public static FramedataImpl1 get(Opcode opcode) {
        if (opcode != null) {
            switch (C30361.$SwitchMap$org$java_websocket$enums$Opcode[opcode.ordinal()]) {
                case 1:
