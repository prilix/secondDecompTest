...
public class Base64 {
    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public void write(int i) throws IOException {
            if (this.suspendEncoding) {
                ...
                if (i3 >= this.bufferLength) {
                    this.out.write(Base64.encode3to4(this.f727b4, this.buffer, this.bufferLength, this.options));
                ...
                if (bArr2[i5] > -5) {
                    ...
                    if (i7 >= this.bufferLength) {
                        this.out.write(this.f727b4, 0, Base64.decode4to3(bArr3, 0, this.f727b4, 0, this.options));
                        this.position = 0;
                    }
                } else if (bArr2[i5] != -5) {
        ...
        public void flushBase64() throws IOException {
            ...
            if (this.encode) {
                this.out.write(Base64.encode3to4(this.f727b4, this.buffer, this.position, this.options));
                this.position = 0;
                return;
            }
