...
final class GifViewUtils {
    ...
    static float getDensityScale(Resources resources, int i) {
        ...
        if (i2 == 0) {
            i2 = C1662R2.attr.behavior_skipCollapsed;
        } else if (i2 == 65535) {
            i2 = 0;
        }
    ...
    static class GifViewAttributes {
        ...
        GifViewAttributes(View view, AttributeSet attributeSet, int i, int i2) {
            TypedArray obtainStyledAttributes = view.getContext().obtainStyledAttributes(attributeSet, C3050R.styleable.GifView, i, i2);
            this.freezesAnimation = obtainStyledAttributes.getBoolean(C3050R.styleable.GifView_freezesAnimation, false);
            this.mLoopCount = obtainStyledAttributes.getInt(C3050R.styleable.GifView_loopCount, -1);
