...
import p019pl.droidsonroids.gif.GifViewUtils;
import p019pl.droidsonroids.gif.InputSource;
...
public class GifTextureView extends TextureView {
    ...
    private void init(AttributeSet attributeSet, int i, int i2) {
        if (attributeSet != null) {
            ...
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C3050R.styleable.GifTextureView, i, i2);
            this.mInputSource = findSource(obtainStyledAttributes);
            super.setOpaque(obtainStyledAttributes.getBoolean(C3050R.styleable.GifTextureView_isOpaque, false));
    ...
    private static InputSource findSource(TypedArray typedArray) {
        ...
        if (!typedArray.getValue(C3050R.styleable.GifTextureView_gifSource, typedValue)) {
            return null;
        }
    ...
    public void updateTextureViewSize(GifInfoHandle gifInfoHandle) {
        ...
        float f = 1.0f;
        switch (C30461.$SwitchMap$android$widget$ImageView$ScaleType[this.mScaleType.ordinal()]) {
            case 1:
    ...
    static /* synthetic */ class C30461 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p019pl.droidsonroids.gif.GifTextureView.C30461.<clinit>():void");
        }
    }
