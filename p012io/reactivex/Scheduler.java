...
import p012io.reactivex.internal.schedulers.NewThreadWorker;
import p012io.reactivex.internal.schedulers.SchedulerWhen;
import p012io.reactivex.internal.util.ExceptionHelper;
import p012io.reactivex.plugins.RxJavaPlugins;
import p012io.reactivex.schedulers.SchedulerRunnableIntrospection;
        ...
        final class PeriodicTask implements Runnable, SchedulerRunnableIntrospection {
            ...
            public void run() {
                ...
                if (!this.f499sd.isDisposed()) {
                    ...
                    this.f499sd.replace(Worker.this.schedule(this, j - now, TimeUnit.NANOSECONDS));
                }
            }
