...
import p012io.reactivex.internal.disposables.ArrayCompositeDisposable;
                ...
                while (!this.cancelled) {
                    ...
                    if (!z || (th2 = equalObserver.error) == null) {
                        ...
                        if (!z2 || (th = equalObserver2.error) == null) {
                            if (this.f569v1 == null) {
                                this.f569v1 = spscLinkedArrayQueue.poll();
                            }
                            boolean z3 = this.f569v1 == null;
                            if (this.f570v2 == null) {
                                this.f570v2 = spscLinkedArrayQueue2.poll();
                            }
                            T t = this.f570v2;
                            boolean z4 = t == null;
                            if (z && z2 && z3 && z4) {
                                ...
                                if (!z3 && !z4) {
                                    try {
                                        if (!this.comparer.test(this.f569v1, t)) {
