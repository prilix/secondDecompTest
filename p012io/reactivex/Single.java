...
import p012io.reactivex.internal.observers.BiConsumerSingleObserver;
import p012io.reactivex.internal.observers.BlockingMultiObserver;
import p012io.reactivex.internal.observers.ConsumerSingleObserver;
import p012io.reactivex.internal.observers.FutureSingleObserver;
import p012io.reactivex.internal.operators.completable.CompletableFromSingle;
import p012io.reactivex.internal.operators.completable.CompletableToFlowable;
...
import p012io.reactivex.internal.operators.maybe.MaybeFilterSingle;
import p012io.reactivex.internal.operators.maybe.MaybeFromSingle;
import p012io.reactivex.internal.operators.mixed.SingleFlatMapObservable;
...
import p012io.reactivex.internal.operators.single.SingleAmb;
import p012io.reactivex.internal.operators.single.SingleCache;
import p012io.reactivex.internal.operators.single.SingleContains;
import p012io.reactivex.internal.operators.single.SingleCreate;
import p012io.reactivex.internal.operators.single.SingleDefer;
import p012io.reactivex.internal.operators.single.SingleDelay;
import p012io.reactivex.internal.operators.single.SingleDelayWithCompletable;
import p012io.reactivex.internal.operators.single.SingleDelayWithObservable;
import p012io.reactivex.internal.operators.single.SingleDelayWithPublisher;
import p012io.reactivex.internal.operators.single.SingleDelayWithSingle;
import p012io.reactivex.internal.operators.single.SingleDematerialize;
import p012io.reactivex.internal.operators.single.SingleDetach;
import p012io.reactivex.internal.operators.single.SingleDoAfterSuccess;
import p012io.reactivex.internal.operators.single.SingleDoAfterTerminate;
import p012io.reactivex.internal.operators.single.SingleDoFinally;
import p012io.reactivex.internal.operators.single.SingleDoOnDispose;
import p012io.reactivex.internal.operators.single.SingleDoOnError;
import p012io.reactivex.internal.operators.single.SingleDoOnEvent;
import p012io.reactivex.internal.operators.single.SingleDoOnSubscribe;
import p012io.reactivex.internal.operators.single.SingleDoOnSuccess;
import p012io.reactivex.internal.operators.single.SingleEquals;
import p012io.reactivex.internal.operators.single.SingleError;
import p012io.reactivex.internal.operators.single.SingleFlatMap;
import p012io.reactivex.internal.operators.single.SingleFlatMapCompletable;
import p012io.reactivex.internal.operators.single.SingleFlatMapIterableFlowable;
import p012io.reactivex.internal.operators.single.SingleFlatMapIterableObservable;
import p012io.reactivex.internal.operators.single.SingleFlatMapMaybe;
import p012io.reactivex.internal.operators.single.SingleFlatMapPublisher;
import p012io.reactivex.internal.operators.single.SingleFromCallable;
import p012io.reactivex.internal.operators.single.SingleFromPublisher;
import p012io.reactivex.internal.operators.single.SingleFromUnsafeSource;
import p012io.reactivex.internal.operators.single.SingleHide;
import p012io.reactivex.internal.operators.single.SingleInternalHelper;
import p012io.reactivex.internal.operators.single.SingleJust;
import p012io.reactivex.internal.operators.single.SingleLift;
import p012io.reactivex.internal.operators.single.SingleMap;
import p012io.reactivex.internal.operators.single.SingleMaterialize;
import p012io.reactivex.internal.operators.single.SingleNever;
import p012io.reactivex.internal.operators.single.SingleObserveOn;
import p012io.reactivex.internal.operators.single.SingleOnErrorReturn;
import p012io.reactivex.internal.operators.single.SingleResumeNext;
import p012io.reactivex.internal.operators.single.SingleSubscribeOn;
import p012io.reactivex.internal.operators.single.SingleTakeUntil;
import p012io.reactivex.internal.operators.single.SingleTimeout;
import p012io.reactivex.internal.operators.single.SingleTimer;
import p012io.reactivex.internal.operators.single.SingleToFlowable;
import p012io.reactivex.internal.operators.single.SingleToObservable;
import p012io.reactivex.internal.operators.single.SingleUnsubscribeOn;
import p012io.reactivex.internal.operators.single.SingleUsing;
import p012io.reactivex.internal.operators.single.SingleZipArray;
import p012io.reactivex.internal.operators.single.SingleZipIterable;
...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @SchedulerSupport("none")
    /* renamed from: as */
    public final <R> R mo35115as(SingleConverter<T, ? extends R> singleConverter) {
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R mo35189to(Function<? super Single<T>, R> function) {
        try {
