...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$7 implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C2909x930bd3d8(flowCollector, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        InlineMarker.mark(5);
        InlineMarker.mark(0);
        this.$this_unsafeTransform$inlined.collect(new C2909x930bd3d8(flowCollector, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
