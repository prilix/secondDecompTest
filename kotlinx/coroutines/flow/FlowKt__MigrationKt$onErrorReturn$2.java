...
@DebugMetadata(mo37450c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$onErrorReturn$2", mo37451f = "Migration.kt", mo37452i = {0, 0}, mo37453l = {306}, mo37454m = "invokeSuspend", mo37455n = {"$this$catch", "e"}, mo37456s = {"L$0", "L$1"})
...
final class FlowKt__MigrationKt$onErrorReturn$2 extends SuspendLambda implements Function3<FlowCollector<? super T>, Throwable, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(FlowCollector<? super T> flowCollector, Throwable th, Continuation<? super Unit> continuation) {
        ...
        flowKt__MigrationKt$onErrorReturn$2.f661p$ = flowCollector;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector = this.f661p$;
