...
@DebugMetadata(mo37450c = "kotlinx.coroutines.flow.FlowKt__MergeKt$mapLatest$1", mo37451f = "Merge.kt", mo37452i = {0, 0, 1, 1}, mo37453l = {214, 214}, mo37454m = "invokeSuspend", mo37455n = {"$this$transformLatest", "it", "$this$transformLatest", "it"}, mo37456s = {"L$0", "L$1", "L$0", "L$1"})
...
final class FlowKt__MergeKt$mapLatest$1 extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
        ...
        flowKt__MergeKt$mapLatest$1.f658p$ = flowCollector;
