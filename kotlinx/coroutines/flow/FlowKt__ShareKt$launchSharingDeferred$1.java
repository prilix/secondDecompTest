...
@DebugMetadata(mo37450c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharingDeferred$1", mo37451f = "Share.kt", mo37452i = {0, 0, 0}, mo37453l = {415}, mo37454m = "invokeSuspend", mo37455n = {"$this$launch", "state", "$this$collect$iv"}, mo37456s = {"L$0", "L$1", "L$2"})
...
final class FlowKt__ShareKt$launchSharingDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__ShareKt$launchSharingDeferred$1.f663p$ = (CoroutineScope) obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            CoroutineScope coroutineScope = this.f663p$;
            ...
            this.L$2 = flow;
            this.label = 1;
            if (flow.collect(new C2863x6e5ea3bc(this, coroutineScope, objectRef), this) == coroutine_suspended) {
