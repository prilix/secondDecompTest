...
@DebugMetadata(mo37450c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", mo37451f = "Zip.kt", mo37452i = {0}, mo37453l = {308}, mo37454m = "invokeSuspend", mo37455n = {"$this$flow"}, mo37456s = {"L$0"})
...
public final class FlowKt__ZipKt$combineTransform$7 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__ZipKt$combineTransform$7.f686p$ = (FlowCollector) obj;
    ...
    @DebugMetadata(mo37450c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", mo37451f = "Zip.kt", mo37452i = {0, 0}, mo37453l = {308}, mo37454m = "invokeSuspend", mo37455n = {"$this$combineInternal", "it"}, mo37456s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2 */
    /* compiled from: Zip.kt */
    public static final class C29342 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        Object L$0;
        Object L$1;
        int label;
        ...
        public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C29342 r0 = new C29342(this.this$0, continuation);
            r0.f687p$ = flowCollector;
            r0.p$0 = tArr;
            return r0;
        }

        public final Object invoke(Object obj, Object obj2, Object obj3) {
            return ((C29342) create((FlowCollector) obj, (Object[]) obj2, (Continuation) obj3)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                FlowCollector flowCollector = this.f687p$;
        ...
        public final Object invokeSuspend$$forInline(Object obj) {
            this.this$0.$transform.invoke(this.f687p$, this.p$0, this);
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            FlowCollector flowCollector = this.f686p$;
            ...
            }, new C29342(this, (Continuation) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            FlowCollector flowCollector2 = (FlowCollector) this.L$0;
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C29342(this, (Continuation) null), this);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
