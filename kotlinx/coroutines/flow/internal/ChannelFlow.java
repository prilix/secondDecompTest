...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    public BroadcastChannel<T> broadcastImpl(CoroutineScope coroutineScope, CoroutineStart coroutineStart) {
        ...
        return BroadcastKt.broadcast$default(coroutineScope, this.context, i, coroutineStart, (Function1) null, getCollectToFun$kotlinx_coroutines_core(), 8, (Object) null);
    }

    public ReceiveChannel<T> produceImpl(CoroutineScope coroutineScope) {
        return ProduceKt.produce$default(coroutineScope, this.context, getProduceCapacity(), this.onBufferOverflow, CoroutineStart.ATOMIC, (Function1) null, getCollectToFun$kotlinx_coroutines_core(), 16, (Object) null);
    }
    ...
    static /* synthetic */ Object collect$suspendImpl(ChannelFlow channelFlow, FlowCollector flowCollector, Continuation continuation) {
        Object coroutineScope = CoroutineScopeKt.coroutineScope(new ChannelFlow$collect$2(channelFlow, flowCollector, (Continuation) null), continuation);
