...
@Metadata(mo36736bv = {1, 0, 3}, mo36737d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u0004*\u00020\u0005H@¢\u0006\u0004\b\u0006\u0010\u0007¨\u0006\b"}, mo36738d2 = {"<anonymous>", "", "T1", "T2", "R", "Lkotlinx/coroutines/CoroutineScope;", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", "kotlinx/coroutines/flow/internal/CombineKt$zipImpl$1$1"}, mo36739k = 3, mo36740mv = {1, 4, 0})
...
final class CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r20) {
        ...
        L_0x0032:
            ...
            kotlinx.coroutines.CoroutineScope r11 = r8.f698p$
            r3 = 0
            r4 = 0
            ...
            r1.invokeOnClose(r2)
            kotlin.coroutines.CoroutineContext r13 = r11.getCoroutineContext()     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            java.lang.Object r14 = kotlinx.coroutines.internal.ThreadContextKt.threadContextElements(r13)     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            kotlin.coroutines.CoroutineContext r1 = r11.getCoroutineContext()     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            r2 = r7
            kotlin.coroutines.CoroutineContext r2 = (kotlin.coroutines.CoroutineContext) r2     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            kotlin.coroutines.CoroutineContext r15 = r1.plus(r2)     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            kotlin.Unit r16 = kotlin.Unit.INSTANCE     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            r17 = 0
            kotlinx.coroutines.flow.internal.CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1$3 r18 = new kotlinx.coroutines.flow.internal.CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1$3     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            r6 = 0
            r1 = r18
            r2 = r19
            r3 = r13
            r4 = r14
            r5 = r12
            r1.<init>(r2, r3, r4, r5, r6)     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            r4 = r18
            kotlin.jvm.functions.Function2 r4 = (kotlin.jvm.functions.Function2) r4     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            r6 = 4
            r18 = 0
            r8.L$0 = r11     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            r8.L$1 = r12     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            r8.L$2 = r7     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            r8.L$3 = r13     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            r8.L$4 = r14     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            r8.label = r9     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
            r1 = r15
            r2 = r16
            r3 = r17
            r5 = r19
            r7 = r18
            java.lang.Object r1 = kotlinx.coroutines.flow.internal.ChannelFlowKt.withContextUndispatched$default(r1, r2, r3, r4, r5, r6, r7)     // Catch:{ AbortFlowException -> 0x00b3, all -> 0x00b0 }
