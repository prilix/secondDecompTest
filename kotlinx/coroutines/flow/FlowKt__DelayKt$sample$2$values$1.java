...
@DebugMetadata(mo37450c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", mo37451f = "Delay.kt", mo37452i = {0, 0}, mo37453l = {352}, mo37454m = "invokeSuspend", mo37455n = {"$this$produce", "$this$collect$iv"}, mo37456s = {"L$0", "L$1"})
...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__DelayKt$sample$2$values$1.f651p$ = (ProducerScope) obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ProducerScope producerScope = this.f651p$;
            Flow flow = this.this$0.$this_sample;
            this.L$0 = producerScope;
            this.L$1 = flow;
            this.label = 1;
            if (flow.collect(new C2828xe7e632(producerScope), this) == coroutine_suspended) {
