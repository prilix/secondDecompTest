...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            if (newInstance != null) {
                obj = Result.m1581constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
            ...
            obj = Result.m1581constructorimpl(ResultKt.createFailure(th));
        }
    }
    ...
    public final void uninstall() {
        ...
        L_0x001c:
            ...
            int r5 = installations     // Catch:{ all -> 0x008c }
            int r5 = r5 + -1
            installations = r5     // Catch:{ all -> 0x008c }
            int r5 = installations     // Catch:{ all -> 0x008c }
        ...
        L_0x003d:
            ...
            return
        L_0x0041:
            r4.stopWeakRefCleanerThread()     // Catch:{ all -> 0x008c }
            kotlinx.coroutines.debug.internal.ConcurrentWeakMap<kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner<?>, java.lang.Boolean> r4 = capturedCoroutinesMap     // Catch:{ all -> 0x008c }
            r4.clear()     // Catch:{ all -> 0x008c }
            kotlinx.coroutines.debug.internal.ConcurrentWeakMap<kotlin.coroutines.jvm.internal.CoroutineStackFrame, kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl> r4 = callerInfoCache     // Catch:{ all -> 0x008c }
            r4.clear()     // Catch:{ all -> 0x008c }
        ...
        L_0x005e:
            ...
            return
        L_0x0062:
            kotlin.jvm.functions.Function1<java.lang.Boolean, kotlin.Unit> r4 = dynamicAttach     // Catch:{ all -> 0x008c }
            if (r4 == 0) goto L_0x0070
            java.lang.Boolean r5 = java.lang.Boolean.valueOf(r3)     // Catch:{ all -> 0x008c }
            java.lang.Object r4 = r4.invoke(r5)     // Catch:{ all -> 0x008c }
            kotlin.Unit r4 = (kotlin.Unit) r4     // Catch:{ all -> 0x008c }
        L_0x0070:
    ...
    public final java.lang.String hierarchyToString(kotlinx.coroutines.Job r10) {
        ...
        L_0x0081:
            ...
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r5 = r5.f803info     // Catch:{ all -> 0x00cf }
    ...
    private final <R> java.util.List<R> dumpCoroutinesInfoImpl(kotlin.jvm.functions.Function2<? super kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner<?>, ? super kotlin.coroutines.CoroutineContext, ? extends R> r11) {
        ...
        L_0x001e:
            ...
            r0.lock()
            r4 = 1
            kotlinx.coroutines.debug.internal.DebugProbesImpl r5 = INSTANCE     // Catch:{ all -> 0x0096 }
            boolean r6 = r5.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x0096 }
            if (r6 == 0) goto L_0x0088
            java.util.Set r5 = r5.getCapturedCoroutines()     // Catch:{ all -> 0x0096 }
        ...
        L_0x004c:
            ...
            kotlinx.coroutines.debug.internal.DebugProbesImpl r8 = INSTANCE     // Catch:{ all -> 0x0096 }
            boolean r8 = r8.isFinished(r7)     // Catch:{ all -> 0x0096 }
            r9 = 0
            if (r8 == 0) goto L_0x0062
            goto L_0x006e
        L_0x0062:
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r8 = r7.f803info     // Catch:{ all -> 0x0096 }
    ...
    public final boolean isFinished(CoroutineOwner<?> coroutineOwner) {
        Job job;
        CoroutineContext context = coroutineOwner.f803info.getContext();
    ...
    private final void dumpCoroutinesSynchronized(java.io.PrintStream r14) {
        ...
        L_0x001c:
            java.util.concurrent.locks.ReentrantReadWriteLock$WriteLock r0 = r0.writeLock()
            r0.lock()
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x011c }
            boolean r5 = r4.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x011c }
            ...
            r5.append(r6)     // Catch:{ all -> 0x011c }
            java.text.SimpleDateFormat r6 = dateFormat     // Catch:{ all -> 0x011c }
            long r7 = java.lang.System.currentTimeMillis()     // Catch:{ all -> 0x011c }
            java.lang.Long r7 = java.lang.Long.valueOf(r7)     // Catch:{ all -> 0x011c }
            java.lang.String r6 = r6.format(r7)     // Catch:{ all -> 0x011c }
            r5.append(r6)     // Catch:{ all -> 0x011c }
            java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x011c }
            r14.print(r5)     // Catch:{ all -> 0x011c }
            java.util.Set r4 = r4.getCapturedCoroutines()     // Catch:{ all -> 0x011c }
            java.lang.Iterable r4 = (java.lang.Iterable) r4     // Catch:{ all -> 0x011c }
            kotlin.sequences.Sequence r4 = kotlin.collections.CollectionsKt.asSequence(r4)     // Catch:{ all -> 0x011c }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$1$2 r5 = kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$1$2.INSTANCE     // Catch:{ all -> 0x011c }
            kotlin.jvm.functions.Function1 r5 = (kotlin.jvm.functions.Function1) r5     // Catch:{ all -> 0x011c }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.filter(r4, r5)     // Catch:{ all -> 0x011c }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$$special$$inlined$sortedBy$4 r5 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$$special$$inlined$sortedBy$4     // Catch:{ all -> 0x011c }
            r5.<init>()     // Catch:{ all -> 0x011c }
            java.util.Comparator r5 = (java.util.Comparator) r5     // Catch:{ all -> 0x011c }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.sortedWith(r4, r5)     // Catch:{ all -> 0x011c }
            java.util.Iterator r4 = r4.iterator()     // Catch:{ all -> 0x011c }
        L_0x006e:
            boolean r5 = r4.hasNext()     // Catch:{ all -> 0x011c }
            if (r5 == 0) goto L_0x0100
            java.lang.Object r5 = r4.next()     // Catch:{ all -> 0x011c }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r5 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r5     // Catch:{ all -> 0x011c }
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r6 = r5.f803info     // Catch:{ all -> 0x011c }
            java.util.List r7 = r6.lastObservedStackTrace()     // Catch:{ all -> 0x011c }
            kotlinx.coroutines.debug.internal.DebugProbesImpl r8 = INSTANCE     // Catch:{ all -> 0x011c }
            java.lang.String r9 = r6.getState()     // Catch:{ all -> 0x011c }
            java.lang.Thread r10 = r6.lastObservedThread     // Catch:{ all -> 0x011c }
            java.util.List r9 = r8.enhanceStackTraceWithThreadDumpImpl(r9, r10, r7)     // Catch:{ all -> 0x011c }
            java.lang.String r10 = r6.getState()     // Catch:{ all -> 0x011c }
            java.lang.String r11 = "RUNNING"
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r11)     // Catch:{ all -> 0x011c }
            ...
            java.lang.String r11 = r6.getState()     // Catch:{ all -> 0x011c }
        ...
        L_0x00b0:
            java.lang.String r10 = r6.getState()     // Catch:{ all -> 0x011c }
        L_0x00b4:
            java.lang.StringBuilder r11 = new java.lang.StringBuilder     // Catch:{ all -> 0x011c }
            r11.<init>()     // Catch:{ all -> 0x011c }
            java.lang.String r12 = "\n\nCoroutine "
            r11.append(r12)     // Catch:{ all -> 0x011c }
            kotlin.coroutines.Continuation<T> r5 = r5.delegate     // Catch:{ all -> 0x011c }
            r11.append(r5)     // Catch:{ all -> 0x011c }
            java.lang.String r5 = ", state: "
            r11.append(r5)     // Catch:{ all -> 0x011c }
            r11.append(r10)     // Catch:{ all -> 0x011c }
            java.lang.String r5 = r11.toString()     // Catch:{ all -> 0x011c }
            r14.print(r5)     // Catch:{ all -> 0x011c }
            boolean r5 = r7.isEmpty()     // Catch:{ all -> 0x011c }
            if (r5 == 0) goto L_0x00fb
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x011c }
            r5.<init>()     // Catch:{ all -> 0x011c }
            java.lang.String r7 = "\n\tat "
            r5.append(r7)     // Catch:{ all -> 0x011c }
            java.lang.String r7 = "Coroutine creation stacktrace"
            java.lang.StackTraceElement r7 = kotlinx.coroutines.internal.StackTraceRecoveryKt.artificialFrame(r7)     // Catch:{ all -> 0x011c }
            r5.append(r7)     // Catch:{ all -> 0x011c }
            java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x011c }
            r14.print(r5)     // Catch:{ all -> 0x011c }
            java.util.List r5 = r6.getCreationStackTrace()     // Catch:{ all -> 0x011c }
            r8.printStackTrace(r14, r5)     // Catch:{ all -> 0x011c }
            goto L_0x006e
        L_0x00fb:
            r8.printStackTrace(r14, r9)     // Catch:{ all -> 0x011c }
            goto L_0x006e
        L_0x0100:
            kotlin.Unit r14 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x011c }
        L_0x0102:
        ...
        L_0x010e:
            ...
            java.lang.IllegalStateException r4 = new java.lang.IllegalStateException     // Catch:{ all -> 0x011c }
            java.lang.String r14 = r14.toString()     // Catch:{ all -> 0x011c }
            r4.<init>(r14)     // Catch:{ all -> 0x011c }
            java.lang.Throwable r4 = (java.lang.Throwable) r4     // Catch:{ all -> 0x011c }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String str, Thread thread, List<StackTraceElement> list) {
        ...
        if (!(!Intrinsics.areEqual((Object) str, (Object) DebugCoroutineInfoImplKt.RUNNING)) && thread != null) {
            try {
                Result.Companion companion = Result.Companion;
                DebugProbesImpl debugProbesImpl = this;
                obj = Result.m1581constructorimpl(thread.getStackTrace());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                obj = Result.m1581constructorimpl(ResultKt.createFailure(th));
            }
    ...
    private final Pair<Integer, Boolean> findContinuationStartIndex(int i, StackTraceElement[] stackTraceElementArr, List<StackTraceElement> list) {
        ...
        if (findIndexOfFrame == -1) {
            return TuplesKt.m701to(Integer.valueOf(findIndexOfFrame(i - 2, stackTraceElementArr, list)), true);
        }
        return TuplesKt.m701to(Integer.valueOf(findIndexOfFrame), false);
    }
        ...
        try {
            ...
            if (debugProbesImpl.isInstalled$kotlinx_coroutines_core()) {
                ...
                if (remove == null) {
                    ...
                    if (owner == null || (remove = owner.f803info) == null) {
                        readLock.unlock();
                        return;
                    }
    ...
    private final void updateState(CoroutineOwner<?> coroutineOwner, Continuation<?> continuation, String str) {
        ...
        try {
            if (INSTANCE.isInstalled$kotlinx_coroutines_core()) {
                coroutineOwner.f803info.updateState$kotlinx_coroutines_core(str, continuation);
                Unit unit = Unit.INSTANCE;
                readLock.unlock();
            }
        } finally {
    ...
    public final void probeCoroutineCompleted(CoroutineOwner<?> coroutineOwner) {
        ...
        capturedCoroutinesMap.remove(coroutineOwner);
        CoroutineStackFrame lastObservedFrame$kotlinx_coroutines_core = coroutineOwner.f803info.getLastObservedFrame$kotlinx_coroutines_core();
    ...
    private static final class CoroutineOwner<T> implements Continuation<T>, CoroutineStackFrame {
        ...
        public final DebugCoroutineInfoImpl f803info;
        ...
        public CoroutineOwner(Continuation<? super T> continuation, DebugCoroutineInfoImpl debugCoroutineInfoImpl, CoroutineStackFrame coroutineStackFrame) {
            ...
            this.f803info = debugCoroutineInfoImpl;
    ...
    public final java.util.List<kotlinx.coroutines.debug.internal.DebugCoroutineInfo> dumpCoroutinesInfo() {
        ...
        L_0x001e:
            java.util.concurrent.locks.ReentrantReadWriteLock$WriteLock r0 = r0.writeLock()
            r0.lock()
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x0092 }
            boolean r5 = r4.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x0092 }
            if (r5 == 0) goto L_0x0084
            java.util.Set r4 = r4.getCapturedCoroutines()     // Catch:{ all -> 0x0092 }
        ...
        L_0x004b:
            ...
            kotlinx.coroutines.debug.internal.DebugProbesImpl r7 = INSTANCE     // Catch:{ all -> 0x0092 }
            boolean r7 = r7.isFinished(r6)     // Catch:{ all -> 0x0092 }
            r8 = 0
            if (r7 == 0) goto L_0x0061
            goto L_0x0070
        L_0x0061:
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r7 = r6.f803info     // Catch:{ all -> 0x0092 }
            ...
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r6 = r6.f803info     // Catch:{ all -> 0x0092 }
