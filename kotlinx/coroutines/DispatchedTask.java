        ...
        try {
            ...
            if (delegate$kotlinx_coroutines_core != null) {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m1581constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    ...
                    continuation.resumeWith(Result.m1581constructorimpl(successfulResult$kotlinx_coroutines_core));
                }
                ...
                try {
                    ...
                    obj = Result.m1581constructorimpl(Unit.INSTANCE);
                } catch (Throwable th4) {
                    th = th4;
                    Result.Companion companion5 = Result.Companion;
                    obj = Result.m1581constructorimpl(ResultKt.createFailure(th));
                    handleFatalException$kotlinx_coroutines_core(th2, Result.m1584exceptionOrNullimpl(obj));
                }
                handleFatalException$kotlinx_coroutines_core(th2, Result.m1584exceptionOrNullimpl(obj));
            }
