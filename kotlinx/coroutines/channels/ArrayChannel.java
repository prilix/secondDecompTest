...
public class ArrayChannel<E> extends AbstractChannel<E> {
    ...
    @Metadata(mo36736bv = {1, 0, 3}, mo36739k = 3, mo36740mv = {1, 4, 0})
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0059, code lost:
        if (r7 != kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()) goto L_0x0067;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x005b, code lost:
        r8.size = r2;
        r8.buffer[r8.head] = r5;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x0069, code lost:
        if ((r7 instanceof kotlinx.coroutines.channels.Closed) == false) goto L_0x0070;
     */
    ...
    public java.lang.Object pollSelectInternal(kotlinx.coroutines.selects.SelectInstance<?> r9) {
        /*
            ...
            r1.lock()
            int r2 = r8.size     // Catch:{ all -> 0x00cf }
            if (r2 != 0) goto L_0x001c
            kotlinx.coroutines.channels.Closed r9 = r8.getClosedForSend()     // Catch:{ all -> 0x00cf }
            if (r9 == 0) goto L_0x0016
            goto L_0x0018
        L_0x0016:
            kotlinx.coroutines.internal.Symbol r9 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00cf }
        L_0x0018:
            r1.unlock()
            return r9
        L_0x001c:
            java.lang.Object[] r3 = r8.buffer     // Catch:{ all -> 0x00cf }
            int r4 = r8.head     // Catch:{ all -> 0x00cf }
            r5 = r3[r4]     // Catch:{ all -> 0x00cf }
            r3[r4] = r0     // Catch:{ all -> 0x00cf }
            int r3 = r2 + -1
            r8.size = r3     // Catch:{ all -> 0x00cf }
            kotlinx.coroutines.internal.Symbol r3 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00cf }
            int r4 = r8.capacity     // Catch:{ all -> 0x00cf }
            r6 = 1
            if (r2 != r4) goto L_0x008d
        L_0x002f:
            kotlinx.coroutines.channels.AbstractChannel$TryPollDesc r4 = r8.describeTryPoll()     // Catch:{ all -> 0x00cf }
            r7 = r4
            kotlinx.coroutines.internal.AtomicDesc r7 = (kotlinx.coroutines.internal.AtomicDesc) r7     // Catch:{ all -> 0x00cf }
            java.lang.Object r7 = r9.performAtomicTrySelect(r7)     // Catch:{ all -> 0x00cf }
            if (r7 != 0) goto L_0x004b
            java.lang.Object r0 = r4.getResult()     // Catch:{ all -> 0x00cf }
            kotlinx.coroutines.channels.Send r0 = (kotlinx.coroutines.channels.Send) r0     // Catch:{ all -> 0x00cf }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x00cf }
            java.lang.Object r3 = r0.getPollResult()     // Catch:{ all -> 0x00cf }
        L_0x0049:
            r4 = 1
            goto L_0x008e
        L_0x004b:
            kotlinx.coroutines.internal.Symbol r4 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00cf }
            if (r7 != r4) goto L_0x0050
            goto L_0x008d
        L_0x0050:
            java.lang.Object r4 = kotlinx.coroutines.internal.AtomicKt.RETRY_ATOMIC     // Catch:{ all -> 0x00cf }
            if (r7 != r4) goto L_0x0055
            goto L_0x002f
        L_0x0055:
            java.lang.Object r0 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00cf }
            if (r7 != r0) goto L_0x0067
            r8.size = r2     // Catch:{ all -> 0x00cf }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00cf }
            int r0 = r8.head     // Catch:{ all -> 0x00cf }
            r9[r0] = r5     // Catch:{ all -> 0x00cf }
            r1.unlock()
            return r7
        L_0x0067:
            boolean r0 = r7 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00cf }
            ...
            goto L_0x0049
        L_0x0070:
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ all -> 0x00cf }
            r9.<init>()     // Catch:{ all -> 0x00cf }
            java.lang.String r0 = "performAtomicTrySelect(describeTryOffer) returned "
            r9.append(r0)     // Catch:{ all -> 0x00cf }
            r9.append(r7)     // Catch:{ all -> 0x00cf }
        ...
        L_0x008d:
            r4 = 0
        L_0x008e:
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00cf }
            if (r3 == r7) goto L_0x00a2
            boolean r7 = r3 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00cf }
            if (r7 != 0) goto L_0x00a2
            r8.size = r2     // Catch:{ all -> 0x00cf }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00cf }
            int r7 = r8.head     // Catch:{ all -> 0x00cf }
            int r7 = r7 + r2
            int r2 = r9.length     // Catch:{ all -> 0x00cf }
            int r7 = r7 % r2
            r9[r7] = r3     // Catch:{ all -> 0x00cf }
            goto L_0x00b8
        L_0x00a2:
            boolean r9 = r9.trySelect()     // Catch:{ all -> 0x00cf }
            if (r9 != 0) goto L_0x00b8
            r8.size = r2     // Catch:{ all -> 0x00cf }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00cf }
            int r0 = r8.head     // Catch:{ all -> 0x00cf }
            r9[r0] = r5     // Catch:{ all -> 0x00cf }
            java.lang.Object r9 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00cf }
            r1.unlock()
            return r9
        L_0x00b8:
            int r9 = r8.head     // Catch:{ all -> 0x00cf }
            int r9 = r9 + r6
            java.lang.Object[] r2 = r8.buffer     // Catch:{ all -> 0x00cf }
            int r2 = r2.length     // Catch:{ all -> 0x00cf }
            int r9 = r9 % r2
            r8.head = r9     // Catch:{ all -> 0x00cf }
            kotlin.Unit r9 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00cf }
            r1.unlock()
