...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    private final Throwable helpCloseAndGetSendException(E e, Closed<?> closed) {
        ...
        ExceptionsKt.addSuppressed(th, closed.getSendException());
        throw th;
    }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 == null || (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, (UndeliveredElementException) null, 2, (Object) null)) == null) {
            ...
            continuation.resumeWith(Result.m1581constructorimpl(ResultKt.createFailure(sendException)));
            return;
        }
        Throwable th = callUndeliveredElementCatchingException$default;
        ExceptionsKt.addSuppressed(th, sendException);
        Result.Companion companion2 = Result.Companion;
        continuation.resumeWith(Result.m1581constructorimpl(ResultKt.createFailure(th)));
    }
    ...
    private final void invokeOnCloseHandler(Throwable th) {
        ...
        if (obj != null && obj != AbstractChannelKt.HANDLER_INVOKED && C0174xc40028dd.m4m(onCloseHandler$FU, this, obj, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        if (!C0174xc40028dd.m4m(atomicReferenceFieldUpdater, this, (Object) null, function1)) {
            Object obj = this.onCloseHandler;
        ...
        Closed<?> closedForSend = getClosedForSend();
        if (closedForSend != null && C0174xc40028dd.m4m(atomicReferenceFieldUpdater, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
            function1.invoke(closedForSend.closeCause);
        }
    }

    private final void helpClose(Closed<?> closed) {
        Object r2 = InlineList.m3003constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
        while (true) {
            ...
            if (receive == null) {
                ...
                r2 = InlineList.m3008plusUZ7vuAc(r2, receive);
            }
        }
        if (r2 != null) {
    ...
    @Metadata(mo36736bv = {1, 0, 3}, mo36737d1 = {"\u00006\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0004\u0018\u0000*\u0004\b\u0001\u0010\u00012\u001e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00010\u00030\u0002j\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00010\u0003`\u0004B\u0015\u0012\u0006\u0010\u0005\u001a\u00028\u0001\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bJ\u0012\u0010\n\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\f\u001a\u00020\rH\u0014J\u0016\u0010\u000e\u001a\u0004\u0018\u00010\u000b2\n\u0010\u000f\u001a\u00060\u0010j\u0002`\u0011H\u0016R\u0012\u0010\u0005\u001a\u00028\u00018\u0006X\u0004¢\u0006\u0004\n\u0002\u0010\t¨\u0006\u0012"}, mo36738d2 = {"Lkotlinx/coroutines/channels/AbstractSendChannel$TryOfferDesc;", "E", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$RemoveFirstDesc;", "Lkotlinx/coroutines/channels/ReceiveOrClosed;", "Lkotlinx/coroutines/internal/RemoveFirstDesc;", "element", "queue", "Lkotlinx/coroutines/internal/LockFreeLinkedListHead;", "(Ljava/lang/Object;Lkotlinx/coroutines/internal/LockFreeLinkedListHead;)V", "Ljava/lang/Object;", "failure", "", "affected", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode;", "onPrepare", "prepareOp", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$PrepareOp;", "Lkotlinx/coroutines/internal/PrepareOp;", "kotlinx-coroutines-core"}, mo36739k = 1, mo36740mv = {1, 4, 0})
    /* compiled from: AbstractChannel.kt */
