...
public abstract class ConcurrentLinkedListNode<N extends ConcurrentLinkedListNode<N>> {
    ...
    public final N nextOrIfClosed(Function0 function0) {
        N access$getNextOrClosed$p = getNextOrClosed();
        if (access$getNextOrClosed$p != ConcurrentLinkedListKt.CLOSED) {
            return (ConcurrentLinkedListNode) access$getNextOrClosed$p;
        }
        function0.invoke();
    ...
    public final boolean trySetNext(N n) {
        return C0174xc40028dd.m4m(_next$FU, this, (Object) null, n);
    }
    ...
    public final boolean markAsClosed() {
        return C0174xc40028dd.m4m(_next$FU, this, (Object) null, ConcurrentLinkedListKt.CLOSED);
    }
