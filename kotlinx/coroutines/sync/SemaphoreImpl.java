...
final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        do {
            ...
            while (true) {
                if (segment.getId() >= access$getSEGMENT_SIZE$p && !segment.getRemoved()) {
                    obj = SegmentOrClosed.m3012constructorimpl(segment);
                    break;
                }
                Object access$getNextOrClosed$p = segment.getNextOrClosed();
                if (access$getNextOrClosed$p == ConcurrentLinkedListKt.CLOSED) {
                    obj = SegmentOrClosed.m3012constructorimpl(ConcurrentLinkedListKt.CLOSED);
                    break;
                }
            ...
            z = true;
            if (SegmentOrClosed.m3017isClosedimpl(obj)) {
                break;
            }
            Segment r8 = SegmentOrClosed.m3015getSegmentimpl(obj);
            while (true) {
                ...
                if (segment3.getId() >= r8.getId()) {
                    ...
                    continue;
                    break;
                } else if (C0174xc40028dd.m4m(tail$FU, this, segment3, r8)) {
        ...
        SemaphoreSegment semaphoreSegment2 = (SemaphoreSegment) SegmentOrClosed.m3015getSegmentimpl(obj);
        ...
        if (semaphoreSegment2.acquirers.compareAndSet(access$getSEGMENT_SIZE$p2, SemaphoreKt.PERMIT, SemaphoreKt.TAKEN)) {
            ...
            cancellableContinuation2.resumeWith(Result.m1581constructorimpl(unit));
            return true;
        }
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        L_0x0014:
            ...
            goto L_0x0028
        L_0x0023:
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m3012constructorimpl(r5)
            goto L_0x003d
        L_0x0028:
            r6 = r5
            ...
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m3012constructorimpl(r5)
        L_0x003d:
            boolean r6 = kotlinx.coroutines.internal.SegmentOrClosed.m3017isClosedimpl(r5)
            r7 = 0
            r8 = 1
            if (r6 != 0) goto L_0x0082
            kotlinx.coroutines.internal.Segment r6 = kotlinx.coroutines.internal.SegmentOrClosed.m3015getSegmentimpl(r5)
        L_0x0049:
        ...
        L_0x0063:
            ...
            boolean r10 = androidx.concurrent.futures.C0174xc40028dd.m4m(r10, r15, r9, r6)
        ...
        L_0x0078:
            ...
            goto L_0x0049
        L_0x0082:
            kotlinx.coroutines.internal.Segment r0 = kotlinx.coroutines.internal.SegmentOrClosed.m3015getSegmentimpl(r5)
            kotlinx.coroutines.sync.SemaphoreSegment r0 = (kotlinx.coroutines.sync.SemaphoreSegment) r0
            r0.cleanPrev()
            long r5 = r0.getId()
