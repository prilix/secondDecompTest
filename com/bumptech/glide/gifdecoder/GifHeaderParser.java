...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f134ix = readShort();
        this.header.currentFrame.f135iy = readShort();
        this.header.currentFrame.f133iw = readShort();
        this.header.currentFrame.f132ih = readShort();
        int read = read();
        boolean z = false;
