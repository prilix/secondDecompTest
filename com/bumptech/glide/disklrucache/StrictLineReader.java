...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f129CR = 13;

    /* renamed from: LF */
    private static final byte f130LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f131in;
    private int pos;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f131in) {
            if (this.buf != null) {
                ...
                C09081 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f131in;
        byte[] bArr = this.buf;
