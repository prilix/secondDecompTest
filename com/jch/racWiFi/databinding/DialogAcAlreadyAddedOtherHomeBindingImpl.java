...
public class DialogAcAlreadyAddedOtherHomeBindingImpl extends DialogAcAlreadyAddedOtherHomeBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.button_reset_ac, 8);
        ...
        sparseIntArray.put(R.id.view53, 12);
    }

    public DialogAcAlreadyAddedOtherHomeBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 13, sIncludes, sViewsWithIds));
    }

    private DialogAcAlreadyAddedOtherHomeBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, objArr[9], objArr[8], objArr[10], objArr[11], objArr[4], objArr[3], objArr[7], objArr[2], objArr[1], objArr[5], objArr[6], objArr[12]);
        this.mDirtyFlags = -1;
