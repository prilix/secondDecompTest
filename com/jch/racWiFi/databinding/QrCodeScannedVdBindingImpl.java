...
public class QrCodeScannedVdBindingImpl extends QrCodeScannedVdBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.view16, 11);
        sparseIntArray.put(R.id.view12, 12);
        sparseIntArray.put(R.id.view18, 13);
        sparseIntArray.put(R.id.view17, 14);
        sparseIntArray.put(R.id.view19, 15);
        sparseIntArray.put(R.id.view15, 16);
        sparseIntArray.put(R.id.view22, 17);
        sparseIntArray.put(R.id.view21, 18);
        sparseIntArray.put(R.id.qr_code_scanned, 19);
        sparseIntArray.put(R.id.text_view_qr_code_scanned, 20);
        sparseIntArray.put(R.id.button_where_to_locate_qr_code, 21);
        sparseIntArray.put(R.id.button_unable_to_scan_qr_code, 22);
    }

    public QrCodeScannedVdBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 23, sIncludes, sViewsWithIds));
    }

    private QrCodeScannedVdBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, objArr[22], objArr[21], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7], objArr[1], objArr[10], objArr[19], objArr[20], objArr[9], objArr[8], objArr[12], objArr[16], objArr[11], objArr[14], objArr[13], objArr[15], objArr[18], objArr[17]);
        this.mDirtyFlags = -1;
    ...
    public boolean hasPendingBindings() {
        ...
        L_0x0018:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jch.racWiFi.databinding.QrCodeScannedVdBindingImpl.hasPendingBindings():boolean");
    }
