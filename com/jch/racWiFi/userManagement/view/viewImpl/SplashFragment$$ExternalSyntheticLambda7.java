...
public final /* synthetic */ class SplashFragment$$ExternalSyntheticLambda7 implements SingleChoiceDialog.CustomOnClickListener {
    public final /* synthetic */ SplashFragment f$0;
    public final /* synthetic */ SingleChoiceDialog f$1;

    public /* synthetic */ SplashFragment$$ExternalSyntheticLambda7(SplashFragment splashFragment, SingleChoiceDialog singleChoiceDialog) {
        this.f$0 = splashFragment;
        this.f$1 = singleChoiceDialog;
    }

    public final boolean onButtonClickListener(Dialog dialog, View view) {
        return this.f$0.mo33282x57c8a5ba(this.f$1, dialog, view);
    }
}
