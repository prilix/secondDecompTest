...
final class ECSelectACFragment$showToolTip$1 extends Lambda implements Function1<Tooltip, Unit> {
    final /* synthetic */ View $view;
    final /* synthetic */ ECSelectACFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ECSelectACFragment$showToolTip$1(ECSelectACFragment eCSelectACFragment, View view) {
        super(1);
    ...
    public final void invoke(Tooltip tooltip) {
        ...
        ((ImageView) (view == null ? null : view.findViewById(C1655R.C1658id.ecQuestionMarkImage))).setImageDrawable(ContextCompat.getDrawable(this.$view.getContext(), R.drawable.ic_red_question_mark));
    }
}
