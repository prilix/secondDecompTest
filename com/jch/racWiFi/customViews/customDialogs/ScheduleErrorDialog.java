...
public class ScheduleErrorDialog extends Dialog implements DialogInterface.OnShowListener {
    ...
    public void setParentView(final View view) {
        setOnShowListener(new DialogInterface.OnShowListener() {
            public void onShow(DialogInterface dialogInterface) {
                ...
                layoutParams.copyFrom(ScheduleErrorDialog.this.getWindow().getAttributes());
                layoutParams.dimAmount = 0.2f;
                layoutParams.width = -1;
                layoutParams.height = -2;
                ScheduleErrorDialog.this.getWindow().addFlags(2);
                ScheduleErrorDialog.this.getWindow().setAttributes(layoutParams);
                View view = view;
                if (view != null) {
    ...
    private void init(Context context) {
        ...
        this.mView = LayoutInflater.from(context).inflate(R.layout.schedule_error_dialog, (ViewGroup) null, false);
        initViews();
        setCancelable(false);
    }
    ...
    public ScheduleErrorDialog(Context context) {
        super(context);
        init(context);
    ...
    public ScheduleErrorDialog(Context context, boolean z) {
        super(context);
    ...
    public ScheduleErrorDialog(Context context, String str, String str2, String str3, String str4) {
        super(context);
        init(context);
    ...
    public void setPositiveButton(String str, final CustomOnClickListener customOnClickListener) {
        ...
        this.mPositiveButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (customOnClickListener.onButtonClickListener(ScheduleErrorDialog.this, view)) {
                    ScheduleErrorDialog.this.dismiss();
                }
            }
        });
    }
    ...
    public static class Builder {
        ...
        public ScheduleErrorDialog create() {
            ScheduleErrorDialog scheduleErrorDialog = new ScheduleErrorDialog(this.mContext);
            scheduleErrorDialog.setTitleString(getTitle());
            scheduleErrorDialog.setMessageString(getMessage());
            scheduleErrorDialog.setPositiveButton(this.mPositiveButtonStr, this.mPositiveButtonClickListener);
            scheduleErrorDialog.setNegativeButton(this.mNegativeButtonStr, this.mNegativeButtonClickListener);
            return scheduleErrorDialog;
        }
    }
}
