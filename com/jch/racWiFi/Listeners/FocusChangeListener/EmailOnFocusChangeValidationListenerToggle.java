...
public class EmailOnFocusChangeValidationListenerToggle implements View.OnFocusChangeListener {
    ...
    public EmailOnFocusChangeValidationListenerToggle(EditText editText) {
