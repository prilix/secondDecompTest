...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    public void calculateOffsets() {
        ...
        if (this.mData != null) {
            ...
            this.mCircleBox.set((centerOffsets.f195x - diameter) + selectionShift, (centerOffsets.f196y - diameter) + selectionShift, (centerOffsets.f195x + diameter) - selectionShift, (centerOffsets.f196y + diameter) - selectionShift);
    ...
    public float[] getMarkerPosition(Highlight highlight) {
        ...
        double d = (double) f2;
        float cos = (float) ((Math.cos(Math.toRadians((double) (((this.mAbsoluteAngles[x] + rotationAngle) - f3) * this.mAnimator.getPhaseY()))) * d) + ((double) centerCircleBox.f195x));
        MPPointF.recycleInstance(centerCircleBox);
        return new float[]{cos, (float) ((d * Math.sin(Math.toRadians((double) (((rotationAngle + this.mAbsoluteAngles[x]) - f3) * this.mAnimator.getPhaseY())))) + ((double) centerCircleBox.f196y))};
    }
    ...
    public void setCenterTextSize(float f) {
        ((PieChartRenderer) this.mRenderer).getPaintCenterText().setTextSize(C1030Utils.convertDpToPixel(f));
    }
    ...
    public void setCenterTextOffset(float f, float f2) {
        this.mCenterTextOffset.f195x = C1030Utils.convertDpToPixel(f);
        this.mCenterTextOffset.f196y = C1030Utils.convertDpToPixel(f2);
    }

    public MPPointF getCenterTextOffset() {
        return MPPointF.getInstance(this.mCenterTextOffset.f195x, this.mCenterTextOffset.f196y);
    }
    ...
    public void setEntryLabelTextSize(float f) {
        ((PieChartRenderer) this.mRenderer).getPaintEntryLabels().setTextSize(C1030Utils.convertDpToPixel(f));
    }
