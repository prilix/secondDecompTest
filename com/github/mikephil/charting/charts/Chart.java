...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    public void init() {
        ...
        C1030Utils.init(getContext());
        this.mMaxHighlightDistance = C1030Utils.convertDpToPixel(500.0f);
        ...
        paint.setColor(Color.rgb(C1662R2.attr.chipIconSize, C1662R2.attr.buttonBarNegativeButtonStyle, 51));
        this.mInfoPaint.setTextAlign(Paint.Align.CENTER);
        this.mInfoPaint.setTextSize(C1030Utils.convertDpToPixel(12.0f));
        if (this.mLogEnabled) {
            Log.i("", "Chart.init()");
        }
    }
    ...
    public void setupDefaultFormatter(float f, float f2) {
        ...
        this.mDefaultValueFormatter.setup(C1030Utils.getDecimals(f3));
    }
    ...
    public void onDraw(Canvas canvas) {
        if (this.mData == null) {
            if (!TextUtils.isEmpty(this.mNoDataText)) {
                ...
                canvas.drawText(this.mNoDataText, center.f195x, center.f196y, this.mInfoPaint);
            }
    ...
    public void setMaxHighlightDistance(float f) {
        this.mMaxHighlightDistance = C1030Utils.convertDpToPixel(f);
    }
    ...
    public void setExtraTopOffset(float f) {
        this.mExtraTopOffset = C1030Utils.convertDpToPixel(f);
    }
    ...
    public void setExtraRightOffset(float f) {
        this.mExtraRightOffset = C1030Utils.convertDpToPixel(f);
    }
    ...
    public void setExtraBottomOffset(float f) {
        this.mExtraBottomOffset = C1030Utils.convertDpToPixel(f);
    }
    ...
    public void setExtraLeftOffset(float f) {
        this.mExtraLeftOffset = C1030Utils.convertDpToPixel(f);
    }
    ...
    public boolean saveToGallery(String str, String str2, String str3, Bitmap.CompressFormat compressFormat, int i) {
        ...
        int i2 = C10202.$SwitchMap$android$graphics$Bitmap$CompressFormat[compressFormat.ordinal()];
    ...
    static /* synthetic */ class C10202 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.Chart.C10202.<clinit>():void");
        }
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        int convertDpToPixel = (int) C1030Utils.convertDpToPixel(50.0f);
