...
public abstract class PieRadarChartBase<T extends ChartData<? extends IDataSet<? extends Entry>>> extends Chart<T> {
    ...
    public void calculateOffsets() {
        /*
            ...
            int[] r2 = com.github.mikephil.charting.charts.PieRadarChartBase.C10222.f172x9c9dbef
            com.github.mikephil.charting.components.Legend r3 = r11.mLegend
        ...
        L_0x0054:
            ...
            int[] r2 = com.github.mikephil.charting.charts.PieRadarChartBase.C10222.f173xc926f1ec
            com.github.mikephil.charting.components.Legend r5 = r11.mLegend
        ...
        L_0x00e2:
            ...
            float r9 = com.github.mikephil.charting.utils.C1030Utils.convertDpToPixel(r9)
            float r10 = r5.f196y
        ...
        L_0x0126:
            int[] r2 = com.github.mikephil.charting.charts.PieRadarChartBase.C10222.f171x2787f53e
            com.github.mikephil.charting.components.Legend r5 = r11.mLegend
            ...
            goto L_0x014e
        L_0x013c:
            int[] r0 = com.github.mikephil.charting.charts.PieRadarChartBase.C10222.f173xc926f1ec
            com.github.mikephil.charting.components.Legend r2 = r11.mLegend
            com.github.mikephil.charting.components.Legend$LegendVerticalAlignment r2 = r2.getVerticalAlignment()
            int r2 = r2.ordinal()
            r0 = r0[r2]
    ...
    static /* synthetic */ class C10222 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f172x9c9dbef     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x002e:
                int[] r2 = f171x2787f53e     // Catch:{ NoSuchFieldError -> 0x0038 }
            ...
            L_0x0038:
                int[] r2 = f171x2787f53e     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0054:
                int[] r1 = f173xc926f1ec     // Catch:{ NoSuchFieldError -> 0x005e }
            ...
            L_0x005e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.PieRadarChartBase.C10222.<clinit>():void");
        }
    }

    public float getAngleForPoint(float f, float f2) {
        MPPointF centerOffsets = getCenterOffsets();
        double d = (double) (f - centerOffsets.f195x);
        double d2 = (double) (f2 - centerOffsets.f196y);
        float degrees = (float) Math.toDegrees(Math.acos(d2 / Math.sqrt((d * d) + (d2 * d2))));
        if (f > centerOffsets.f195x) {
    ...
    public void getPosition(MPPointF mPPointF, float f, float f2, MPPointF mPPointF2) {
        double d = (double) f;
        double d2 = (double) f2;
        mPPointF2.f195x = (float) (((double) mPPointF.f195x) + (Math.cos(Math.toRadians(d2)) * d));
        mPPointF2.f196y = (float) (((double) mPPointF.f196y) + (d * Math.sin(Math.toRadians(d2))));
    }
    ...
    public float distanceToCenter(float f, float f2) {
        ...
        MPPointF centerOffsets = getCenterOffsets();
        if (f > centerOffsets.f195x) {
            f3 = f - centerOffsets.f195x;
        } else {
            f3 = centerOffsets.f195x - f;
        }
        if (f2 > centerOffsets.f196y) {
            f4 = f2 - centerOffsets.f196y;
        } else {
            f4 = centerOffsets.f196y - f2;
        }
    ...
    public void setRotationAngle(float f) {
        ...
        this.mRotationAngle = C1030Utils.getNormalizedAngle(f);
    }
