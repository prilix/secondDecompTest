...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    protected MPPointD posForGetHighestVisibleX = MPPointD.getInstance(C1030Utils.DOUBLE_EPSILON, C1030Utils.DOUBLE_EPSILON);
    protected MPPointD posForGetLowestVisibleX = MPPointD.getInstance(C1030Utils.DOUBLE_EPSILON, C1030Utils.DOUBLE_EPSILON);
    ...
    public void init() {
        ...
        this.mGridBackgroundPaint.setColor(Color.rgb(C1662R2.attr.checkedTextViewStyle, C1662R2.attr.checkedTextViewStyle, C1662R2.attr.checkedTextViewStyle));
        Paint paint2 = new Paint();
        this.mBorderPaint = paint2;
        paint2.setStyle(Paint.Style.STROKE);
        this.mBorderPaint.setColor(ViewCompat.MEASURED_STATE_MASK);
        this.mBorderPaint.setStrokeWidth(C1030Utils.convertDpToPixel(1.0f));
    }
    ...
    public void calculateLegendOffsets(RectF rectF) {
        ...
        if (this.mLegend != null && this.mLegend.isEnabled() && !this.mLegend.isDrawInsideEnabled()) {
            int i = C10182.f169x9c9dbef[this.mLegend.getOrientation().ordinal()];
            if (i == 1) {
                int i2 = C10182.f168x2787f53e[this.mLegend.getHorizontalAlignment().ordinal()];
                if (i2 == 1) {
                    ...
                    int i3 = C10182.f170xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
                    if (i3 == 1) {
                ...
                int i4 = C10182.f170xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
                if (i4 == 1) {
                    rectF.top += Math.min(this.mLegend.mNeededHeight, this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent()) + this.mLegend.getYOffset();
                } else if (i4 == 2) {
                    rectF.bottom += Math.min(this.mLegend.mNeededHeight, this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent()) + this.mLegend.getYOffset();
    ...
    static /* synthetic */ class C10182 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f169x9c9dbef     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x002e:
                int[] r2 = f168x2787f53e     // Catch:{ NoSuchFieldError -> 0x0038 }
            ...
            L_0x0038:
                int[] r2 = f168x2787f53e     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0054:
                int[] r1 = f170xc926f1ec     // Catch:{ NoSuchFieldError -> 0x005e }
            ...
            L_0x005e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.BarLineChartBase.C10182.<clinit>():void");
        }
    }
    ...
    public void calculateOffsets() {
        if (!this.mCustomViewPortEnabled) {
            ...
            float convertDpToPixel = C1030Utils.convertDpToPixel(this.mMinOffset);
    ...
    public void zoomIn() {
        ...
        this.mViewPortHandler.zoomIn(contentCenter.f195x, -contentCenter.f196y, this.mZoomMatrixBuffer);
    ...
    public void zoomOut() {
        MPPointF contentCenter = this.mViewPortHandler.getContentCenter();
        this.mViewPortHandler.zoomOut(contentCenter.f195x, -contentCenter.f196y, this.mZoomMatrixBuffer);
        this.mViewPortHandler.refresh(this.mZoomMatrixBuffer, this, false);
        MPPointF.recycleInstance(contentCenter);
        calculateOffsets();
        postInvalidate();
    ...
    public void zoomToCenter(float f, float f2) {
        ...
        this.mViewPortHandler.zoom(f, f2, centerOffsets.f195x, -centerOffsets.f196y, matrix);
    ...
    public void zoomAndCenterAnimated(float f, float f2, float f3, float f4, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedZoomJob.getInstance(this.mViewPortHandler, this, getTransformer(axisDependency2), getAxis(axisDependency2), this.mXAxis.mAxisRange, f, f2, this.mViewPortHandler.getScaleX(), this.mViewPortHandler.getScaleY(), f3, f4, (float) valuesByTouchPoint.f193x, (float) valuesByTouchPoint.f194y, j));
    ...
    public void moveViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f, f2 + (axisRange / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.f193x, (float) valuesByTouchPoint.f194y, j));
        MPPointD.recycleInstance(valuesByTouchPoint);
    }
    ...
    public void centerViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f - (scaleX / 2.0f), f2 + (axisRange / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.f193x, (float) valuesByTouchPoint.f194y, j));
        MPPointD.recycleInstance(valuesByTouchPoint);
    }
    ...
    public void setBorderWidth(float f) {
        this.mBorderPaint.setStrokeWidth(C1030Utils.convertDpToPixel(f));
    }
    ...
    public MPPointD getValuesByTouchPoint(float f, float f2, YAxis.AxisDependency axisDependency) {
        MPPointD instance = MPPointD.getInstance(C1030Utils.DOUBLE_EPSILON, C1030Utils.DOUBLE_EPSILON);
    ...
    public float getLowestVisibleX() {
        ...
        return (float) Math.max((double) this.mXAxis.mAxisMinimum, this.posForGetLowestVisibleX.f193x);
    }
    ...
    public float getHighestVisibleX() {
        ...
        return (float) Math.min((double) this.mXAxis.mAxisMaximum, this.posForGetHighestVisibleX.f193x);
    }
