...
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
    ...
    public BaseDataSet() {
        ...
        this.mColors.add(Integer.valueOf(Color.rgb(C1662R2.attr.badgeGravity, 234, 255)));
    ...
    public ValueFormatter getValueFormatter() {
        if (needsFormatter()) {
            return C1030Utils.getDefaultValueFormatter();
        }
    ...
    public void setValueTextSize(float f) {
        this.mValueTextSize = C1030Utils.convertDpToPixel(f);
    }
    ...
    public void setIconsOffset(MPPointF mPPointF) {
        this.mIconsOffset.f195x = mPPointF.f195x;
        this.mIconsOffset.f196y = mPPointF.f196y;
    }
