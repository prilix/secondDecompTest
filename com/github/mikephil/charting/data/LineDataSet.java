...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
    ...
    public LineDataSet(List<Entry> list, String str) {
        ...
        this.mCircleColors.add(Integer.valueOf(Color.rgb(C1662R2.attr.badgeGravity, 234, 255)));
    }
    ...
    public void setCircleRadius(float f) {
        if (f >= 1.0f) {
            this.mCircleRadius = C1030Utils.convertDpToPixel(f);
        } else {
    ...
    public void setCircleHoleRadius(float f) {
        if (f >= 0.5f) {
            this.mCircleHoleRadius = C1030Utils.convertDpToPixel(f);
        } else {
