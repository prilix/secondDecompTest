...
public class RadarHighlighter extends PieRadarHighlighter<RadarChart> {
    ...
    public List<Highlight> getHighlightsAtIndex(int i) {
        ...
        while (i3 < ((RadarData) ((RadarChart) this.mChart).getData()).getDataSetCount()) {
            ...
            float f = (float) i2;
            C1030Utils.getPosition(((RadarChart) this.mChart).getCenterOffsets(), (entryForIndex.getY() - ((RadarChart) this.mChart).getYChartMin()) * factor * phaseY, (sliceAngle * f * phaseX) + ((RadarChart) this.mChart).getRotationAngle(), instance);
            List list = this.mHighlightBuffer;
            Highlight highlight = r8;
            Highlight highlight2 = new Highlight(f, entryForIndex.getY(), instance.f195x, instance.f196y, i3, dataSetByIndex.getAxisDependency());
            list.add(highlight);
            i3++;
            i2 = i;
        }
