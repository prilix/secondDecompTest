...
public class YAxisRenderer extends AxisRenderer {
    ...
    public void renderAxisLabels(Canvas canvas) {
        ...
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            float calcTextHeight = (((float) C1030Utils.calcTextHeight(this.mAxisLabelPaint, ExifInterface.GPS_MEASUREMENT_IN_PROGRESS)) / 2.5f) + this.mYAxis.getYOffset();
    ...
    public void drawZeroLine(Canvas canvas) {
        ...
        path.reset();
        path.moveTo(this.mViewPortHandler.contentLeft(), (float) pixelForValues.f194y);
        path.lineTo(this.mViewPortHandler.contentRight(), (float) pixelForValues.f194y);
            ...
            for (int i = 0; i < limitLines.size(); i++) {
                ...
                if (limitLine.isEnabled()) {
                    ...
                    if (label != null && !label.equals("")) {
                        ...
                        float calcTextHeight = (float) C1030Utils.calcTextHeight(this.mLimitLinePaint, label);
                        float convertDpToPixel = C1030Utils.convertDpToPixel(4.0f) + limitLine.getXOffset();
