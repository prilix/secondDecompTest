...
public class PieChartRenderer extends DataRenderer {
    ...
    public PieChartRenderer(PieChart pieChart, ChartAnimator chartAnimator, ViewPortHandler viewPortHandler) {
        ...
        this.mCenterTextPaint.setTextSize(C1030Utils.convertDpToPixel(12.0f));
        this.mValuePaint.setTextSize(C1030Utils.convertDpToPixel(13.0f));
        ...
        this.mEntryLabelsPaint.setTextSize(C1030Utils.convertDpToPixel(13.0f));
    ...
    public float calculateMinimumRadiusForSpacedSlice(MPPointF mPPointF, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        float cos = mPPointF2.f195x + (((float) Math.cos(d)) * f);
        float sin = mPPointF2.f196y + (((float) Math.sin(d)) * f);
        double d2 = (double) ((f5 + (f6 / 2.0f)) * 0.017453292f);
        return (float) (((double) (f - ((float) ((Math.sqrt(Math.pow((double) (cos - f3), 2.0d) + Math.pow((double) (sin - f4), 2.0d)) / 2.0d) * Math.tan(((180.0d - ((double) f2)) / 2.0d) * 0.017453292519943295d))))) - Math.sqrt(Math.pow((double) ((mPPointF2.f195x + (((float) Math.cos(d2)) * f)) - ((cos + f3) / 2.0f)), 2.0d) + Math.pow((double) ((mPPointF2.f196y + (((float) Math.sin(d2)) * f)) - ((sin + f4) / 2.0f)), 2.0d)));
    }
    ...
    public void drawDataSet(Canvas canvas, IPieDataSet iPieDataSet) {
        ...
        for (int i8 = 0; i8 < entryCount; i8++) {
            if (Math.abs(((PieEntry) iPieDataSet2.getEntryForIndex(i8)).getY()) > C1030Utils.FLOAT_EPSILON) {
                i7++;
            }
        }
        if (i7 <= 1) {
        ...
        while (i9 < entryCount) {
            ...
            if (Math.abs(iPieDataSet2.getEntryForIndex(i9).getY()) > C1030Utils.FLOAT_EPSILON && (!pieChartRenderer.mChart.needsHighlight(i9) || z2)) {
                ...
                if (z2) {
                    ...
                    i = entryCount;
                    fArr = drawAngles;
                    float cos = centerCircleBox.f195x + (((float) Math.cos(d)) * f16);
                    float sin = centerCircleBox.f196y + (f16 * ((float) Math.sin(d)));
                ...
                f3 = rotationAngle;
                f2 = phaseX;
                float cos2 = centerCircleBox.f195x + (((float) Math.cos(d2)) * radius);
                float sin2 = centerCircleBox.f196y + (((float) Math.sin(d2)) * radius);
                int i10 = (f15 > 360.0f ? 1 : (f15 == 360.0f ? 0 : -1));
                if (i10 < 0 || f15 % 360.0f > C1030Utils.FLOAT_EPSILON) {
                    if (z2) {
                        pieChartRenderer.mPathBuffer.arcTo(rectF7, f14 + 180.0f, -180.0f);
                    }
                    pieChartRenderer.mPathBuffer.arcTo(circleBox, f14, f15);
                } else {
                    pieChartRenderer.mPathBuffer.addCircle(centerCircleBox.f195x, centerCircleBox.f196y, radius, Path.Direction.CW);
                }
                float f17 = f15;
                pieChartRenderer.mInnerRectBuffer.set(centerCircleBox.f195x - holeRadius, centerCircleBox.f196y - holeRadius, centerCircleBox.f195x + holeRadius, centerCircleBox.f196y + holeRadius);
                if (!z) {
                    f8 = holeRadius;
                    f9 = radius;
                    ...
                    float f22 = f20 + f21;
                    if (i10 < 0 || f10 % 360.0f > C1030Utils.FLOAT_EPSILON) {
                        pieChartRenderer = this;
                        if (z2) {
                            float f23 = f4 - holeRadius2;
                            double d3 = (double) (f22 * 0.017453292f);
                            float cos3 = mPPointF2.f195x + (((float) Math.cos(d3)) * f23);
                            float sin3 = mPPointF2.f196y + (f23 * ((float) Math.sin(d3)));
                            rectF3 = rectF6;
                            ...
                            pieChartRenderer.mPathBuffer.lineTo(mPPointF2.f195x + (((float) Math.cos(d4)) * holeRadius), mPPointF2.f196y + (holeRadius * ((float) Math.sin(d4))));
                        }
                        pieChartRenderer.mPathBuffer.arcTo(pieChartRenderer.mInnerRectBuffer, f22, -f21);
                    } else {
                        pieChartRenderer = this;
                        pieChartRenderer.mPathBuffer.addCircle(mPPointF2.f195x, mPPointF2.f196y, holeRadius, Path.Direction.CCW);
                        rectF3 = rectF6;
                    }
                    mPPointF = mPPointF2;
                    rectF2 = rectF3;
                ...
                if (f6 % f7 > C1030Utils.FLOAT_EPSILON) {
                    if (z3) {
                        ...
                        pieChartRenderer.mPathBuffer.lineTo(mPPointF.f195x + (((float) Math.cos(d5)) * calculateMinimumRadiusForSpacedSlice2), mPPointF.f196y + (calculateMinimumRadiusForSpacedSlice2 * ((float) Math.sin(d5))));
                    } else {
                        rectF2 = rectF3;
                        pieChartRenderer.mPathBuffer.lineTo(mPPointF.f195x, mPPointF.f196y);
                    }
                    pieChartRenderer.mPathBuffer.close();
                    pieChartRenderer.mBitmapCanvas.drawPath(pieChartRenderer.mPathBuffer, pieChartRenderer.mRenderPaint);
                    f11 += f12 * f2;
    ...
    public void drawValues(android.graphics.Canvas r53) {
        ...
        L_0x007d:
            ...
            float r22 = com.github.mikephil.charting.utils.C1030Utils.convertDpToPixel(r0)
            r23 = 0
            r0 = 0
            r4 = 0
        L_0x00a5:
        ...
        L_0x00d4:
            ...
            int r0 = com.github.mikephil.charting.utils.C1030Utils.calcTextHeight(r0, r4)
            float r0 = (float) r0
            ...
            float r7 = com.github.mikephil.charting.utils.C1030Utils.convertDpToPixel(r7)
            ...
            r29 = r8
            float r8 = r5.f195x
            float r8 = com.github.mikephil.charting.utils.C1030Utils.convertDpToPixel(r8)
            r5.f195x = r8
            float r8 = r5.f196y
            float r8 = com.github.mikephil.charting.utils.C1030Utils.convertDpToPixel(r8)
            r5.f196y = r8
        ...
        L_0x0393:
            ...
            r4 = r5
            r5 = r11
            com.github.mikephil.charting.utils.C1030Utils.drawImage(r0, r1, r2, r3, r4, r5)
            goto L_0x03d0
        L_0x03ce:
            r7 = r51
        L_0x03d0:
    ...
    public void drawHole(Canvas canvas) {
        if (this.mChart.isDrawHoleEnabled() && this.mBitmapCanvas != null) {
            ...
            if (Color.alpha(this.mHolePaint.getColor()) > 0) {
                this.mBitmapCanvas.drawCircle(centerCircleBox.f195x, centerCircleBox.f196y, holeRadius, this.mHolePaint);
            }
            if (Color.alpha(this.mTransparentCirclePaint.getColor()) > 0 && this.mChart.getTransparentCircleRadius() > this.mChart.getHoleRadius()) {
                ...
                this.mHoleCirclePath.addCircle(centerCircleBox.f195x, centerCircleBox.f196y, transparentCircleRadius, Path.Direction.CW);
                this.mHoleCirclePath.addCircle(centerCircleBox.f195x, centerCircleBox.f196y, holeRadius, Path.Direction.CCW);
    ...
    public void drawCenterText(Canvas canvas) {
        ...
        if (this.mChart.isDrawCenterTextEnabled() && centerText != null) {
            ...
            float f2 = centerCircleBox.f195x + centerTextOffset.f195x;
            float f3 = centerCircleBox.f196y + centerTextOffset.f196y;
            ...
            if (((double) centerTextRadiusPercent) > C1030Utils.DOUBLE_EPSILON) {
            ...
            while (i4 < highlightArr2.length) {
                ...
                if (x < drawAngles.length && (dataSetByIndex = ((PieData) this.mChart.getData()).getDataSetByIndex(highlightArr2[i4].getDataSetIndex())) != null && dataSetByIndex.isHighlightEnabled()) {
                    ...
                    for (int i6 = 0; i6 < entryCount; i6++) {
                        if (Math.abs(((PieEntry) dataSetByIndex.getEntryForIndex(i6)).getY()) > C1030Utils.FLOAT_EPSILON) {
                            i5++;
                        }
                    }
                    if (x == 0) {
                    ...
                    if (i8 < 0 || f17 % 360.0f > C1030Utils.FLOAT_EPSILON) {
                        fArr2 = drawAngles;
                        f6 = f4;
                        double d = (double) (f18 * 0.017453292f);
                        i3 = i5;
                        z = z2;
                        this.mPathBuffer.moveTo(centerCircleBox.f195x + (((float) Math.cos(d)) * f10), centerCircleBox.f196y + (f10 * ((float) Math.sin(d))));
                        this.mPathBuffer.arcTo(rectF2, f18, f19);
                    } else {
                        this.mPathBuffer.addCircle(centerCircleBox.f195x, centerCircleBox.f196y, f10, Path.Direction.CW);
                        fArr2 = drawAngles;
                        f6 = f4;
                        i3 = i5;
                        z = z2;
                    ...
                    if (z3) {
                        ...
                        mPPointF = centerCircleBox;
                        fArr = fArr2;
                        f7 = calculateMinimumRadiusForSpacedSlice(centerCircleBox, radius, f9 * phaseY, (((float) Math.cos(d2)) * radius) + centerCircleBox.f195x, centerCircleBox.f196y + (((float) Math.sin(d2)) * radius), f15, f17);
                    } else {
                        rectF = rectF2;
                        mPPointF = centerCircleBox;
                        i = i7;
                    ...
                    this.mInnerRectBuffer.set(mPPointF.f195x - f2, mPPointF.f196y - f2, mPPointF.f195x + f2, mPPointF.f196y + f2);
                    if (!z || (f2 <= 0.0f && !z3)) {
                        f3 = phaseX;
                        f = phaseY;
                        if (f17 % 360.0f > C1030Utils.FLOAT_EPSILON) {
                            if (z3) {
                                double d3 = (double) ((f15 + (f17 / 2.0f)) * 0.017453292f);
                                this.mPathBuffer.lineTo(mPPointF.f195x + (((float) Math.cos(d3)) * f7), mPPointF.f196y + (f7 * ((float) Math.sin(d3))));
                            } else {
                                this.mPathBuffer.lineTo(mPPointF.f195x, mPPointF.f196y);
                            }
                        }
                    } else {
                        if (z3) {
                        ...
                        if (i8 < 0 || f17 % 360.0f > C1030Utils.FLOAT_EPSILON) {
                            ...
                            f3 = phaseX;
                            f = phaseY;
                            this.mPathBuffer.lineTo(mPPointF.f195x + (((float) Math.cos(d4)) * f8), mPPointF.f196y + (f8 * ((float) Math.sin(d4))));
                            this.mPathBuffer.arcTo(this.mInnerRectBuffer, f23, -f22);
                        } else {
                            this.mPathBuffer.addCircle(mPPointF.f195x, mPPointF.f196y, f8, Path.Direction.CCW);
                            f3 = phaseX;
                            f = phaseY;
                        }
                    }
        ...
        if (this.mChart.isDrawRoundedSlicesEnabled()) {
            ...
            if (dataSet.isVisible()) {
                ...
                while (i < dataSet.getEntryCount()) {
                    ...
                    if (Math.abs(dataSet.getEntryForIndex(i).getY()) > C1030Utils.FLOAT_EPSILON) {
                        double d = (double) (radius - holeRadius);
                        double d2 = (double) ((rotationAngle + f3) * phaseY);
                        f = phaseY;
                        fArr = drawAngles;
                        f2 = rotationAngle;
                        float cos = (float) (((double) centerCircleBox.f195x) + (Math.cos(Math.toRadians(d2)) * d));
                        float sin = (float) ((d * Math.sin(Math.toRadians(d2))) + ((double) centerCircleBox.f196y));
