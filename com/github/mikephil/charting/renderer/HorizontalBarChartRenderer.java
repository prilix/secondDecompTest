...
public class HorizontalBarChartRenderer extends BarChartRenderer {
    ...
    public void drawDataSet(Canvas canvas, IBarDataSet iBarDataSet, int i) {
        ...
        this.mBarBorderPaint.setStrokeWidth(C1030Utils.convertDpToPixel(iBarDataSet.getBarBorderWidth()));
        int i3 = 0;
        boolean z = true;
        ...
        if (isDrawingValuesAllowed(this.mChart)) {
            ...
            while (i6 < this.mChart.getBarData().getDataSetCount()) {
                ...
                if (!shouldDrawValues(iBarDataSet)) {
                    ...
                    float f5 = 2.0f;
                    float calcTextHeight = ((float) C1030Utils.calcTextHeight(this.mValuePaint, "10")) / 2.0f;
                    ...
                    instance.f195x = C1030Utils.convertDpToPixel(instance.f195x);
                    instance.f196y = C1030Utils.convertDpToPixel(instance.f196y);
                    if (!iBarDataSet.isStacked()) {
                        ...
                        while (((float) i7) < ((float) barBuffer2.buffer.length) * this.mAnimator.getPhaseX()) {
                            ...
                            if (this.mViewPortHandler.isInBoundsX(barBuffer2.buffer[i7]) && this.mViewPortHandler.isInBoundsBottom(barBuffer2.buffer[i8])) {
                                ...
                                float calcTextWidth = (float) C1030Utils.calcTextWidth(this.mValuePaint, barLabel);
                                String str = barLabel;
                                ...
                                if (barEntry2.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                    ...
                                    C1030Utils.drawImage(canvas, icon, (int) (f14 + f9 + mPPointF2.f195x), (int) (f6 + mPPointF2.f196y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                                }
                            } else {
                                i4 = i7;
                                list2 = dataSets;
                        ...
                        while (((float) i9) < ((float) iBarDataSet.getEntryCount()) * this.mAnimator.getPhaseX()) {
                            ...
                            if (yVals != null) {
                                ...
                                while (true) {
                                    ...
                                    float calcTextWidth2 = (float) C1030Utils.calcTextWidth(this.mValuePaint, barStackedLabel);
                                    ...
                                    if (this.mViewPortHandler.isInBoundsX(f24) && this.mViewPortHandler.isInBoundsBottom(f25)) {
                                        ...
                                        if (barEntry4.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                            ...
                                            C1030Utils.drawImage(canvas, icon2, (int) (f2 + mPPointF.f195x), (int) (f + mPPointF.f196y), icon2.getIntrinsicWidth(), icon2.getIntrinsicHeight());
                                        }
                                    } else {
                                        i3 = i14;
                                        fArr2 = fArr3;
                                ...
                                if (!this.mViewPortHandler.isInBoundsTop(barBuffer3.buffer[i16])) {
                                    ...
                                    float calcTextWidth3 = (float) C1030Utils.calcTextWidth(this.mValuePaint, barLabel2);
                                    ...
                                    if (barEntry.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                        ...
                                        C1030Utils.drawImage(canvas, icon3, (int) (f32 + f30 + mPPointF.f195x), (int) (barBuffer3.buffer[i16] + mPPointF.f196y), icon3.getIntrinsicWidth(), icon3.getIntrinsicHeight());
                                    }
                                }
                            }
