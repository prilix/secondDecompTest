...
public abstract class LineRadarRenderer extends LineScatterCandleRadarRenderer {
    ...
    public void drawFilledPath(Canvas canvas, Path path, Drawable drawable) {
        ...
        throw new RuntimeException("Fill-drawables not (yet) supported below API level 18, this code was run on API level " + C1030Utils.getSDKInt() + ".");
    }
    ...
    private boolean clipPathSupported() {
        return C1030Utils.getSDKInt() >= 18;
    }
}
