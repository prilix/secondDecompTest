...
public class BarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    public void drawValues(Canvas canvas) {
        ...
        if (isDrawingValuesAllowed(this.mChart)) {
            ...
            float convertDpToPixel = C1030Utils.convertDpToPixel(4.5f);
            ...
            while (i5 < this.mChart.getBarData().getDataSetCount()) {
                ...
                if (!shouldDrawValues(iBarDataSet)) {
                    ...
                    float calcTextHeight = (float) C1030Utils.calcTextHeight(this.mValuePaint, "8");
                        ...
                        while (((float) i6) < ((float) barBuffer.buffer.length) * this.mAnimator.getPhaseX()) {
                            ...
                            if (!this.mViewPortHandler.isInBoundsY(barBuffer.buffer[i7]) || !this.mViewPortHandler.isInBoundsLeft(f13)) {
                                ...
                                if (barEntry3.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                    ...
                                    C1030Utils.drawImage(canvas, icon, (int) (f8 + mPPointF2.f195x), (int) ((y >= 0.0f ? barBuffer.buffer[i7] + f11 : barBuffer.buffer[i4 + 3] + f12) + mPPointF2.f196y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                                }
                            }
                            i6 = i4 + 4;
                            instance = mPPointF2;
                            ...
                            if (yVals != null) {
                                ...
                                while (i15 < length) {
                                    ...
                                    if (!this.mViewPortHandler.isInBoundsY(f22) || !this.mViewPortHandler.isInBoundsLeft(f16)) {
                                        ...
                                        if (barEntry.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                            ...
                                            C1030Utils.drawImage(canvas, icon2, (int) (f4 + mPPointF.f195x), (int) (f5 + mPPointF.f196y), icon2.getIntrinsicWidth(), icon2.getIntrinsicHeight());
                                        }
                                    }
                                    i15 = i3 + 2;
                                    fArr4 = fArr2;
                                ...
                                if (!this.mViewPortHandler.isInBoundsY(barBuffer.buffer[i17]) || !this.mViewPortHandler.isInBoundsLeft(f15)) {
                                    ...
                                    if (barEntry2.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                        ...
                                        C1030Utils.drawImage(canvas, icon3, (int) (mPPointF.f195x + f7), (int) (barBuffer.buffer[i17] + (barEntry2.getY() >= 0.0f ? f11 : f12) + mPPointF.f196y), icon3.getIntrinsicWidth(), icon3.getIntrinsicHeight());
                                    }
                                }
                            }
