...
public class XAxisRendererHorizontalBarChart extends XAxisRenderer {
    ...
    public void computeSize() {
        ...
        FSize calcTextSize = C1030Utils.calcTextSize(this.mAxisLabelPaint, this.mXAxis.getLongestLabel());
        float f = calcTextSize.height;
        FSize sizeOfRotatedRectangleByDegrees = C1030Utils.getSizeOfRotatedRectangleByDegrees(calcTextSize.width, f, this.mXAxis.getLabelRotationAngle());
