...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    public void renderAxisLabels(Canvas canvas) {
        ...
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            float convertDpToPixel = C1030Utils.convertDpToPixel(2.5f);
    ...
    public void drawZeroLine(Canvas canvas) {
        ...
        path.reset();
        path.moveTo(((float) pixelForValues.f193x) - 1.0f, this.mViewPortHandler.contentTop());
        path.lineTo(((float) pixelForValues.f193x) - 1.0f, this.mViewPortHandler.contentBottom());
            ...
            while (i < limitLines.size()) {
                ...
                if (limitLine.isEnabled()) {
                    ...
                    if (label != null && !label.equals("")) {
                        ...
                        float convertDpToPixel = C1030Utils.convertDpToPixel(2.0f) + limitLine.getYOffset();
                        LimitLine.LimitLabelPosition labelPosition = limitLine.getLabelPosition();
                        if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_TOP) {
                            this.mLimitLinePaint.setTextAlign(Paint.Align.LEFT);
                            canvas2.drawText(label, fArr[0] + lineWidth, this.mViewPortHandler.contentTop() + convertDpToPixel + ((float) C1030Utils.calcTextHeight(this.mLimitLinePaint, label)), this.mLimitLinePaint);
