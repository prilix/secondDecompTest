...
public class RadarChartRenderer extends LineRadarRenderer {
    ...
    public RadarChartRenderer(RadarChart radarChart, ChartAnimator chartAnimator, ViewPortHandler viewPortHandler) {
        ...
        this.mHighlightPaint.setColor(Color.rgb(255, C1662R2.attr.bubbleTextColor, 115));
    ...
    public void drawDataSet(Canvas canvas, IRadarDataSet iRadarDataSet, int i) {
        ...
        for (int i2 = 0; i2 < iRadarDataSet.getEntryCount(); i2++) {
            ...
            C1030Utils.getPosition(centerOffsets, (((RadarEntry) iRadarDataSet.getEntryForIndex(i2)).getY() - this.mChart.getYChartMin()) * factor * phaseY, (((float) i2) * sliceAngle * phaseX) + this.mChart.getRotationAngle(), instance);
            if (!Float.isNaN(instance.f195x)) {
                if (!z) {
                    path.moveTo(instance.f195x, instance.f196y);
                    z = true;
                } else {
                    path.lineTo(instance.f195x, instance.f196y);
                }
            }
        }
        if (iRadarDataSet.getEntryCount() > i) {
            path.lineTo(centerOffsets.f195x, centerOffsets.f196y);
        }
        path.close();
    ...
    public void drawValues(Canvas canvas) {
        ...
        float convertDpToPixel = C1030Utils.convertDpToPixel(5.0f);
        int i4 = 0;
        while (i4 < ((RadarData) this.mChart.getData()).getDataSetCount()) {
            ...
            if (!shouldDrawValues(iRadarDataSet2)) {
                ...
                instance3.f195x = C1030Utils.convertDpToPixel(instance3.f195x);
                instance3.f196y = C1030Utils.convertDpToPixel(instance3.f196y);
                int i5 = 0;
                while (i5 < iRadarDataSet2.getEntryCount()) {
                    ...
                    C1030Utils.getPosition(centerOffsets, (radarEntry2.getY() - this.mChart.getYChartMin()) * factor * phaseY, f3 + this.mChart.getRotationAngle(), instance);
                    if (iRadarDataSet2.isDrawValuesEnabled()) {
                        String radarLabel = valueFormatter2.getRadarLabel(radarEntry2);
                        float f4 = instance.f195x;
                        radarEntry = radarEntry2;
                        float f5 = instance.f196y - convertDpToPixel;
                    ...
                    if (radarEntry.getIcon() != null && iRadarDataSet.isDrawIconsEnabled()) {
                        ...
                        C1030Utils.getPosition(centerOffsets, (radarEntry.getY() * factor * phaseY) + mPPointF.f196y, f3 + this.mChart.getRotationAngle(), instance2);
                        instance2.f196y += mPPointF.f195x;
                        C1030Utils.drawImage(canvas, icon, (int) instance2.f195x, (int) instance2.f196y, icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                    }
                    i5 = i2 + 1;
                    instance3 = mPPointF;
    ...
    public void drawWeb(Canvas canvas) {
        ...
        for (int i = 0; i < entryCount; i += skipWebLineCount) {
            C1030Utils.getPosition(centerOffsets, this.mChart.getYRange() * factor, (((float) i) * sliceAngle) + rotationAngle, instance);
            canvas.drawLine(centerOffsets.f195x, centerOffsets.f196y, instance.f195x, instance.f196y, this.mWebPaint);
        }
        MPPointF.recycleInstance(instance);
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            while (i4 < ((RadarData) this.mChart.getData()).getEntryCount()) {
                ...
                C1030Utils.getPosition(centerOffsets, yChartMin, (((float) i4) * sliceAngle) + rotationAngle, instance2);
                i4++;
                C1030Utils.getPosition(centerOffsets, yChartMin, (((float) i4) * sliceAngle) + rotationAngle, instance3);
                canvas.drawLine(instance2.f195x, instance2.f196y, instance3.f195x, instance3.f196y, this.mWebPaint);
            }
        }
        MPPointF.recycleInstance(instance2);
        MPPointF.recycleInstance(instance3);
        ...
        while (i3 < length) {
            ...
            if (iRadarDataSet != null && iRadarDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(radarEntry, iRadarDataSet)) {
                    C1030Utils.getPosition(centerOffsets, (radarEntry.getY() - this.mChart.getYChartMin()) * factor * this.mAnimator.getPhaseY(), (highlight.getX() * sliceAngle * this.mAnimator.getPhaseX()) + this.mChart.getRotationAngle(), instance);
                    highlight.setDraw(instance.f195x, instance.f196y);
                    drawHighlightLines(canvas, instance.f195x, instance.f196y, iRadarDataSet);
                    if (iRadarDataSet.isDrawHighlightCircleEnabled() && !Float.isNaN(instance.f195x) && !Float.isNaN(instance.f196y)) {
    ...
    public void drawHighlightCircle(Canvas canvas, MPPointF mPPointF, float f, float f2, int i, int i2, float f3) {
        canvas.save();
        float convertDpToPixel = C1030Utils.convertDpToPixel(f2);
        float convertDpToPixel2 = C1030Utils.convertDpToPixel(f);
        if (i != 1122867) {
            Path path = this.mDrawHighlightCirclePathBuffer;
            path.reset();
            path.addCircle(mPPointF.f195x, mPPointF.f196y, convertDpToPixel, Path.Direction.CW);
            if (convertDpToPixel2 > 0.0f) {
                path.addCircle(mPPointF.f195x, mPPointF.f196y, convertDpToPixel2, Path.Direction.CCW);
            }
        ...
        if (i2 != 1122867) {
            ...
            this.mHighlightCirclePaint.setStrokeWidth(C1030Utils.convertDpToPixel(f3));
            canvas.drawCircle(mPPointF.f195x, mPPointF.f196y, convertDpToPixel, this.mHighlightCirclePaint);
        }
        canvas.restore();
    }
}
