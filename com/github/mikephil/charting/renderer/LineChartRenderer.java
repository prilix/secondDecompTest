...
public class LineChartRenderer extends LineRadarRenderer {
    ...
    public void drawDataSet(Canvas canvas, ILineDataSet iLineDataSet) {
        if (iLineDataSet.getEntryCount() >= 1) {
            ...
            int i = C10281.$SwitchMap$com$github$mikephil$charting$data$LineDataSet$Mode[iLineDataSet.getMode().ordinal()];
            if (i == 3) {
    ...
    static /* synthetic */ class C10281 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.renderer.LineChartRenderer.C10281.<clinit>():void");
        }
    }
                    ...
                    while (i4 < generateTransformedValuesLine.length) {
                        ...
                        if (!this.mViewPortHandler.isInBoundsLeft(f) || !this.mViewPortHandler.isInBoundsY(f2)) {
                            ...
                            if (entry.getIcon() != null && iLineDataSet.isDrawIconsEnabled()) {
                                ...
                                C1030Utils.drawImage(canvas, icon, (int) (f + instance.f195x), (int) (f2 + instance.f196y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                            }
                        }
                        i4 += 2;
        ...
        while (i < dataSets.size()) {
            ...
            if (iLineDataSet.isVisible() && iLineDataSet.isDrawCirclesEnabled() && iLineDataSet.getEntryCount() != 0) {
                ...
                if (this.mImageCaches.containsKey(iLineDataSet)) {
                    ...
                    dataSetImageCache = new DataSetImageCache(this, (C10281) null);
        ...
        for (Highlight highlight : highlightArr) {
            ...
            if (iLineDataSet != null && iLineDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(entryForXValue, iLineDataSet)) {
                    ...
                    highlight.setDraw((float) pixelForValues.f193x, (float) pixelForValues.f194y);
                    drawHighlightLines(canvas, (float) pixelForValues.f193x, (float) pixelForValues.f194y, iLineDataSet);
                }
            }
        }
    }
    ...
    private class DataSetImageCache {
        ...
        /* synthetic */ DataSetImageCache(LineChartRenderer lineChartRenderer, C10281 r2) {
            this();
        }
