...
public class XAxisRenderer extends AxisRenderer {
    ...
    public XAxisRenderer(ViewPortHandler viewPortHandler, XAxis xAxis, Transformer transformer) {
        ...
        this.mAxisLabelPaint.setTextSize(C1030Utils.convertDpToPixel(10.0f));
    }
    ...
    public void computeAxis(float f, float f2, boolean z) {
        ...
        if (this.mViewPortHandler.contentWidth() > 10.0f && !this.mViewPortHandler.isFullyZoomedOutX()) {
            ...
            if (z) {
                f3 = (float) valuesByTouchPoint2.f193x;
                d = valuesByTouchPoint.f193x;
            } else {
                f3 = (float) valuesByTouchPoint.f193x;
                d = valuesByTouchPoint2.f193x;
            }
    ...
    public void computeSize() {
        ...
        FSize calcTextSize = C1030Utils.calcTextSize(this.mAxisLabelPaint, longestLabel);
        float f = calcTextSize.width;
        float calcTextHeight = (float) C1030Utils.calcTextHeight(this.mAxisLabelPaint, "Q");
        FSize sizeOfRotatedRectangleByDegrees = C1030Utils.getSizeOfRotatedRectangleByDegrees(f, calcTextHeight, this.mXAxis.getLabelRotationAngle());
            ...
            if (this.mViewPortHandler.isInBoundsX(f2)) {
                ...
                if (this.mXAxis.isAvoidFirstLastClippingEnabled()) {
                    if (i4 == this.mXAxis.mEntryCount - 1 && this.mXAxis.mEntryCount > 1) {
                        float calcTextWidth = (float) C1030Utils.calcTextWidth(this.mAxisLabelPaint, axisLabel);
                        ...
                        f2 += ((float) C1030Utils.calcTextWidth(this.mAxisLabelPaint, axisLabel)) / 2.0f;
                    }
                }
    ...
    public void drawLabel(Canvas canvas, String str, float f, float f2, MPPointF mPPointF, float f3) {
        C1030Utils.drawXAxisValue(canvas, str, f, f2, this.mAxisLabelPaint, mPPointF, f3);
    }
    ...
    public void renderLimitLineLabel(Canvas canvas, LimitLine limitLine, float[] fArr, float f) {
        ...
        if (label != null && !label.equals("")) {
            ...
            if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_TOP) {
                ...
                canvas.drawText(label, fArr[0] + lineWidth, this.mViewPortHandler.contentTop() + f + ((float) C1030Utils.calcTextHeight(this.mLimitLinePaint, label)), this.mLimitLinePaint);
