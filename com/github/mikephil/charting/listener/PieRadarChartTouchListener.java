    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        if (!this.mGestureDetector.onTouchEvent(motionEvent) && ((PieRadarChartBase) this.mChart).isRotationEnabled()) {
            ...
            if (action == 0) {
                ...
                this.mTouchStartPoint.f195x = x;
                this.mTouchStartPoint.f196y = y;
            } else if (action == 1) {
                if (((PieRadarChartBase) this.mChart).isDragDecelerationEnabled()) {
                    stopDeceleration();
                    sampleVelocity(x, y);
                ...
                if (this.mTouchMode == 0 && distance(x, this.mTouchStartPoint.f195x, y, this.mTouchStartPoint.f196y) > C1030Utils.convertDpToPixel(8.0f)) {
