...
public class BarLineChartTouchListener extends ChartTouchListener<BarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>>> {
    ...
    public BarLineChartTouchListener(BarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> barLineChartBase, Matrix matrix, float f) {
        ...
        this.mMatrix = matrix;
        this.mDragTriggerDist = C1030Utils.convertDpToPixel(f);
        this.mMinScalePointerDistance = C1030Utils.convertDpToPixel(3.5f);
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (action != 0) {
            ...
            if (action == 1) {
                ...
                velocityTracker2.computeCurrentVelocity(1000, (float) C1030Utils.getMaximumFlingVelocity());
                float yVelocity = velocityTracker2.getYVelocity(pointerId);
                float xVelocity = velocityTracker2.getXVelocity(pointerId);
                if ((Math.abs(xVelocity) > ((float) C1030Utils.getMinimumFlingVelocity()) || Math.abs(yVelocity) > ((float) C1030Utils.getMinimumFlingVelocity())) && this.mTouchMode == 1 && ((BarLineChartBase) this.mChart).isDragDecelerationEnabled()) {
                    stopDeceleration();
                    this.mDecelerationLastTime = AnimationUtils.currentAnimationTimeMillis();
                    this.mDecelerationCurrentPoint.f195x = motionEvent.getX();
                    this.mDecelerationCurrentPoint.f196y = motionEvent.getY();
                    this.mDecelerationVelocity.f195x = xVelocity;
                    this.mDecelerationVelocity.f196y = yVelocity;
                    C1030Utils.postInvalidateOnAnimation(this.mChart);
                }
                ...
                if (action == 3) {
                    ...
                    if (action == 6) {
                        C1030Utils.velocityTrackerPointerUpCleanUpIfNecessary(motionEvent, this.mVelocityTracker);
                        this.mTouchMode = 5;
                    }
                ...
                ((BarLineChartBase) this.mChart).disableScroll();
                float f = 0.0f;
                float x = ((BarLineChartBase) this.mChart).isDragXEnabled() ? motionEvent.getX() - this.mTouchStartPoint.f195x : 0.0f;
                if (((BarLineChartBase) this.mChart).isDragYEnabled()) {
                    f = motionEvent.getY() - this.mTouchStartPoint.f196y;
                }
            ...
            } else if (this.mTouchMode == 0 && Math.abs(distance(motionEvent.getX(), this.mTouchStartPoint.f195x, motionEvent.getY(), this.mTouchStartPoint.f196y)) > this.mDragTriggerDist && ((BarLineChartBase) this.mChart).isDragEnabled()) {
                if (!((BarLineChartBase) this.mChart).isFullyZoomedOut() || !((BarLineChartBase) this.mChart).hasNoDragOffset()) {
                    z = true;
                }
                if (z) {
                    float abs = Math.abs(motionEvent.getX() - this.mTouchStartPoint.f195x);
                    float abs2 = Math.abs(motionEvent.getY() - this.mTouchStartPoint.f196y);
    ...
    private void saveTouchStart(MotionEvent motionEvent) {
        ...
        this.mTouchStartPoint.f195x = motionEvent.getX();
        this.mTouchStartPoint.f196y = motionEvent.getY();
    ...
    private void performZoom(MotionEvent motionEvent) {
        ...
        if (motionEvent.getPointerCount() >= 2) {
            ...
            if (spacing > this.mMinScalePointerDistance) {
                MPPointF trans = getTrans(this.mTouchPointCenter.f195x, this.mTouchPointCenter.f196y);
                ...
                if (this.mTouchMode == 4) {
                    ...
                    if (z4 || z3) {
                        this.mMatrix.set(this.mSavedMatrix);
                        this.mMatrix.postScale(f3, f, trans.f195x, trans.f196y);
                        if (onChartGestureListener != null) {
                    ...
                    if (z2) {
                        this.mMatrix.set(this.mSavedMatrix);
                        this.mMatrix.postScale(xDist, 1.0f, trans.f195x, trans.f196y);
                        if (onChartGestureListener != null) {
                    ...
                    if (z) {
                        this.mMatrix.set(this.mSavedMatrix);
                        this.mMatrix.postScale(1.0f, yDist, trans.f195x, trans.f196y);
                        if (onChartGestureListener != null) {
    ...
    private static void midPoint(MPPointF mPPointF, MotionEvent motionEvent) {
        mPPointF.f195x = (motionEvent.getX(0) + motionEvent.getX(1)) / 2.0f;
        mPPointF.f196y = (motionEvent.getY(0) + motionEvent.getY(1)) / 2.0f;
    }
    ...
    public boolean onDoubleTap(MotionEvent motionEvent) {
        ...
        if (((BarLineChartBase) this.mChart).isDoubleTapToZoomEnabled() && ((BarLineScatterCandleBubbleData) ((BarLineChartBase) this.mChart).getData()).getEntryCount() > 0) {
            ...
            barLineChartBase.zoom(f2, f, trans.f195x, trans.f196y);
            if (((BarLineChartBase) this.mChart).isLogEnabled()) {
                Log.i("BarlineChartTouch", "Double-Tap, Zooming In, x: " + trans.f195x + ", y: " + trans.f196y);
            }
            MPPointF.recycleInstance(trans);
        }
    ...
    public void stopDeceleration() {
        this.mDecelerationVelocity.f195x = 0.0f;
        this.mDecelerationVelocity.f196y = 0.0f;
    }

    public void computeScroll() {
        float f = 0.0f;
        if (this.mDecelerationVelocity.f195x != 0.0f || this.mDecelerationVelocity.f196y != 0.0f) {
            long currentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
            this.mDecelerationVelocity.f195x *= ((BarLineChartBase) this.mChart).getDragDecelerationFrictionCoef();
            this.mDecelerationVelocity.f196y *= ((BarLineChartBase) this.mChart).getDragDecelerationFrictionCoef();
            float f2 = ((float) (currentAnimationTimeMillis - this.mDecelerationLastTime)) / 1000.0f;
            float f3 = this.mDecelerationVelocity.f195x * f2;
            float f4 = this.mDecelerationVelocity.f196y * f2;
            this.mDecelerationCurrentPoint.f195x += f3;
            this.mDecelerationCurrentPoint.f196y += f4;
            MotionEvent obtain = MotionEvent.obtain(currentAnimationTimeMillis, currentAnimationTimeMillis, 2, this.mDecelerationCurrentPoint.f195x, this.mDecelerationCurrentPoint.f196y, 0);
            float f5 = ((BarLineChartBase) this.mChart).isDragXEnabled() ? this.mDecelerationCurrentPoint.f195x - this.mTouchStartPoint.f195x : 0.0f;
            if (((BarLineChartBase) this.mChart).isDragYEnabled()) {
                f = this.mDecelerationCurrentPoint.f196y - this.mTouchStartPoint.f196y;
            }
            ...
            if (((double) Math.abs(this.mDecelerationVelocity.f195x)) >= 0.01d || ((double) Math.abs(this.mDecelerationVelocity.f196y)) >= 0.01d) {
                C1030Utils.postInvalidateOnAnimation(this.mChart);
                return;
            }
            ((BarLineChartBase) this.mChart).calculateOffsets();
