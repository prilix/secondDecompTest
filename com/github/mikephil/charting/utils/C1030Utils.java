...
/* renamed from: com.github.mikephil.charting.utils.Utils */
public abstract class C1030Utils {
    ...
    public static void drawImage(Canvas canvas, Drawable drawable, int i, int i2, int i3, int i4) {
        ...
        instance.f195x = (float) (i - (i3 / 2));
        instance.f196y = (float) (i2 - (i4 / 2));
        ...
        canvas.translate(instance.f195x, instance.f196y);
    ...
    public static void drawXAxisValue(Canvas canvas, String str, float f, float f2, Paint paint, MPPointF mPPointF, float f3) {
        ...
        if (f3 != 0.0f) {
            ...
            if (!(mPPointF.f195x == 0.5f && mPPointF.f196y == 0.5f)) {
                FSize sizeOfRotatedRectangleByDegrees = getSizeOfRotatedRectangleByDegrees((float) mDrawTextRectBuffer.width(), fontMetrics, f3);
                f -= sizeOfRotatedRectangleByDegrees.width * (mPPointF.f195x - 0.5f);
                f2 -= sizeOfRotatedRectangleByDegrees.height * (mPPointF.f196y - 0.5f);
            ...
            if (!(mPPointF.f195x == 0.0f && mPPointF.f196y == 0.0f)) {
                f4 -= ((float) mDrawTextRectBuffer.width()) * mPPointF.f195x;
                f5 -= fontMetrics * mPPointF.f196y;
            }
    ...
    public static void drawMultilineText(Canvas canvas, StaticLayout staticLayout, float f, float f2, TextPaint textPaint, MPPointF mPPointF, float f3) {
        ...
        if (f3 != 0.0f) {
            ...
            if (!(mPPointF.f195x == 0.0f && mPPointF.f196y == 0.0f)) {
                f4 -= width * mPPointF.f195x;
                f5 -= lineCount * mPPointF.f196y;
            }
            canvas.save();
