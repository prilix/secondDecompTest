    ...
    static class Token {
        ...
        static Token parse(String str) {
            ...
            try {
                ...
                return new Token(jSONObject.getString("token"), jSONObject.getString(Constants.JsonKeys.APP_VERSION), jSONObject.getLong("timestamp"));
        ...
        static String encode(String str, String str2, long j) {
            try {
                ...
                jSONObject.put(Constants.JsonKeys.APP_VERSION, str2);
