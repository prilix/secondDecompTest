...
public class HttpRequest {
    private static final OkHttpClient CLIENT = new OkHttpClient().newBuilder().callTimeout(Constants.VALID_WIFI_CONNECTION_CHECK_TIMEOUT, TimeUnit.MILLISECONDS).build();
