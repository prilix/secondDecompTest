...
public class CompositeCreateReportSpiCall implements CreateReportSpiCall {
    ...
    static /* synthetic */ class C14601 {
        ...
        static final /* synthetic */ int[] f252xc221d5a6;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f252xc221d5a6     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.crashlytics.internal.report.network.CompositeCreateReportSpiCall.C14601.<clinit>():void");
        }
    }

    public boolean invoke(CreateReportRequest createReportRequest, boolean z) {
        int i = C14601.f252xc221d5a6[createReportRequest.report.getType().ordinal()];
        if (i == 1) {
