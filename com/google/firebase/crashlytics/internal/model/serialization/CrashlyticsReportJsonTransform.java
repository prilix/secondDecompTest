        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case -1291329255:
                    ...
                    break;
                case C1662R2.C1664drawable.notification_template_icon_low_bg /*3556*/:
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case 104069929:
                    ...
                    break;
                case 109757585:
                    if (nextName.equals(Constants.Alexa.STATE)) {
                        c = 7;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case -887523944:
                    ...
                    break;
                case C1662R2.C1664drawable.red_border_without_radius /*3571*/:
