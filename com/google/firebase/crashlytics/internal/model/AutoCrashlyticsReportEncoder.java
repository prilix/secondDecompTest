...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        ...
        encoderConfig.registerEncoder((Class<U>) C1445x7e3e3ebd.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationExecutionThreadEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.class, (ObjectEncoder<? super U>) C1427xc3999712.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C1447xce3d994b.class, (ObjectEncoder<? super U>) C1427xc3999712.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.Exception.class, (ObjectEncoder<? super U>) C1426x55689506.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C1441xc2f5febc.class, (ObjectEncoder<? super U>) C1426x55689506.INSTANCE);
        ...
        encoderConfig.registerEncoder((Class<U>) C1443x7c929f5b.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationExecutionSignalEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.class, (ObjectEncoder<? super U>) C1425x99c932db.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C1439xfe724d07.class, (ObjectEncoder<? super U>) C1425x99c932db.INSTANCE);
    ...
    private static final class CrashlyticsReportEncoder implements ObjectEncoder<CrashlyticsReport> {
        ...
        public void encode(CrashlyticsReport crashlyticsReport, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(Constants.AMP_TRACKING_OPTION_PLATFORM, crashlyticsReport.getPlatform());
    ...
    private static final class CrashlyticsReportSessionOperatingSystemEncoder implements ObjectEncoder<CrashlyticsReport.Session.OperatingSystem> {
        ...
        public void encode(CrashlyticsReport.Session.OperatingSystem operatingSystem, ObjectEncoderContext objectEncoderContext) throws IOException {
            objectEncoderContext.add(Constants.AMP_TRACKING_OPTION_PLATFORM, operatingSystem.getPlatform());
    ...
    private static final class CrashlyticsReportSessionDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Device> {
        ...
        public void encode(CrashlyticsReport.Session.Device device, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(Constants.Alexa.STATE, device.getState());
    ...
    private static final class C1427xc3999712 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> {
        static final C1427xc3999712 INSTANCE = new C1427xc3999712();

        private C1427xc3999712() {
        }
    ...
    private static final class C1426x55689506 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Exception> {
        static final C1426x55689506 INSTANCE = new C1426x55689506();

        private C1426x55689506() {
        }
    ...
    private static final class C1425x99c932db implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.BinaryImage> {
        static final C1425x99c932db INSTANCE = new C1425x99c932db();

        private C1425x99c932db() {
        }
