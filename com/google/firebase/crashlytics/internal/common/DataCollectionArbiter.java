...
public class DataCollectionArbiter {
    ...
    public Task<Void> waitForDataCollectionPermission() {
        return C1417Utils.race(this.dataCollectionExplicitlyApproved.getTask(), waitForAutomaticDataCollectionEnabled());
    }
    ...
    private void logDataCollectionState(boolean z) {
        ...
        Logger.getLogger().mo24918d(String.format("Crashlytics automatic data collection %s by %s.", new Object[]{str2, str}));
    }
    ...
    private static Boolean readCrashlyticsDataCollectionEnabledFromManifest(Context context) {
        ...
        try {
            ...
            Logger.getLogger().mo24919d("Unable to get PackageManager. Falling through", e);
            return null;
        }
    }
