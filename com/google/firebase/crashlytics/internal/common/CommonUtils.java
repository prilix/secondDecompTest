...
public class CommonUtils {
    ...
    public static java.lang.String extractFieldFromSystemFile(java.io.File r6, java.lang.String r7) {
        ...
        L_0x0040:
            ...
            r3.mo24921e(r6, r7)     // Catch:{ all -> 0x0059 }
            goto L_0x0036
        L_0x0059:
            r6 = move-exception
            r2 = r1
    ...
    enum Architecture {
        ...
        static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Logger.getLogger().mo24918d("Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
                ...
                if (!TextUtils.isEmpty(extractFieldFromSystemFile)) {
                    ...
                    try {
                        if (upperCase.endsWith("KB")) {
                            ...
                            logger.mo24918d("Unexpected meminfo format while computing RAM: " + upperCase);
                        }
                    } catch (NumberFormatException e) {
                        Logger logger2 = Logger.getLogger();
                        logger2.mo24921e("Unexpected meminfo format while computing RAM: " + upperCase, e);
                    }
                }
                totalRamInBytes = j2;
            }
    ...
    private static String hash(InputStream inputStream, String str) {
        try {
            ...
            Logger.getLogger().mo24921e("Could not calculate hash for app icon.", e);
            return "";
        }
    }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            Logger logger = Logger.getLogger();
            logger.mo24921e("Could not create hashing algorithm: " + str + ", returning empty string.", e);
            return "";
        }
    }
    ...
    public static void closeOrLog(Closeable closeable, String str) {
        if (closeable != null) {
            try {
                ...
                Logger.getLogger().mo24921e(str, e);
            }
        }
    }
    ...
    public static String getAppIconHashOrNull(Context context) {
        ...
        try {
            ...
            try {
                ...
                e = e;
                try {
                    Logger.getLogger().mo24928w("Could not calculate hash for app icon:" + e.getMessage());
                    closeOrLog(inputStream, "Failed to close icon input stream.");
                    return null;
                } catch (Throwable th) {
                    th = th;
    ...
    public static String resolveUnityEditorVersion(Context context) {
        ...
        Logger logger = Logger.getLogger();
        logger.mo24918d("Unity Editor version is: " + string);
        return string;
    }
