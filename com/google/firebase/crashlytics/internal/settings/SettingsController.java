...
public class SettingsController implements SettingsDataProvider {
                ...
                if (parseSettingsJson != null) {
                    ...
                    if (!SettingsCacheBehavior.IGNORE_CACHE_EXPIRATION.equals(settingsCacheBehavior)) {
                        if (parseSettingsJson.isExpired(currentTimeMillis)) {
                            Logger.getLogger().mo24918d("Cached settings have expired.");
                            return null;
                        }
                    }
                    try {
                        Logger.getLogger().mo24918d("Returning cached settings.");
                        return parseSettingsJson;
                    } catch (Exception e) {
                        e = e;
                        settingsData = parseSettingsJson;
                        Logger.getLogger().mo24921e("Failed to get cached settings", e);
                        return settingsData;
                    }
                } else {
                    Logger.getLogger().mo24921e("Failed to parse cached settings data.", (Throwable) null);
                    return null;
                }
            } else {
                Logger.getLogger().mo24918d("No cached settings data found.");
                return null;
            }
        } catch (Exception e2) {
            e = e2;
    ...
    public void logSettings(JSONObject jSONObject, String str) throws JSONException {
        ...
        logger.mo24918d(str + jSONObject.toString());
    }
