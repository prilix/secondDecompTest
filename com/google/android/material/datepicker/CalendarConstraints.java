...
public final class CalendarConstraints implements Parcelable {
    ...
    public static final class Builder {
        ...
        static final long DEFAULT_END = UtcDates.canonicalYearMonthDay(Month.create(C1662R2.dimen.abc_seekbar_track_background_height_material, 11).timeInMillis);
        static final long DEFAULT_START = UtcDates.canonicalYearMonthDay(Month.create(C1662R2.C1663color.material_grey_300, 0).timeInMillis);
