...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public BottomSheetDialog(Context context) {
        this(context, 0);
        this.edgeToEdgeEnabled = getContext().getTheme().obtainStyledAttributes(new int[]{C1059R.attr.enableEdgeToEdge}).getBoolean(0, false);
    }
    ...
    public void onAttachedToWindow() {
        ...
        if (window != null && Build.VERSION.SDK_INT >= 21) {
            ...
            if (z) {
                window.getDecorView().setSystemUiVisibility(C1662R2.attr.materialAlertDialogBodyTextStyle);
            }
        }
    }
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C1059R.layout.design_bottom_sheet_dialog, (ViewGroup) null);
            this.container = frameLayout;
            this.coordinator = (CoordinatorLayout) frameLayout.findViewById(C1059R.C1062id.coordinator);
            FrameLayout frameLayout2 = (FrameLayout) this.container.findViewById(C1059R.C1062id.design_bottom_sheet);
    ...
    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) this.container.findViewById(C1059R.C1062id.coordinator);
        if (i != 0 && view == null) {
        ...
        coordinatorLayout.findViewById(C1059R.C1062id.touch_outside).setOnClickListener(new View.OnClickListener() {
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        if (context.getTheme().resolveAttribute(C1059R.attr.bottomSheetDialogTheme, typedValue, true)) {
            return typedValue.resourceId;
        }
        return C1059R.style.Theme_Design_Light_BottomSheetDialog;
    }
