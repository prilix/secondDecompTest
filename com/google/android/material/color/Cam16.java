...
final class Cam16 {
    ...
    /* renamed from: j */
    private final float f224j;
    private final float jstar;

    /* renamed from: m */
    private final float f225m;

    /* renamed from: q */
    private final float f226q;
    ...
    public static Cam16 fromUcsInViewingConditions(float f, float f2, float f3, ViewingConditions viewingConditions) {
        ...
        if (atan2 < C1030Utils.DOUBLE_EPSILON) {
            atan2 += 360.0d;
        }
    ...
    public int viewed(ViewingConditions viewingConditions) {
        float pow = (float) Math.pow(((double) ((((double) getChroma()) == C1030Utils.DOUBLE_EPSILON || ((double) getJ()) == C1030Utils.DOUBLE_EPSILON) ? 0.0f : getChroma() / ((float) Math.sqrt(((double) getJ()) / 100.0d)))) / Math.pow(1.64d - Math.pow(0.29d, (double) viewingConditions.getN()), 0.73d), 1.1111111111111112d);
        ...
        float signum = Math.signum(f5) * (100.0f / viewingConditions.getFl()) * ((float) Math.pow((double) ((float) Math.max(C1030Utils.DOUBLE_EPSILON, (((double) Math.abs(f5)) * 27.13d) / (400.0d - ((double) Math.abs(f5))))), 2.380952380952381d));
        float signum2 = Math.signum(f6) * (100.0f / viewingConditions.getFl()) * ((float) Math.pow((double) ((float) Math.max(C1030Utils.DOUBLE_EPSILON, (((double) Math.abs(f6)) * 27.13d) / (400.0d - ((double) Math.abs(f6))))), 2.380952380952381d));
        float signum3 = Math.signum(f7) * (100.0f / viewingConditions.getFl()) * ((float) Math.pow((double) ((float) Math.max(C1030Utils.DOUBLE_EPSILON, (((double) Math.abs(f7)) * 27.13d) / (400.0d - ((double) Math.abs(f7))))), 2.380952380952381d));
