...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
        ...
        this.selectionListener = new View.OnClickListener() {
            public void onClick(View view) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) view.getTag(C1059R.C1062id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C1059R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C1059R.C1062id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C1059R.C1062id.material_clock_period_toggle);
        this.toggle = materialButtonToggleGroup;
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() {
            public void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup, int i, boolean z) {
                int i2 = i == C1059R.C1062id.material_clock_period_pm_button ? 1 : 0;
                if (TimePickerView.this.onPeriodChangeListener != null && z) {
                    TimePickerView.this.onPeriodChangeListener.onPeriodChange(i2);
                }
            }
        });
        Chip chip = (Chip) findViewById(C1059R.C1062id.material_minute_tv);
        this.minuteView = chip;
        Chip chip2 = (Chip) findViewById(C1059R.C1062id.material_hour_tv);
        this.hourView = chip2;
        this.clockHandView = (ClockHandView) findViewById(C1059R.C1062id.material_clock_hand);
    ...
    private void setupDoubleTap() {
        ...
        C13004 r1 = new View.OnTouchListener() {
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C1059R.C1062id.selection_type, 12);
        this.hourView.setTag(C1059R.C1062id.selection_type, 10);
    ...
    public void updateTime(int i, int i2, int i3) {
        this.toggle.check(i == 1 ? C1059R.C1062id.material_clock_period_pm_button : C1059R.C1062id.material_clock_period_am_button);
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.clear(C1059R.C1062id.material_clock_display, i);
