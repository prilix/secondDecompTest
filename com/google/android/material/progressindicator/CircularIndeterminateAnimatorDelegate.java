...
final class CircularIndeterminateAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private static final int[] DELAY_TO_COLLAPSE_IN_MS = {C1662R2.attr.layoutDescription, C1662R2.C1663color.switch_thumb_material_light, C1662R2.C1664drawable.ic_hitachi_login_updated, C1662R2.C1665id.image_view_fan_speed_auto};
    private static final int[] DELAY_TO_EXPAND_IN_MS = {0, C1662R2.bool.m3_sys_typescale_title_large_text_all_caps, C1662R2.dimen.notification_small_icon_size_as_large, C1662R2.C1665id.clockwise};
    private static final int[] DELAY_TO_FADE_IN_MS = {1000, C1662R2.dimen.m3_btn_translation_z_base, C1662R2.C1665id.f374xcc62394b, C1662R2.C1665id.layout_password};
    ...
    private void updateSegmentPositions(int i) {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            float fractionInRange = getFractionInRange(i, DELAY_TO_EXPAND_IN_MS[i2], C1662R2.attr.layoutDescription);
            float[] fArr = this.segmentPositions;
            fArr[1] = fArr[1] + (this.interpolator.getInterpolation(fractionInRange) * 250.0f);
            float fractionInRange2 = getFractionInRange(i, DELAY_TO_COLLAPSE_IN_MS[i2], C1662R2.attr.layoutDescription);
    ...
    private void maybeUpdateSegmentColors(int i) {
        int i2 = 0;
        while (i2 < 4) {
            float fractionInRange = getFractionInRange(i, DELAY_TO_FADE_IN_MS[i2], C1662R2.attr.colorPrimary);
