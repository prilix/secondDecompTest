...
final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private static final int[] DELAY_TO_MOVE_SEGMENT_ENDS = {C1662R2.attr.tsb_tick_texts_array, 1000, C1662R2.attr.colorPrimary, 0};
    private static final int[] DURATION_TO_MOVE_SEGMENT_ENDS = {C1662R2.attr.flow_lastHorizontalBias, C1662R2.attr.haloColor, C1662R2.attr.motionEffect_translationY, C1662R2.attr.listLayout};
    ...
    public LinearIndeterminateDisjointAnimatorDelegate(Context context, LinearProgressIndicatorSpec linearProgressIndicatorSpec) {
        ...
        this.interpolatorArray = new Interpolator[]{AnimationUtilsCompat.loadInterpolator(context, C1059R.animator.linear_indeterminate_line1_head_interpolator), AnimationUtilsCompat.loadInterpolator(context, C1059R.animator.linear_indeterminate_line1_tail_interpolator), AnimationUtilsCompat.loadInterpolator(context, C1059R.animator.linear_indeterminate_line2_head_interpolator), AnimationUtilsCompat.loadInterpolator(context, C1059R.animator.linear_indeterminate_line2_tail_interpolator)};
    }
