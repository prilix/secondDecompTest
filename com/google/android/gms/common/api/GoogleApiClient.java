...
public abstract class GoogleApiClient {
    ...
    public <A extends C1048Api.AnyClient, R extends Result, T extends BaseImplementation.ApiMethodImpl<R, A>> T enqueue(T t) {
        throw new UnsupportedOperationException();
    }

    public <A extends C1048Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T execute(T t) {
        throw new UnsupportedOperationException();
    }

    public <C extends C1048Api.Client> C getClient(C1048Api.AnyClientKey<C> anyClientKey) {
        throw new UnsupportedOperationException();
    }

    public abstract ConnectionResult getConnectionResult(C1048Api<?> api);
    ...
    public boolean hasApi(C1048Api<?> api) {
        throw new UnsupportedOperationException();
    }

    public abstract boolean hasConnectedApi(C1048Api<?> api);
    ...
    public static final class Builder {
        ...
        private String zaf;
        private String zag;
        private final Map<C1048Api<?>, zab> zah;
        private final Context zai;
        private final Map<C1048Api<?>, C1048Api.ApiOptions> zaj;
        private LifecycleActivity zak;
        private int zal;
        private OnConnectionFailedListener zam;
        private Looper zan;
        private GoogleApiAvailability zao;
        private C1048Api.AbstractClientBuilder<? extends zae, SignInOptions> zap;
        ...
        private final <O extends C1048Api.ApiOptions> void zab(C1048Api<O> api, O o, Scope... scopeArr) {
            HashSet hashSet = new HashSet(((C1048Api.BaseClientBuilder) Preconditions.checkNotNull(api.zac(), "Base client builder must not be null")).getImpliedScopes(o));
        ...
        public Builder addApi(C1048Api<? extends C1048Api.ApiOptions.NotRequiredOptions> api) {
            Preconditions.checkNotNull(api, "Api must not be null");
            this.zaj.put(api, (Object) null);
            List<Scope> impliedScopes = ((C1048Api.BaseClientBuilder) Preconditions.checkNotNull(api.zac(), "Base client builder must not be null")).getImpliedScopes(null);
            this.zac.addAll(impliedScopes);
            this.zab.addAll(impliedScopes);
            return this;
        }

        public <O extends C1048Api.ApiOptions.HasOptions> Builder addApiIfAvailable(C1048Api<O> api, O o, Scope... scopeArr) {
            Preconditions.checkNotNull(api, "Api must not be null");
        ...
        public GoogleApiClient build() {
            ...
            Map<C1048Api<?>, zab> zad2 = zaa2.zad();
            ArrayMap arrayMap = new ArrayMap();
            ArrayMap arrayMap2 = new ArrayMap();
            ArrayList arrayList = new ArrayList();
            C1048Api api = null;
            boolean z = false;
            for (C1048Api next : this.zaj.keySet()) {
                C1048Api.ApiOptions apiOptions = this.zaj.get(next);
                boolean z2 = zad2.get(next) != null;
                arrayMap.put(next, Boolean.valueOf(z2));
                zat zat = new zat(next, z2);
                arrayList.add(zat);
                C1048Api.AbstractClientBuilder abstractClientBuilder = (C1048Api.AbstractClientBuilder) Preconditions.checkNotNull(next.zaa());
                C1048Api api2 = next;
                C1048Api.Client buildClient = abstractClientBuilder.buildClient(this.zai, this.zan, zaa2, apiOptions, (ConnectionCallbacks) zat, (OnConnectionFailedListener) zat);
        ...
        public <T extends C1048Api.ApiOptions.NotRequiredOptions> Builder addApiIfAvailable(C1048Api<? extends C1048Api.ApiOptions.NotRequiredOptions> api, Scope... scopeArr) {
            Preconditions.checkNotNull(api, "Api must not be null");
            this.zaj.put(api, (Object) null);
            zab(api, (C1048Api.ApiOptions) null, scopeArr);
            return this;
        }

        public <O extends C1048Api.ApiOptions.HasOptions> Builder addApi(C1048Api<O> api, O o) {
            Preconditions.checkNotNull(api, "Api must not be null");
            Preconditions.checkNotNull(o, "Null options are not permitted for this Api");
            this.zaj.put(api, o);
            List<Scope> impliedScopes = ((C1048Api.BaseClientBuilder) Preconditions.checkNotNull(api.zac(), "Base client builder must not be null")).getImpliedScopes(o);
            this.zac.addAll(impliedScopes);
            this.zab.addAll(impliedScopes);
            return this;
        }
