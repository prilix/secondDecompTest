...
public class AvailabilityException extends Exception {
    ...
    public ConnectionResult getConnectionResult(GoogleApi<? extends C1048Api.ApiOptions> googleApi) {
        ApiKey<? extends C1048Api.ApiOptions> apiKey = googleApi.getApiKey();
    ...
    public ConnectionResult getConnectionResult(HasApiKey<? extends C1048Api.ApiOptions> hasApiKey) {
        ApiKey<? extends C1048Api.ApiOptions> apiKey = hasApiKey.getApiKey();
        boolean z = this.zaa.get(apiKey) != null;
        String zab = apiKey.zab();
        StringBuilder sb = new StringBuilder(String.valueOf(zab).length() + 58);
        sb.append("The given API (");
