...
public class GoogleApiManager implements Handler.Callback {
    ...
    /* access modifiers changed from: private */
    public long zag = Constants.VALID_WIFI_CONNECTION_CHECK_TIMEOUT;
    /* access modifiers changed from: private */
    ...
    public final boolean handleMessage(Message message) {
        int i = message.what;
        long j = com.amplitude.api.Constants.MIN_TIME_BETWEEN_SESSIONS_MILLIS;
        zabq zabq = null;
        switch (i) {
            case 1:
                if (true == ((Boolean) message.obj).booleanValue()) {
                    j = Constants.VALID_WIFI_CONNECTION_CHECK_TIMEOUT;
                }
                this.zag = j;
            ...
            case 6:
                if (this.zak.getApplicationContext() instanceof Application) {
                    ...
                    if (!BackgroundDetector.getInstance().readCurrentStateIfPossible(true)) {
                        this.zag = com.amplitude.api.Constants.MIN_TIME_BETWEEN_SESSIONS_MILLIS;
                        break;
                    }
                }
                break;
    ...
    public final <O extends C1048Api.ApiOptions> Task<Void> zaq(GoogleApi<O> googleApi, RegisterListenerMethod<C1048Api.AnyClient, ?> registerListenerMethod, UnregisterListenerMethod<C1048Api.AnyClient, ?> unregisterListenerMethod, Runnable runnable) {
    ...
    public final <O extends C1048Api.ApiOptions> Task<Boolean> zar(GoogleApi<O> googleApi, ListenerHolder.ListenerKey listenerKey, int i) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
    ...
    public final <O extends C1048Api.ApiOptions> void zaw(GoogleApi<O> googleApi, int i, BaseImplementation.ApiMethodImpl<? extends Result, C1048Api.AnyClient> apiMethodImpl) {
        zae zae2 = new zae(i, apiMethodImpl);
        Handler handler = this.zat;
        handler.sendMessage(handler.obtainMessage(4, new zach(zae2, this.zao.get(), googleApi)));
    }

    public final <O extends C1048Api.ApiOptions, ResultT> void zax(GoogleApi<O> googleApi, int i, TaskApiCall<C1048Api.AnyClient, ResultT> taskApiCall, TaskCompletionSource<ResultT> taskCompletionSource, StatusExceptionMapper statusExceptionMapper) {
