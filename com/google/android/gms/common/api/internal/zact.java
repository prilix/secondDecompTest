...
public final class zact extends zac implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    private static final C1048Api.AbstractClientBuilder<? extends zae, SignInOptions> zaa = zad.zac;
    private final Context zab;
    private final Handler zac;
    private final C1048Api.AbstractClientBuilder<? extends zae, SignInOptions> zad;
    ...
    public zact(Context context, Handler handler, ClientSettings clientSettings) {
        C1048Api.AbstractClientBuilder<? extends zae, SignInOptions> abstractClientBuilder = zaa;
        this.zab = context;
        this.zac = handler;
    ...
    public final void zae(zacs zacs) {
        ...
        C1048Api.AbstractClientBuilder abstractClientBuilder = this.zad;
