...
final class zaao extends zaav {
    ...
    private final Map<C1048Api.Client, zaal> zac;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public zaao(zaaw zaaw, Map<C1048Api.Client, zaal> map) {
    ...
    public final void zaa() {
        ...
        for (C1048Api.Client next : this.zac.keySet()) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            while (i2 < size) {
                i = zal.zab(this.zaa.zac, (C1048Api.Client) arrayList.get(i2));
                i2++;
                if (i != 0) {
                    break;
                }
            ...
            while (i2 < size2) {
                i = zal.zab(this.zaa.zac, (C1048Api.Client) arrayList2.get(i2));
                i2++;
                if (i == 0) {
                    break;
                }
        ...
        for (C1048Api.Client next2 : this.zac.keySet()) {
