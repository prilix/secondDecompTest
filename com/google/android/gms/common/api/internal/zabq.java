...
public final class zabq<O extends C1048Api.ApiOptions> implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    final /* synthetic */ GoogleApiManager zaa;
    private final Queue<zai> zab = new LinkedList();
    /* access modifiers changed from: private */
    @NotOnlyInitialized
    public final C1048Api.Client zac;
    /* access modifiers changed from: private */
    ...
    public zabq(GoogleApiManager googleApiManager, GoogleApi<O> googleApi) {
        ...
        C1048Api.Client zab2 = googleApi.zab(googleApiManager.zat.getLooper(), this);
        this.zac = zab2;
    ...
    public final C1048Api.Client zaf() {
        return this.zac;
    }
    ...
    public final void zao() {
        ...
        if (!this.zac.isConnected() && !this.zac.isConnecting()) {
            try {
                ...
                GoogleApiManager googleApiManager2 = this.zaa;
                C1048Api.Client client = this.zac;
    ...
    public final void zar(ConnectionResult connectionResult, Exception exc) {
        ...
        if ((this.zac instanceof zap) && connectionResult.getErrorCode() != 24) {
            this.zaa.zah = true;
            GoogleApiManager googleApiManager = this.zaa;
            googleApiManager.zat.sendMessageDelayed(googleApiManager.zat.obtainMessage(19), Constants.MIN_TIME_BETWEEN_SESSIONS_MILLIS);
        }
