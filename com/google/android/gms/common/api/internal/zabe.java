...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    zabx zab;
    final Map<C1048Api.AnyClientKey<?>, C1048Api.Client> zac;
    Set<Scope> zad;
    final ClientSettings zae;
    final Map<C1048Api<?>, Boolean> zaf;
    final C1048Api.AbstractClientBuilder<? extends zae, SignInOptions> zag;
    Set<zada> zah;
    final zadc zai;
    ...
    public zabe(Context context, Lock lock, Looper looper, ClientSettings clientSettings, GoogleApiAvailability googleApiAvailability, C1048Api.AbstractClientBuilder<? extends zae, SignInOptions> abstractClientBuilder, Map<C1048Api<?>, Boolean> map, List<GoogleApiClient.ConnectionCallbacks> list, List<GoogleApiClient.OnConnectionFailedListener> list2, Map<C1048Api.AnyClientKey<?>, C1048Api.Client> map2, int i, int i2, ArrayList<zat> arrayList) {
        Looper looper2 = looper;
        int i3 = i;
        this.zaq = true != ClientLibraryUtils.isPackageSide() ? 120000 : Constants.VALID_WIFI_CONNECTION_CHECK_TIMEOUT;
        this.zar = 5000;
    ...
    public static int zad(Iterable<C1048Api.Client> iterable, boolean z) {
        boolean z2 = false;
        boolean z3 = false;
        for (C1048Api.Client next : iterable) {
    ...
    static String zag(int i) {
        return i != 1 ? i != 2 ? i != 3 ? StompCommand.UNKNOWN : "SIGN_IN_MODE_NONE" : "SIGN_IN_MODE_OPTIONAL" : "SIGN_IN_MODE_REQUIRED";
    }
    ...
    private final void zal(int i) {
        ...
        if (this.zal == null) {
            boolean z = false;
            boolean z2 = false;
            for (C1048Api.Client next : this.zac.values()) {
    ...
    public final <A extends C1048Api.AnyClient, R extends Result, T extends BaseImplementation.ApiMethodImpl<R, A>> T enqueue(T t) {
        Lock lock;
        C1048Api<?> api = t.getApi();
    ...
    public final <A extends C1048Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T execute(T t) {
        Lock lock;
        C1048Api<?> api = t.getApi();
        boolean containsKey = this.zac.containsKey(t.getClientKey());
        String zad2 = api != null ? api.zad() : "the API";
    ...
    public final <C extends C1048Api.Client> C getClient(C1048Api.AnyClientKey<C> anyClientKey) {
        C c = (C1048Api.Client) this.zac.get(anyClientKey);
        Preconditions.checkNotNull(c, "Appropriate Api was not requested.");
        return c;
    }

    public final ConnectionResult getConnectionResult(C1048Api<?> api) {
    ...
    public final boolean hasApi(C1048Api<?> api) {
        return this.zac.containsKey(api.zab());
    }

    public final boolean hasConnectedApi(C1048Api<?> api) {
        C1048Api.Client client;
