        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    style.addAction(C1043R.C1045drawable.common_full_open_on_phone, resources.getString(C1043R.string.common_open_on_phone), pendingIntent);
                } else {
                    style.setContentIntent(pendingIntent);
                }
            } else {
                style.setSmallIcon(17301642).setTicker(resources.getString(C1043R.string.common_google_play_services_notification_ticker)).setWhen(System.currentTimeMillis()).setContentIntent(pendingIntent).setContentText(zae);
            }
            if (PlatformVersion.isAtLeastO()) {
            ...
            if (i == 1 || i == 2 || i == 3) {
                ...
                i2 = C1662R2.style.ThemeOverlay_Material3_FloatingActionButton_Tertiary;
            } else {
                i2 = 39789;
            }
