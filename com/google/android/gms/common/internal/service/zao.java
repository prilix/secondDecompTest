...
public final class zao extends GoogleApi<TelemetryLoggingOptions> implements TelemetryLoggingClient {
    ...
    private static final C1048Api.ClientKey<zap> zac;
    private static final C1048Api.AbstractClientBuilder<zap, TelemetryLoggingOptions> zad;
    private static final C1048Api<TelemetryLoggingOptions> zae;

    static {
        C1048Api.ClientKey<zap> clientKey = new C1048Api.ClientKey<>();
        zac = clientKey;
        zan zan = new zan();
        zad = zan;
        zae = new C1048Api<>("ClientTelemetry.API", zan, clientKey);
    }
