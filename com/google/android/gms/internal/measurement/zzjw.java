...
interface zzjw {
    ...
    <T> T zza(zzjv<T> zzjv, zzhi zzhi) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzjv<T> zzjv, zzhi zzhi) throws IOException;

    <K, V> void zza(Map<K, V> map, zzix<K, V> zzix, zzhi zzhi) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzjv<T> zzjv, zzhi zzhi) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzjv<T> zzjv, zzhi zzhi) throws IOException;
