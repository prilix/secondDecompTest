...
interface zzlk {
    ...
    void zza(int i, zzgm zzgm) throws IOException;

    <K, V> void zza(int i, zzix<K, V> zzix, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzjv zzjv) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzjv zzjv) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzjv zzjv) throws IOException;

    void zzb(int i, List<zzgm> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzjv zzjv) throws IOException;
