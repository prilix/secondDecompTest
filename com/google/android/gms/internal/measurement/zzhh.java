...
final class zzhh implements zzlk {
    ...
    public static zzhh zza(zzhf zzhf) {
        ...
        return new zzhh(zzhf);
    }

    private zzhh(zzhf zzhf) {
        zzhf zzhf2 = (zzhf) zzhx.zza(zzhf, "output");
        this.zza = zzhf2;
        zzhf2.zza = this;
    }
    ...
    public final void zza(int i, Object obj, zzjv zzjv) throws IOException {
        this.zza.zza(i, (zzjg) obj, zzjv);
    }

    public final void zzb(int i, Object obj, zzjv zzjv) throws IOException {
        zzhf zzhf = this.zza;
        zzhf.zza(i, 3);
    ...
    public final void zza(int i, List<?> list, zzjv zzjv) throws IOException {
        for (int i2 = 0; i2 < list.size(); i2++) {
            zza(i, (Object) list.get(i2), zzjv);
        }
    }

    public final void zzb(int i, List<?> list, zzjv zzjv) throws IOException {
        for (int i2 = 0; i2 < list.size(); i2++) {
            zzb(i, (Object) list.get(i2), zzjv);
        }
    }

    public final <K, V> void zza(int i, zzix<K, V> zzix, Map<K, V> map) throws IOException {
