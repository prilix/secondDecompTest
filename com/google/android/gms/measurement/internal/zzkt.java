    ...
    public final String zza(zzcd.zzf zzf) {
        ...
        for (zzcd.zzg next : zzf.zza()) {
            if (next != null) {
                ...
                zza(sb, 1, Constants.AMP_TRACKING_OPTION_PLATFORM, (Object) next.zzq());
                if (next.zzz()) {
                ...
                zza(sb, 1, AmplitudeClient.DEVICE_ID_KEY, (Object) next.zzat());
                zza(sb, 1, "ds_id", (Object) next.zzay());
                if (next.zzae()) {
                    zza(sb, 1, "limited_ad_tracking", (Object) Boolean.valueOf(next.zzaf()));
                }
                zza(sb, 1, Constants.AMP_TRACKING_OPTION_OS_VERSION, (Object) next.zzr());
                zza(sb, 1, Constants.AMP_TRACKING_OPTION_DEVICE_MODEL, (Object) next.zzs());
