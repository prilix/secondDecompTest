...
public final class zzfu extends zzgx {
    ...
    private final void zza(zzfz<?> zzfz) {
        synchronized (this.zzg) {
            ...
            zzfy zzfy = this.zza;
            if (zzfy == null) {
                zzfy zzfy2 = new zzfy(this, "Measurement Worker", this.zzc);
                this.zza = zzfy2;
                zzfy2.setUncaughtExceptionHandler(this.zze);
                this.zza.start();
            } else {
                zzfy.zza();
            }
    ...
    public final void zzc(Runnable runnable) throws IllegalStateException {
        ...
        synchronized (this.zzg) {
            ...
            zzfy zzfy = this.zzb;
            if (zzfy == null) {
                zzfy zzfy2 = new zzfy(this, "Measurement Network", this.zzd);
                this.zzb = zzfy2;
                zzfy2.setUncaughtExceptionHandler(this.zzf);
                this.zzb.start();
            } else {
                zzfy.zza();
            }
