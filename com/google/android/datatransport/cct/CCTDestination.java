...
public final class CCTDestination implements EncodedDestination {
    ...
    private static final Set<Encoding> zzd = Collections.unmodifiableSet(new HashSet(Arrays.asList(new Encoding[]{Encoding.m67of("proto"), Encoding.m67of(Constants.Json.JSON)})));
