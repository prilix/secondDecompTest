...
final class zzc implements TransportBackend {
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        for (Map.Entry entry : hashMap.entrySet()) {
            ...
            for (EventInternal eventInternal2 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.m67of("proto"))) {
                    zza2 = zzq.zza(encodedPayload.getBytes());
                } else if (encoding.equals(Encoding.m67of(Constants.Json.JSON))) {
                    zza2 = zzq.zza(new String(encodedPayload.getBytes(), Charset.forName("UTF-8")));
                } else {
                    Logging.m75w("CctTransportBackend", "Received event of unsupported encoding %s. Skipping...", encoding);
                }
        ...
        try {
            ...
            if (zzb2.zza == 200) {
                return BackendResponse.m68ok(zzb2.zzc);
            }
            int i = zzb2.zza;
            if (i < 500) {
                if (i != 404) {
            ...
            Logging.m73e("CctTransportBackend", "Could not make request to the backend", e);
            return BackendResponse.transientError();
        }
    }
    ...
    public com.google.android.datatransport.cct.zzc.zzb zza(com.google.android.datatransport.cct.zzc.zza r14) throws java.io.IOException {
        /*
            ...
            com.google.android.datatransport.runtime.logging.Logging.m70d((java.lang.String) r1, (java.lang.String) r2, (java.lang.Object) r0)
            java.net.URL r0 = r14.zza
        ...
        L_0x007a:
            ...
            com.google.android.datatransport.runtime.logging.Logging.m74i(r1, r8)
            java.lang.StringBuilder r8 = new java.lang.StringBuilder
            r8.<init>()
            ...
            com.google.android.datatransport.runtime.logging.Logging.m74i(r1, r4)
        ...
        L_0x00ee:
            ...
            com.google.android.datatransport.cct.a.zzs r2 = com.google.android.datatransport.cct.p007a.zzs.zza(r2)     // Catch:{ all -> 0x0110 }
        ...
        L_0x013e:
            ...
            com.google.android.datatransport.runtime.logging.Logging.m73e(r1, r0, r14)
    ...
    static /* synthetic */ zza zza(zza zza2, zzb zzb2) {
        ...
        Logging.m70d("CctTransportBackend", "Following redirect to: %s", (Object) url);
