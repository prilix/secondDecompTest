...
public final class zzb implements Configurator {
    ...
    private static final class C3079zzb implements ObjectEncoder<zzo> {
        static final C3079zzb zza = new C3079zzb();
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        encoderConfig.registerEncoder((Class<U>) zzo.class, (ObjectEncoder<? super U>) C3079zzb.zza);
        encoderConfig.registerEncoder((Class<U>) zze.class, (ObjectEncoder<? super U>) C3079zzb.zza);
