...
public class ShortNumberInfo {
    ...
    public ShortNumberCost getExpectedCost(Phonenumber.PhoneNumber phoneNumber) {
        ...
        for (String expectedCostForRegion : regionCodesForCountryCode) {
            ...
            int i = C15911.f264xe1b2aad7[expectedCostForRegion2.ordinal()];
            if (i == 1) {
                return ShortNumberCost.PREMIUM_RATE;
            }
            if (i == 2) {
    ...
    static /* synthetic */ class C15911 {
        ...
        static final /* synthetic */ int[] f264xe1b2aad7;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f264xe1b2aad7     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f264xe1b2aad7     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f264xe1b2aad7     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.i18n.phonenumbers.ShortNumberInfo.C15911.<clinit>():void");
        }
    }
    ...
    private String getRegionCodeForShortNumberFromRegionList(Phonenumber.PhoneNumber phoneNumber, List<String> list) {
        ...
        for (String next : list) {
            Phonemetadata.PhoneMetadata shortNumberMetadataForRegion = MetadataManager.getShortNumberMetadataForRegion(next);
    ...
    public String getExampleShortNumberForCost(String str, ShortNumberCost shortNumberCost) {
        ...
        int i = C15911.f264xe1b2aad7[shortNumberCost.ordinal()];
        if (i == 1) {
