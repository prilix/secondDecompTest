...
public final class Phonenumber {
    ...
    public static class PhoneNumber implements Serializable {
        ...
        public int hashCode() {
            int countryCode = (((((C1662R2.dimen.design_fab_size_mini + getCountryCode()) * 53) + Long.valueOf(getNationalNumber()).hashCode()) * 53) + getExtension().hashCode()) * 53;
            boolean isItalianLeadingZero = isItalianLeadingZero();
            int i = C1662R2.attr.trackColorInactive;
            int numberOfLeadingZeros = (((((((((countryCode + (isItalianLeadingZero ? C1662R2.attr.trackColorInactive : C1662R2.attr.transformPivotTarget)) * 53) + getNumberOfLeadingZeros()) * 53) + getRawInput().hashCode()) * 53) + getCountryCodeSource().hashCode()) * 53) + getPreferredDomesticCarrierCode().hashCode()) * 53;
            if (!hasPreferredDomesticCarrierCode()) {
                i = C1662R2.attr.transformPivotTarget;
            }
