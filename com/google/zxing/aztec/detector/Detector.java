...
public final class Detector {
    private static final int[] EXPECTED_CORNER_BITS = {C1662R2.C1665id.action_setTimerFragmentV2_to_setModeAndTempratureFragmentV2, C1662R2.attr.errorEnabled, C1662R2.dimen.abc_text_size_body_1_material, C1662R2.C1663color.m3_sys_color_light_secondary};
    ...
    private void extractParameters(ResultPoint[] resultPointArr) throws NotFoundException {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            if (this.compact) {
                ...
                j2 = j3 << 10;
                j = (long) (((i3 >> 2) & C1662R2.attr.searchIcon) + ((i3 >> 1) & 31));
            }
            j3 = j2 + j;
        }
        ...
        this.nbDataBlocks = (correctedParameterData & C1662R2.dimen.abc_action_bar_default_padding_end_material) + 1;
    }
    ...
    static final class Point {
        ...
        public String toString() {
            return "<" + this.f267x + ' ' + this.f268y + Typography.greater;
        }
    }
}
