...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f271FS = '\u001c';

    /* renamed from: GS */
    private static final char f272GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f273NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f274RS = '\u001e';
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        String str;
        StringBuilder sb = new StringBuilder(C1662R2.attr.badgeWidePadding);
        if (i == 2 || i == 3) {
            if (i == 2) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, str + f272GS + format + f272GS + format2 + f272GS);
            } else {
                sb.insert(0, str + f272GS + format + f272GS + format2 + f272GS);
            }
        } else if (i == 4) {
