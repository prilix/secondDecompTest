...
public final class VINResultParser extends ResultParser {
    ...
    private static int modelYear(char c) {
        if (c >= 'E' && c <= 'H') {
            return (c - 'E') + C1662R2.C1663color.primary_dark_material_dark;
        }
        if (c >= 'J' && c <= 'N') {
            return (c - 'J') + C1662R2.C1663color.primary_text_default_material_dark;
        }
        if (c == 'P') {
            return C1662R2.C1663color.qr_code_scanned;
        }
        if (c >= 'R' && c <= 'T') {
            return (c - 'R') + C1662R2.C1663color.rac_name_oofline_color;
        }
        if (c >= 'V' && c <= 'Y') {
            return (c - 'V') + C1662R2.C1663color.radio_flat_text_selector;
        }
        if (c >= '1' && c <= '9') {
            return (c - '1') + C1662R2.C1663color.schedule_no_off_text;
        }
        if (c >= 'A' && c <= 'D') {
            return (c - 'A') + C1662R2.C1663color.selector_contact_select_text_enabled;
        }
        throw new IllegalArgumentException();
    }
