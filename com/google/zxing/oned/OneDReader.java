...
public abstract class OneDReader implements Reader {
    ...
    public Result decode(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map) throws NotFoundException, FormatException {
        try {
            ...
            int i = C1662R2.attr.circleCrop;
            if (resultMetadata != null && resultMetadata.containsKey(ResultMetadataType.ORIENTATION)) {
                i = (((Integer) resultMetadata.get(ResultMetadataType.ORIENTATION)).intValue() + C1662R2.attr.circleCrop) % C1662R2.attr.contentInsetEndWithActions;
            }
            ...
            try {
                ...
                while (i9 < 2) {
                    ...
                    try {
                        ...
                        if (i9 == i2) {
                            decodeRow.putMetadata(ResultMetadataType.ORIENTATION, Integer.valueOf(C1662R2.attr.boxCornerRadiusTopStart));
