...
public final class RSS14Reader extends AbstractRSSReader {
    ...
    private static final int[] INSIDE_GSUM = {0, C1662R2.attr.colorPrimaryInverse, C1662R2.attr.springDamping, C1662R2.C1663color.m3_button_outline_color_selector};
    private static final int[] INSIDE_ODD_TOTAL_SUBSET = {4, 20, 48, 81};
    private static final int[] INSIDE_ODD_WIDEST = {2, 4, 6, 8};
    private static final int[] OUTSIDE_EVEN_TOTAL_SUBSET = {1, 10, 34, 70, 126};
    private static final int[] OUTSIDE_GSUM = {0, C1662R2.attr.blendSrc, C1662R2.attr.sb_border_width, 2015, C1662R2.dimen.search_view_text_padding};
    ...
    private Pair decodePair(BitArray bitArray, boolean z, int i, Map<DecodeHintType, ?> map) {
        ...
        try {
            ...
            return new Pair((decodeDataCharacter.getValue() * C1662R2.C1663color.m3_ref_palette_dynamic_secondary0) + decodeDataCharacter2.getValue(), decodeDataCharacter.getChecksumPortion() + (decodeDataCharacter2.getChecksumPortion() * 4), parseFoundFinderPattern);
