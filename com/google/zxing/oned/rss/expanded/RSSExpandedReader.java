...
public final class RSSExpandedReader extends AbstractRSSReader {
    private static final int[] EVEN_TOTAL_SUBSET = {4, 20, 52, 104, C1662R2.attr.cameraMinZoomPreference};
    ...
    private static final int[] GSUM = {0, C1662R2.attr.colorTertiaryContainer, C1662R2.C1663color.androidx_core_secondary_text_default_material_light, C1662R2.C1664drawable.common_google_signin_btn_text_light_normal_background, C1662R2.C1665id.button_where_to_locate_qr_code};
    private static final int MAX_PAIRS = 11;
    private static final int[] SYMBOL_WIDEST = {7, 5, 4, 3, 1};
    private static final int[][] WEIGHTS = {new int[]{1, 3, 9, 27, 81, 32, 96, 77}, new int[]{20, 60, C1662R2.attr.boxCornerRadiusTopStart, 118, C1662R2.attr.badgeTextColor, 7, 21, 63}, new int[]{C1662R2.attr.buttonBarNegativeButtonStyle, C1662R2.attr.badgeWithTextRadius, 13, 39, 117, C1662R2.attr.badgeGravity, C1662R2.attr.cardBackgroundColor, C1662R2.attr.cameraTargetLat}, new int[]{C1662R2.attr.buttonCompat, C1662R2.attr.behavior_overlapTop, 49, 147, 19, 57, C1662R2.attr.bottomNavigationStyle, 91}, new int[]{62, C1662R2.attr.bubbleColor, 136, C1662R2.attr.buttonSize, C1662R2.attr.bottomAppBarStyle, 85, 44, 132}, new int[]{C1662R2.attr.brightness, C1662R2.attr.backgroundInsetTop, C1662R2.attr.buttonBarButtonStyle, C1662R2.attr.badgeStyle, 4, 12, 36, 108}, new int[]{113, 128, C1662R2.attr.bottomSheetStyle, 97, 80, 29, 87, 50}, new int[]{C1662R2.attr.behavior_autoHide, 28, 84, 41, 123, C1662R2.attr.behavior_peekHeight, 52, C1662R2.attr.behavior_hideable}, new int[]{46, C1662R2.attr.backgroundTintMode, C1662R2.attr.cameraMaxZoomPreference, C1662R2.attr.bubbleTextColor, C1662R2.attr.backspaceIcon, C1662R2.attr.cameraTargetLng, C1662R2.attr.buttonPanelSideLayout, C1662R2.attr.borderRoundPercent}, new int[]{76, 17, 51, C1662R2.attr.behavior_expandedOffset, 37, 111, 122, C1662R2.attr.behavior_halfExpandedRatio}, new int[]{43, C1662R2.attr.backgroundColor, C1662R2.attr.boxCollapsedPaddingTop, 106, 107, 110, 119, C1662R2.attr.barLength}, new int[]{16, 48, C1662R2.attr.badgeWidePadding, 10, 30, 90, 59, 177}, new int[]{109, 116, 137, 200, C1662R2.attr.boxCornerRadiusBottomStart, 112, 125, C1662R2.attr.borderLength}, new int[]{70, C1662R2.attr.cardCornerRadius, C1662R2.attr.cameraZoom, 202, C1662R2.attr.boxStrokeWidthFocused, C1662R2.attr.backgroundInsetBottom, C1662R2.attr.boxCornerRadiusTopEnd, 115}, new int[]{C1662R2.attr.backgroundOverlayColorAlpha, C1662R2.attr.buttonBarPositiveButtonStyle, C1662R2.attr.behavior_autoShrink, 31, 93, 68, C1662R2.attr.cameraMinZoomPreference, C1662R2.attr.buttonBarNeutralButtonStyle}, new int[]{C1662R2.attr.barrierDirection, 22, 66, C1662R2.attr.buttonStyle, C1662R2.attr.bottomSheetDialogTheme, 94, 71, 2}, new int[]{6, 18, 54, C1662R2.attr.borderAlpha, 64, C1662R2.attr.buttonBarStyle, C1662R2.attr.behavior_fitToContents, 40}, new int[]{120, C1662R2.attr.barrierMargin, 25, 75, 14, 42, 126, C1662R2.attr.borderWidth}, new int[]{79, 26, 78, 23, 69, C1662R2.attr.cameraTilt, C1662R2.attr.buttonStyleSmall, C1662R2.attr.boxBackgroundMode}, new int[]{103, 98, 83, 38, 114, C1662R2.attr.backgroundInsetEnd, C1662R2.attr.boxStrokeErrorColor, 124}, new int[]{C1662R2.attr.blendSrc, 61, C1662R2.attr.boxStrokeWidth, 127, C1662R2.attr.bottomInsetScrimEnabled, 88, 53, C1662R2.attr.behavior_saveFlags}, new int[]{55, C1662R2.attr.borderRound, 73, 8, 24, 72, 5, 15}, new int[]{45, C1662R2.attr.backgroundSplit, C1662R2.attr.buttonGravity, C1662R2.attr.behavior_skipCollapsed, 58, C1662R2.attr.boxBackgroundColor, 100, 89}};
    ...
    private boolean checkChecksum() {
        ...
        if (((i - 4) * C1662R2.attr.cardElevation) + (checksumPortion % C1662R2.attr.cardElevation) == leftChar.getValue()) {
            return true;
        }
        return false;
    }
