    ...
    private DecodedChar decodeIsoIec646(int i) throws FormatException {
        ...
        switch (extractNumericValueFromBitArray(i, 8)) {
            ...
            case C1662R2.attr.chipBackgroundColor /*241*/:
                c = ',';
                break;
            case C1662R2.attr.chipCornerRadius /*242*/:
                c = Constants.FCM.DASH;
                break;
            case C1662R2.attr.chipEndPadding /*243*/:
                c = ClassUtils.PACKAGE_SEPARATOR_CHAR;
                break;
            case C1662R2.attr.chipGroupStyle /*244*/:
                c = '/';
                break;
            case C1662R2.attr.chipIcon /*245*/:
                c = ':';
                break;
            case C1662R2.attr.chipIconEnabled /*246*/:
                c = ';';
                break;
            case C1662R2.attr.chipIconSize /*247*/:
                c = Typography.less;
                break;
            case C1662R2.attr.chipIconTint /*248*/:
                c = '=';
                break;
            case 249:
