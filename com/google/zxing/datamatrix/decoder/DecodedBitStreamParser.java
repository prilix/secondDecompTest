...
final class DecodedBitStreamParser {
    ...
    static {
        char[] cArr = {'!', Typography.quote, '#', '$', '%', Typography.amp, '\'', '(', ')', '*', '+', ',', Constants.FCM.DASH, ClassUtils.PACKAGE_SEPARATOR_CHAR, '/', ':', ';', Typography.less, '=', Typography.greater, '?', '@', '[', '\\', ']', '^', Constants.FCM.UNDER_SCORE};
    ...
    static com.google.zxing.common.DecoderResult decode(byte[] r7) throws com.google.zxing.FormatException {
        ...
        L_0x001a:
            ...
            goto L_0x0053
        L_0x0023:
            int[] r6 = com.google.zxing.datamatrix.decoder.DecodedBitStreamParser.C15961.f269xb73eb560
            int r5 = r5.ordinal()
            r5 = r6[r5]
    ...
    static /* synthetic */ class C15961 {
        ...
        static final /* synthetic */ int[] f269xb73eb560;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f269xb73eb560     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f269xb73eb560     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f269xb73eb560     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f269xb73eb560     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.datamatrix.decoder.DecodedBitStreamParser.C15961.<clinit>():void");
        }
    }
        ...
        do {
            ...
            if (readBits == 0) {
                ...
                if (readBits <= 229) {
                    ...
                    switch (readBits) {
                        case C1662R2.attr.checkMarkTintMode /*230*/:
                            return Mode.C40_ENCODE;
                        case C1662R2.attr.checkboxStyle /*231*/:
                            return Mode.BASE256_ENCODE;
                        case C1662R2.attr.checkedButton /*232*/:
                            sb.append(29);
                            break;
                        case C1662R2.attr.checkedChip /*233*/:
                        case 234:
                        case C1662R2.attr.chipBackgroundColor /*241*/:
                            break;
                        case C1662R2.attr.checkedIconEnabled /*235*/:
                            z = true;
                            break;
                        case C1662R2.attr.checkedIconMargin /*236*/:
                            sb.append("[)>\u001e05\u001d");
                            sb2.insert(0, "\u001e\u0004");
                            break;
                        case C1662R2.attr.checkedIconSize /*237*/:
                            sb.append("[)>\u001e06\u001d");
                            sb2.insert(0, "\u001e\u0004");
                            break;
                        case C1662R2.attr.checkedIconTint /*238*/:
                            return Mode.ANSIX12_ENCODE;
                        case C1662R2.attr.checkedIconVisible /*239*/:
                            return Mode.TEXT_ENCODE;
                        case C1662R2.attr.checkedTextViewStyle /*240*/:
                ...
                if (i != 0) {
                    if (i != 1) {
                        if (i == 2) {
                            ...
                            sb.append((char) (i3 + C1662R2.attr.carousel_touchUpMode));
                        } else {
    ...
    private static void parseTwoBytes(int i, int i2, int[] iArr) {
        int i3 = ((i << 8) + i2) - 1;
        int i4 = i3 / C1662R2.C1663color.m3_ref_palette_dynamic_secondary20;
        iArr[0] = i4;
        int i5 = i3 - (i4 * C1662R2.C1663color.m3_ref_palette_dynamic_secondary20);
        int i6 = i5 / 40;
        iArr[1] = i6;
        iArr[2] = i5 - (i6 * 40);
    }
    ...
    private static int unrandomize255State(int i, int i2) {
        int i3 = i - (((i2 * C1662R2.attr.barrierMargin) % 255) + 1);
