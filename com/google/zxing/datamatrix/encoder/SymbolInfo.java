...
public class SymbolInfo {
    ...
    static {
        SymbolInfo[] symbolInfoArr = {new SymbolInfo(false, 3, 5, 8, 8, 1), new SymbolInfo(false, 5, 7, 10, 10, 1), new SymbolInfo(true, 5, 7, 16, 6, 1), new SymbolInfo(false, 8, 10, 12, 12, 1), new SymbolInfo(true, 10, 11, 14, 6, 2), new SymbolInfo(false, 12, 12, 14, 14, 1), new SymbolInfo(true, 16, 14, 24, 10, 1), new SymbolInfo(false, 18, 14, 16, 16, 1), new SymbolInfo(false, 22, 18, 18, 18, 1), new SymbolInfo(true, 22, 18, 16, 10, 2), new SymbolInfo(false, 30, 20, 20, 20, 1), new SymbolInfo(true, 32, 24, 16, 14, 2), new SymbolInfo(false, 36, 24, 22, 22, 1), new SymbolInfo(false, 44, 28, 24, 24, 1), new SymbolInfo(true, 49, 28, 22, 14, 2), new SymbolInfo(false, 62, 36, 14, 14, 4), new SymbolInfo(false, 86, 42, 16, 16, 4), new SymbolInfo(false, 114, 48, 18, 18, 4), new SymbolInfo(false, C1662R2.attr.badgeWidePadding, 56, 20, 20, 4), new SymbolInfo(false, C1662R2.attr.boxBackgroundColor, 68, 22, 22, 4), new SymbolInfo(false, C1662R2.attr.cameraMinZoomPreference, 84, 24, 24, 4, 102, 42), new SymbolInfo(false, C1662R2.attr.civ_border_width, 112, 14, 14, 16, C1662R2.attr.badgeGravity, 56), new SymbolInfo(false, C1662R2.attr.contentPaddingLeft, C1662R2.attr.badgeWidePadding, 16, 16, 16, 92, 36), new SymbolInfo(false, C1662R2.attr.el_duration, C1662R2.attr.buttonBarStyle, 18, 18, 16, 114, 48), new SymbolInfo(false, C1662R2.attr.hideAnimationBehavior, C1662R2.attr.carousel_touchUpMode, 20, 20, 16, C1662R2.attr.badgeWidePadding, 56), new SymbolInfo(false, C1662R2.attr.layout_constraintHeight_min, C1662R2.attr.circularProgressIndicatorStyle, 22, 22, 16, C1662R2.attr.boxBackgroundColor, 68), new SymbolInfo(false, C1662R2.attr.measureWithLargestChild, C1662R2.attr.colorPrimaryInverse, 24, 24, 16, 136, 56), new SymbolInfo(false, C1662R2.attr.state_above_anchor, C1662R2.attr.dayInvalidStyle, 18, 18, 36, C1662R2.attr.boxBackgroundMode, 68), new SymbolInfo(false, C1662R2.attr.useViewLifecycle, C1662R2.attr.extendedFloatingActionButtonSecondaryStyle, 20, 20, 36, C1662R2.attr.borderColor, 62), new DataMatrixSymbolInfo144()};
