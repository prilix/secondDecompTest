    ...
    static void terminateBits(int i, BitArray bitArray) throws WriterException {
        ...
        if (bitArray.getSize() <= i2) {
            ...
            for (int i4 = 0; i4 < sizeInBytes; i4++) {
                bitArray.appendBits((i4 & 1) == 0 ? C1662R2.attr.checkedIconMargin : 17, 8);
            }
            if (bitArray.getSize() != i2) {
    ...
    static /* synthetic */ class C16131 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.qrcode.encoder.Encoder.C16131.<clinit>():void");
        }
    }

    static void appendBytes(String str, Mode mode, BitArray bitArray, String str2) throws WriterException {
        int i = C16131.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
