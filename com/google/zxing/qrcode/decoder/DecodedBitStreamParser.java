...
final class DecodedBitStreamParser {
            ...
            try {
                ...
                switch (mode2) {
                    ...
                    default:
                        ...
                        int i4 = C16111.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode2.ordinal()];
                        if (i4 != i) {
                            if (i4 != 2) {
                                if (i4 == 3) {
                                    mode = mode2;
    ...
    private static void decodeKanjiSegment(BitSource bitSource, StringBuilder sb, int i) throws FormatException {
        if (i * 13 <= bitSource.available()) {
            ...
            while (i > 0) {
                int readBits = bitSource.readBits(13);
                int i3 = (readBits % C1662R2.attr.buttonBarStyle) | ((readBits / C1662R2.attr.buttonBarStyle) << 8);
    ...
    private static int parseECIValue(BitSource bitSource) throws FormatException {
        ...
        if ((readBits & C1662R2.attr.buttonBarStyle) == 128) {
            return bitSource.readBits(8) | ((readBits & 63) << 8);
        }
        if ((readBits & C1662R2.attr.carousel_touchUpMode) == 192) {
