...
final class FormatInformation {
    private static final int[][] FORMAT_INFO_DECODE_LOOKUP = {new int[]{FORMAT_INFO_MASK_QR, 0}, new int[]{20773, 1}, new int[]{24188, 2}, new int[]{23371, 3}, new int[]{17913, 4}, new int[]{16590, 5}, new int[]{20375, 6}, new int[]{19104, 7}, new int[]{30660, 8}, new int[]{29427, 9}, new int[]{32170, 10}, new int[]{30877, 11}, new int[]{26159, 12}, new int[]{25368, 13}, new int[]{27713, 14}, new int[]{26998, 15}, new int[]{C1662R2.C1665id.text_view_arriving_km, 16}, new int[]{C1662R2.C1665id.layout_permission_member, 17}, new int[]{C1662R2.string.common_item_langVietnamese, 18}, new int[]{C1662R2.C1665id.tvSelect, 19}, new int[]{C1662R2.C1663color.material_dynamic_tertiary30, 20}, new int[]{C1662R2.attr.iconTintMode, 21}, new int[]{C1662R2.C1664drawable.ic_fan_speed_5_updated, 22}, new int[]{C1662R2.dimen.abc_text_size_body_1_material, 23}, new int[]{13663, 24}, new int[]{C1662R2.styleable.NavigationView_itemShapeInsetStart, 25}, new int[]{16177, 26}, new int[]{14854, 27}, new int[]{C1662R2.style.Base_Widget_AppCompat_EditText, 28}, new int[]{C1662R2.string.manageAc_btn_acName, 29}, new int[]{C1662R2.styleable.KeyTimeCycle_wavePhase, 30}, new int[]{C1662R2.styleable.Chip_ensureMinTouchTargetSize, 31}};
