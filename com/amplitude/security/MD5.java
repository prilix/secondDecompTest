...
public final class MD5 extends MessageDigest implements Cloneable {
    ...
    public void init() {
        this.f125hA = 1732584193;
        this.f126hB = -271733879;
        this.f127hC = -1732584194;
        this.f128hD = 271733878;
    }
    ...
    public void engineUpdate(byte[] bArr, int i, int i2) {
        ...
        while (i2 >= 512) {
            ...
            engineUpdate(bArr, i + C1662R2.attr.buttonBarStyle);
            engineUpdate(bArr, i + 256);
            engineUpdate(bArr, i + C1662R2.attr.colorOnError);
            engineUpdate(bArr, i + C1662R2.attr.cornerSizeBottomRight);
            engineUpdate(bArr, i + C1662R2.attr.dropDownListViewStyle);
            i += 512;
            i2 -= 512;
        }
        while (i2 >= 64) {
