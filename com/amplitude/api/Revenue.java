...
public class Revenue {
    ...
    public boolean isValidRevenue() {
        ...
        logger.mo13093w(TAG, "Invalid revenue, need to set price");
        return false;
    }

    public Revenue setProductId(String str) {
        if (C0895Utils.isEmptyString(str)) {
            logger.mo13093w(TAG, "Invalid empty productId");
            return this;
        }
        this.productId = str;
        return this;
    ...
    public Revenue setRevenueProperties(JSONObject jSONObject) {
        logger.mo13093w(TAG, "setRevenueProperties is deprecated, please use setEventProperties instead");
        return setEventProperties(jSONObject);
    }

    public Revenue setEventProperties(JSONObject jSONObject) {
        this.properties = C0895Utils.cloneJSONObject(jSONObject);
        return this;
    }
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            ...
            logger.mo13082e(TAG, String.format("Failed to convert revenue object to JSON: %s", new Object[]{e.toString()}));
        }
        return jSONObject;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (jSONObject != null) {
            if (!C0895Utils.compareJSONObjects(jSONObject, jSONObject2)) {
                return false;
            }
            return true;
