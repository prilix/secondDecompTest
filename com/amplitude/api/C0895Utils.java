...
public class C0895Utils {
    ...
    static JSONObject cloneJSONObject(JSONObject jSONObject) {
        ...
        try {
            ...
            logger.mo13082e(TAG, e2.toString());
            return null;
        }
    }
    ...
    static boolean checkLocationPermissionAllowed(Context context) {
        return checkPermissionAllowed(context, Constants.GrantedPermissions.ACCESS_COARSE_LOCATION) || checkPermissionAllowed(context, Constants.GrantedPermissions.ACCESS_FINE_LOCATION);
    }
