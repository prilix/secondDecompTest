    ...
    private static void encodeUtf8Buffer(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i2 < length) {
            ...
            if (charAt2 < 128) {
                ...
                i = position + 1;
                try {
                    byteBuffer.put(position, (byte) ((charAt2 >>> 6) | C1662R2.attr.buttonBarStyle));
                ...
                i = position + 1;
                byteBuffer.put(position, (byte) ((charAt2 >>> 12) | C1662R2.attr.carousel_touchUpMode));
                position = i + 1;
                ...
                if (i3 != length) {
                    try {
                        ...
                        if (Character.isSurrogatePair(charAt2, charAt3)) {
                            ...
                            int i4 = position + 1;
                            try {
                                byteBuffer.put(position, (byte) ((codePoint >>> 18) | C1662R2.attr.checkedTextViewStyle));
                                position = i4 + 1;
    ...
    private static int encodeUtf8Array(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i7 < length) {
            ...
            if (charAt2 < 128 && i8 < i6) {
                ...
                int i9 = i8 + 1;
                bArr[i8] = (byte) ((charAt2 >>> 6) | C1662R2.attr.sb_background);
                i8 = i9 + 1;
                bArr[i9] = (byte) ((charAt2 & '?') | 128);
                i7++;
            } else if ((charAt2 < 55296 || 57343 < charAt2) && i8 <= i6 - 3) {
                int i10 = i8 + 1;
                bArr[i8] = (byte) ((charAt2 >>> 12) | C1662R2.attr.errorTextAppearance);
                int i11 = i10 + 1;
                ...
                if (i12 != charSequence.length()) {
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                        int codePoint = Character.toCodePoint(charAt2, charAt3);
                        int i13 = i8 + 1;
                        bArr[i8] = (byte) ((codePoint >>> 18) | C1662R2.attr.checkedTextViewStyle);
                        int i14 = i13 + 1;
