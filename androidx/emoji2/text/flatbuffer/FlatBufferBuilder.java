...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf82) {
        ...
        if (byteBuffer != null) {
            ...
            byteBuffer.clear();
            this.f85bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f85bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf82;
        this.space = this.f85bb.capacity();
    }
    ...
    public int offset() {
        return this.f85bb.capacity() - this.space;
    }

    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.f85bb;
            int i3 = this.space - 1;
            this.space = i3;
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f85bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f85bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f85bb;
        int i = this.space - remaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f85bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endTable() {
        ...
        while (true) {
            ...
            int capacity = this.f85bb.capacity() - this.vtables[i4];
            int i5 = this.space;
            short s = this.f85bb.getShort(capacity);
            if (s == this.f85bb.getShort(i5)) {
                int i6 = 2;
                while (i6 < s) {
                    if (this.f85bb.getShort(capacity + i6) == this.f85bb.getShort(i5 + i6)) {
                        i6 += 2;
                    }
                }
                i = this.vtables[i4];
        ...
        if (i != 0) {
            int capacity2 = this.f85bb.capacity() - offset;
            this.space = capacity2;
            this.f85bb.putInt(capacity2, i - offset);
        } else {
    ...
    public void required(int i, int i2) {
        int capacity = this.f85bb.capacity() - i;
        if (!(this.f85bb.getShort((capacity - this.f85bb.getInt(capacity)) + i2) != 0)) {
    ...
    public void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f85bb.capacity() - this.space);
        }
        this.f85bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f85bb.position(i);
        this.f85bb.get(bArr);
        return bArr;
    }

    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f85bb.capacity() - this.space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f85bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f85bb.capacity());
