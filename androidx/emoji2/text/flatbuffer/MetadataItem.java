...
public final class MetadataItem extends Table {
    ...
    public int mo8787id() {
        ...
        if (__offset != 0) {
            return this.f90bb.getInt(__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public boolean emojiStyle() {
        ...
        return (__offset == 0 || this.f90bb.get(__offset + this.bb_pos) == 0) ? false : true;
    }

    public short sdkAdded() {
        int __offset = __offset(8);
        if (__offset != 0) {
            return this.f90bb.getShort(__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public int codepoints(int i) {
        ...
        if (__offset != 0) {
            return this.f90bb.getInt(__vector(__offset) + (i * 4));
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector intVector) {
        int __offset = __offset(16);
        if (__offset != 0) {
            return intVector.__assign(__vector(__offset), this.f90bb);
        }
        return null;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem metadataItem, int i) {
            return metadataItem.__assign(MetadataItem.__indirect(__element(i), this.f84bb), this.f84bb);
        }
    }
}
