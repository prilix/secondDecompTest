...
public class NavDestination {
    ...
    public void onInflate(Context context, AttributeSet attributeSet) {
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0619R.styleable.Navigator);
        setId(obtainAttributes.getResourceId(C0619R.styleable.Navigator_android_id, 0));
        this.mIdName = getDisplayName(context, this.mId);
        setLabel(obtainAttributes.getText(C0619R.styleable.Navigator_android_label));
        ...
        if (bundle != null) {
            ...
            if (hashMap3 != null) {
                for (Map.Entry next2 : hashMap3.entrySet()) {
                    if (!((NavArgument) next2.getValue()).verify((String) next2.getKey(), bundle2)) {
