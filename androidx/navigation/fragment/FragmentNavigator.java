...
public class FragmentNavigator extends Navigator<Destination> {
    ...
    public static class Destination extends NavDestination {
        ...
        public void onInflate(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0628R.styleable.FragmentNavigator);
            String string = obtainAttributes.getString(C0628R.styleable.FragmentNavigator_android_name);
            if (string != null) {
                setClassName(string);
            }
