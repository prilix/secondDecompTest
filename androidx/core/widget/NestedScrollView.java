...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0230R.attr.nestedScrollViewStyle);
    }
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = C1662R2.attr.backgroundInsetBottom;
        if (!canScroll) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, C1662R2.attr.backgroundInsetBottom);
            if (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(C1662R2.attr.backgroundInsetBottom)) {
                return false;
            }
            return true;
            ...
            if (keyCode != 19) {
                if (keyCode != 20) {
                    ...
                    return arrowScroll(C1662R2.attr.backgroundInsetBottom);
                } else {
                    return fullScroll(C1662R2.attr.backgroundInsetBottom);
                }
            } else if (!keyEvent.isAltPressed()) {
    ...
    public boolean onRequestFocusInDescendants(int i, Rect rect) {
        View view;
        if (i == 2) {
            i = C1662R2.attr.backgroundInsetBottom;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {
