...
import androidx.databinding.library.C0363R;
...
public abstract class ViewDataBinding extends BaseObservable implements ViewBinding {
    ...
    public void setRootTag(View view) {
        view.setTag(C0363R.C0366id.dataBinding, this);
    }

    /* access modifiers changed from: protected */
    public void setRootTag(View[] viewArr) {
        for (View tag : viewArr) {
            tag.setTag(C0363R.C0366id.dataBinding, this);
        }
    }
    ...
    static ViewDataBinding getBinding(View view) {
        if (view != null) {
            return (ViewDataBinding) view.getTag(C0363R.C0366id.dataBinding);
        }
        return null;
    }
    ...
    protected static double getFromArray(double[] dArr, int i) {
        return (dArr == null || i < 0 || i >= dArr.length) ? C1030Utils.DOUBLE_EPSILON : dArr[i];
    }
    ...
    protected static double safeUnbox(Double d) {
        return d == null ? C1030Utils.DOUBLE_EPSILON : d.doubleValue();
    }
