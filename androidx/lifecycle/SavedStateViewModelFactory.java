...
public final class SavedStateViewModelFactory extends ViewModelProvider.KeyedFactory {
    ...
    public <T extends C0534ViewModel> T create(String str, Class<T> cls) {
        ...
        if (isAssignableFrom) {
            try {
                ...
                if (application != null) {
                    t = (C0534ViewModel) constructor.newInstance(new Object[]{application, create.getHandle()});
        ...
        t = (C0534ViewModel) constructor.newInstance(new Object[]{create.getHandle()});
        t.setTagIfAbsent("androidx.lifecycle.savedstate.vm.tag", create);
        return t;
    }
