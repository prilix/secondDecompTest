...
public class ViewModelProvider {
    ...
    public interface Factory {
        <T extends C0534ViewModel> T create(Class<T> cls);
    }

    static class OnRequeryFactory {
        /* access modifiers changed from: package-private */
        public void onRequery(C0534ViewModel viewModel) {
        }
    ...
    static abstract class KeyedFactory extends OnRequeryFactory implements Factory {
        public abstract <T extends C0534ViewModel> T create(String str, Class<T> cls);
    ...
    public <T extends C0534ViewModel> T get(Class<T> cls) {
    ...
    public <T extends C0534ViewModel> T get(String str, Class<T> cls) {
        T t;
    ...
    public static class NewInstanceFactory implements Factory {
        ...
        public <T extends C0534ViewModel> T create(Class<T> cls) {
            try {
                return (C0534ViewModel) cls.newInstance();
    ...
    public static class AndroidViewModelFactory extends NewInstanceFactory {
        ...
        public <T extends C0534ViewModel> T create(Class<T> cls) {
            ...
            try {
                return (C0534ViewModel) cls.getConstructor(new Class[]{Application.class}).newInstance(new Object[]{this.mApplication});
