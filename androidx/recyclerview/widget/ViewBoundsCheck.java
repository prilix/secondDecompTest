...
class ViewBoundsCheck {
    ...
    /* renamed from: GT */
    static final int f113GT = 1;

    /* renamed from: LT */
    static final int f114LT = 4;
    ...
    static class BoundFlags {
        ...
        public boolean boundsMatch() {
            ...
            if ((i3 & C1662R2.C1663color.m3_sys_color_light_on_surface) != 0 && (i3 & (compare(this.mChildEnd, this.mRvStart) << 8)) == 0) {
                return false;
            }
