...
import androidx.recyclerview.C0662R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0662R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0662R.styleable.RecyclerView, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0662R.styleable.RecyclerView, attributeSet, obtainStyledAttributes, i, 0);
        String string = obtainStyledAttributes.getString(C0662R.styleable.RecyclerView_layoutManager);
        if (obtainStyledAttributes.getInt(C0662R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(C0662R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z2 = obtainStyledAttributes.getBoolean(C0662R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z2;
        if (z2) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0662R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0662R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0662R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0662R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
    ...
    public View focusSearch(View view, int i) {
        ...
        if (!z3 || !(i == 2 || i == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
                int i2 = i == 2 ? C1662R2.attr.backgroundInsetBottom : 33;
    ...
    public final class Recycler {
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                if ((RecyclerView.this.mAdapter != null && doesTransientStatePreventRecycling && RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder)) || viewHolder.isRecyclable()) {
                    if (this.mViewCacheMax <= 0 || viewHolder.hasAnyOfTheFlags(C1662R2.attr.flow_firstHorizontalStyle)) {
                        z = false;
                    } else {
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            if (indexOfChild != -1) {
                ...
                childViewHolderInt.addFlags(C1662R2.string.country_uganda_number);
                return childViewHolderInt;
            }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH vh, int i) {
            ...
            if (z) {
                ...
                vh.setFlags(1, C1662R2.attr.floatingActionButtonLargeTertiaryStyle);
        ...
        public boolean canRestoreState() {
            int i = C07077.f111x3d106619[this.mStateRestorationPolicy.ordinal()];
            if (i == 1) {
                return false;
            }
    ...
    static /* synthetic */ class C07077 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f111x3d106619     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.RecyclerView.C07077.<clinit>():void");
        }
    }
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C07081 r0 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
            ...
            C07092 r1 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
                    return LayoutManager.this.getChildAt(i);
                }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0662R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0662R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0662R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0662R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0662R.styleable.RecyclerView_stackFromEnd, false);
            obtainStyledAttributes.recycle();
            return properties;
        }
    ...
    public int getAdapterPositionInRecyclerView(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(C1662R2.attr.floatingActionButtonTertiaryStyle) || !viewHolder.isBound()) {
            return -1;
        }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0662R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0662R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0662R.dimen.fastscroll_margin));
    }
