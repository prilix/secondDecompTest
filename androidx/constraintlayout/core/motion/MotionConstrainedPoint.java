            ...
            switch (c) {
                ...
                default:
                    if (!next.startsWith("CUSTOM")) {
                        C0181Utils.loge("MotionPaths", "UNKNOWN spline " + next);
                        break;
                    } else {
                        ...
                        if (!this.mCustomVariable.containsKey(str)) {
                            ...
                            if (!(splineSet instanceof SplineSet.CustomSpline)) {
                                C0181Utils.loge("MotionPaths", next + " ViewSpline not a CustomSet frame = " + i + ", value" + customVariable.getValueToInterpolate() + splineSet);
                                break;
                            } else {
