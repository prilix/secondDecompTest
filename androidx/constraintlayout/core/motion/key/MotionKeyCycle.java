...
public class MotionKeyCycle extends MotionKey {
    ...
    public void printAttributes() {
        ...
        C0181Utils.log(" ------------- " + this.mFramePosition + " -------------");
        C0181Utils.log("MotionKeyCycle{Shape=" + this.mWaveShape + ", Period=" + this.mWavePeriod + ", Offset=" + this.mWaveOffset + ", Phase=" + this.mWavePhase + '}');
        String[] strArr = (String[]) hashSet.toArray(new String[0]);
        for (int i = 0; i < strArr.length; i++) {
            TypedValues.AttributesType.CC.getId(strArr[i]);
            C0181Utils.log(strArr[i] + ":" + getValue(strArr[i]));
        }
    }
}
