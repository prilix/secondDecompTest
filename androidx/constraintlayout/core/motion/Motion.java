...
import androidx.constraintlayout.core.motion.utils.C0181Utils;
...
public class Motion implements TypedValues {
    ...
    private void insertKey(MotionPaths motionPaths) {
        ...
        if (binarySearch == 0) {
            C0181Utils.loge(TAG, " KeyPath position \"" + motionPaths.position + "\" outside of range");
        }
    ...
    public void setup(int r21, int r22, float r23, long r24) {
        ...
        L_0x042c:
            r16 = r3
            double[] r2 = java.util.Arrays.copyOf(r13, r12)
            java.lang.Object[] r3 = java.util.Arrays.copyOf(r14, r12)
            double[][] r3 = (double[][]) r3
