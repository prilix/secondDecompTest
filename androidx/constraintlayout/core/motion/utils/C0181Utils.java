...
/* renamed from: androidx.constraintlayout.core.motion.utils.Utils */
public class C0181Utils {
    static DebugHandle ourHandle;

    /* renamed from: androidx.constraintlayout.core.motion.utils.Utils$DebugHandle */
    ...
    public static void socketSend(String str) {
        try {
            OutputStream outputStream = new Socket("127.0.0.1", C1662R2.C1665id.outline).getOutputStream();
