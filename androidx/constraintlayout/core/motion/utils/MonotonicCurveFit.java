...
public class MonotonicCurveFit extends CurveFit {
    ...
    public MonotonicCurveFit(double[] dArr, double[][] dArr2) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            for (int i6 = 0; i6 < length2; i6++) {
                if (dArr5[i5][i6] == C1030Utils.DOUBLE_EPSILON) {
                    dArr6[i5][i6] = 0.0d;
                    dArr6[i5 + 1][i6] = 0.0d;
                } else {
    ...
    public double getPos(double d, int i) {
        ...
        if (this.mExtrapolate) {
            if (d <= dArr[0]) {
                return this.f31mY[0][i2] + ((d - dArr[0]) * getSlope(dArr[0], i2));
            }
            int i4 = length - 1;
            if (d >= dArr[i4]) {
                return this.f31mY[i4][i2] + ((d - dArr[i4]) * getSlope(dArr[i4], i2));
            }
        } else if (d <= dArr[0]) {
            return this.f31mY[0][i2];
        } else {
            int i5 = length - 1;
            if (d >= dArr[i5]) {
                return this.f31mY[i5][i2];
            }
        }
        while (i3 < length - 1) {
            double[] dArr2 = this.f30mT;
            if (d == dArr2[i3]) {
                return this.f31mY[i3][i2];
            }
            int i6 = i3 + 1;
            if (d < dArr2[i6]) {
