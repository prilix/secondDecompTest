...
public class Layer extends ConstraintHelper {
    ...
    public void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0219R.styleable.ConstraintLayout_Layout_android_visibility) {
                    this.mApplyVisibilityOnAttach = true;
                } else if (index == C0219R.styleable.ConstraintLayout_Layout_android_elevation) {
    ...
    private void transform() {
        if (this.mContainer != null) {
            ...
            calcCenters();
            double radians = Float.isNaN(this.mGroupRotateAngle) ? C1030Utils.DOUBLE_EPSILON : Math.toRadians((double) this.mGroupRotateAngle);
