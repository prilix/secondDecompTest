...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        ...
        Location lastKnownLocationForProvider = PermissionChecker.checkSelfPermission(this.mContext, Constants.GrantedPermissions.ACCESS_COARSE_LOCATION) == 0 ? getLastKnownLocationForProvider("network") : null;
        if (PermissionChecker.checkSelfPermission(this.mContext, Constants.GrantedPermissions.ACCESS_FINE_LOCATION) == 0) {
