...
public class AdaptedFunctionReference implements FunctionBase, Serializable {
    ...
    public int hashCode() {
        ...
        return ((((((((((hashCode + i) * 31) + this.name.hashCode()) * 31) + this.signature.hashCode()) * 31) + (this.isTopLevel ? C1662R2.attr.trackColorInactive : C1662R2.attr.transformPivotTarget)) * 31) + this.arity) * 31) + this.flags;
    }
