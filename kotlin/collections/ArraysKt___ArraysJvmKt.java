...
class ArraysKt___ArraysJvmKt extends ArraysKt__ArraysKt {
    ...
    public static final <T> T[] plus(T[] tArr, T t) {
        ...
        copyOf[length] = t;
        Intrinsics.checkNotNullExpressionValue(copyOf, Constants.Meta.RESULT);
        return copyOf;
    }
