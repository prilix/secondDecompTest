...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x00bb, code lost:
        kotlin.p013io.CloseableKt.closeFinally(r0, r11);
     */
    ...
    public static final byte[] readBytes(java.io.File r11) {
        /*
            ...
            r2 = r0
            java.io.FileInputStream r2 = (java.io.FileInputStream) r2     // Catch:{ all -> 0x00b8 }
            long r3 = r11.length()     // Catch:{ all -> 0x00b8 }
            ...
            int r4 = (int) r3
            byte[] r3 = new byte[r4]     // Catch:{ all -> 0x00b8 }
            r5 = 0
            r6 = r4
            r8 = 0
        L_0x0027:
            if (r6 <= 0) goto L_0x0033
            int r9 = r2.read(r3, r8, r6)     // Catch:{ all -> 0x00b8 }
        ...
        L_0x0033:
            ...
            byte[] r3 = java.util.Arrays.copyOf(r3, r8)     // Catch:{ all -> 0x00b8 }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r3, r9)     // Catch:{ all -> 0x00b8 }
            goto L_0x0074
        L_0x003f:
            int r6 = r2.read()     // Catch:{ all -> 0x00b8 }
            r8 = -1
            if (r6 != r8) goto L_0x0047
            goto L_0x0074
        L_0x0047:
            kotlin.io.ExposingBufferByteArrayOutputStream r8 = new kotlin.io.ExposingBufferByteArrayOutputStream     // Catch:{ all -> 0x00b8 }
            r10 = 8193(0x2001, float:1.1481E-41)
            r8.<init>(r10)     // Catch:{ all -> 0x00b8 }
            r8.write(r6)     // Catch:{ all -> 0x00b8 }
            java.io.InputStream r2 = (java.io.InputStream) r2     // Catch:{ all -> 0x00b8 }
            r6 = r8
            java.io.OutputStream r6 = (java.io.OutputStream) r6     // Catch:{ all -> 0x00b8 }
            r10 = 2
            kotlin.p013io.ByteStreamsKt.copyTo$default(r2, r6, r5, r10, r1)     // Catch:{ all -> 0x00b8 }
            int r2 = r8.size()     // Catch:{ all -> 0x00b8 }
            int r2 = r2 + r4
            if (r2 < 0) goto L_0x0078
            byte[] r11 = r8.getBuffer()     // Catch:{ all -> 0x00b8 }
            byte[] r2 = java.util.Arrays.copyOf(r3, r2)     // Catch:{ all -> 0x00b8 }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r9)     // Catch:{ all -> 0x00b8 }
            int r3 = r8.size()     // Catch:{ all -> 0x00b8 }
            byte[] r3 = kotlin.collections.ArraysKt.copyInto((byte[]) r11, (byte[]) r2, (int) r4, (int) r5, (int) r3)     // Catch:{ all -> 0x00b8 }
        L_0x0074:
        ...
        L_0x0078:
            ...
            r2.append(r11)     // Catch:{ all -> 0x00b8 }
            java.lang.String r11 = r2.toString()     // Catch:{ all -> 0x00b8 }
            r1.<init>(r11)     // Catch:{ all -> 0x00b8 }
    ...
    public static final java.lang.String readText(java.io.File r1, java.nio.charset.Charset r2) {
        /*
            ...
            java.lang.String r0 = kotlin.p013io.TextStreamsKt.readText(r0)     // Catch:{ all -> 0x0029 }
            kotlin.p013io.CloseableKt.closeFinally(r1, r2)
            return r0
        L_0x0029:
            r2 = move-exception
    ...
    public static /* synthetic */ java.lang.Object useLines$default(java.io.File r1, java.nio.charset.Charset r2, kotlin.jvm.functions.Function1 r3, int r4, java.lang.Object r5) {
        ...
        L_0x0032:
            ...
            kotlin.sequences.Sequence r0 = kotlin.p013io.TextStreamsKt.lineSequence(r0)     // Catch:{ all -> 0x0058 }
    ...
    public static final <T> T useLines(java.io.File r3, java.nio.charset.Charset r4, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<java.lang.String>, ? extends T> r5) {
        ...
        L_0x002c:
            ...
            kotlin.sequences.Sequence r2 = kotlin.p013io.TextStreamsKt.lineSequence(r2)     // Catch:{ all -> 0x0053 }
