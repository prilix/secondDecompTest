...
public final class CombinedContext implements CoroutineContext, Serializable {
    ...
    public <E extends CoroutineContext.Element> E get(CoroutineContext.Key<E> key) {
        ...
        while (true) {
            E e = combinedContext2.element.get(key);
            if (e != null) {
                return e;
            }
    ...
    public boolean equals(Object obj) {
        ...
        if (this != obj) {
            if (obj instanceof CombinedContext) {
                CombinedContext combinedContext2 = (CombinedContext) obj;
                if (combinedContext2.size() != size() || !combinedContext2.containsAll(this)) {
                    return false;
                }
            }
            return false;
    ...
    @Metadata(mo36737d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0002\u0018\u0000 \f2\u00060\u0001j\u0002`\u0002:\u0001\fB\u0013\u0012\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\u0002\u0010\u0006J\b\u0010\n\u001a\u00020\u000bH\u0002R\u0019\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\n\n\u0002\u0010\t\u001a\u0004\b\u0007\u0010\b¨\u0006\r"}, mo36738d2 = {"Lkotlin/coroutines/CombinedContext$Serialized;", "Ljava/io/Serializable;", "Lkotlin/io/Serializable;", "elements", "", "Lkotlin/coroutines/CoroutineContext;", "([Lkotlin/coroutines/CoroutineContext;)V", "getElements", "()[Lkotlin/coroutines/CoroutineContext;", "[Lkotlin/coroutines/CoroutineContext;", "readResolve", "", "Companion", "kotlin-stdlib"}, mo36739k = 1, mo36740mv = {1, 5, 1})
    /* compiled from: CoroutineContextImpl.kt */
    private static final class Serialized implements Serializable {
        ...
        @Metadata(mo36737d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo36738d2 = {"Lkotlin/coroutines/CombinedContext$Serialized$Companion;", "", "()V", "serialVersionUID", "", "kotlin-stdlib"}, mo36739k = 1, mo36740mv = {1, 5, 1})
        /* compiled from: CoroutineContextImpl.kt */
