...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    public static final double log(double d, double d2) {
        if (d2 <= C1030Utils.DOUBLE_EPSILON || d2 == 1.0d) {
            return Double.NaN;
        }
    ...
    /* renamed from: ln */
    private static final double m712ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m713ln(float f) {
