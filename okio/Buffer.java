...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
        ...
        while (true) {
            ...
            if (i11 < 0) {
                ...
                while (true) {
                    int i15 = i6 + 1;
                    int i16 = i12 + 1;
                    if ((bArr[i6] & UByte.MAX_VALUE) != trie$jvm[i12]) {
                        return i9;
                    }
                    boolean z2 = i16 == i14;
                    if (i15 == i7) {
                    ...
                    while (i < i2) {
                        ...
                        if (charAt < 128) {
                            ...
                            if (charAt < 2048) {
                                ...
                                writableSegment$jvm2.data[writableSegment$jvm2.limit] = (byte) ((charAt >> 6) | C1662R2.attr.buttonBarStyle);
                                ...
                                writableSegment$jvm3.data[writableSegment$jvm3.limit] = (byte) ((charAt >> 12) | C1662R2.attr.carousel_touchUpMode);
                                ...
                                if (charAt > 56319 || 56320 > c || 57343 < c) {
                                    ...
                                    writableSegment$jvm4.data[writableSegment$jvm4.limit] = (byte) ((i6 >> 18) | C1662R2.attr.checkedTextViewStyle);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writableSegment$jvm.data[writableSegment$jvm.limit] = (byte) ((i >> 6) | C1662R2.attr.buttonBarStyle);
            ...
            writableSegment$jvm2.data[writableSegment$jvm2.limit] = (byte) ((i >> 12) | C1662R2.attr.carousel_touchUpMode);
            ...
            writableSegment$jvm3.data[writableSegment$jvm3.limit] = (byte) ((i >> 18) | C1662R2.attr.checkedTextViewStyle);
    ...
    public Buffer writeDecimalLong(long j) {
        ...
        } else if (j >= Constants.VALID_WIFI_CONNECTION_CHECK_TIMEOUT) {
        ...
        if (byteString.size() > 0) {
            ...
            if (z) {
                ...
                if (segment == null) {
                    ...
                    long j8 = (buffer.size - ((long) size4)) + 1;
                    Segment segment4 = segment;
                    while (j3 < j8) {
                        byte[] bArr2 = segment4.data;
                        long j9 = j8;
                        int min2 = (int) Math.min((long) segment4.limit, (((long) segment4.pos) + j8) - j3);
                        for (int i2 = (int) ((((long) segment4.pos) + j2) - j3); i2 < min2; i2++) {
                            if (bArr2[i2] == b2) {
                                if (rangeEquals(segment4, i2 + 1, internalArray$jvm2, 1, size4)) {
                                    return ((long) (i2 - segment4.pos)) + j3;
                                }
                            }
                        }
                        j3 += (long) (segment4.limit - segment4.pos);
    ...
    public final ByteString snapshot(int i) {
        return i == 0 ? ByteString.EMPTY : SegmentedByteString.Companion.mo40891of(this, i);
    }
    ...
    public final byte m3156deprecated_getByte(long j) {
        return getByte(j);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m3157deprecated_size() {
        return this.size;
    }

    @Metadata(mo36736bv = {1, 0, 2}, mo36737d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0010\u001a\u00020\u0011H\u0016J\u000e\u0010\u0012\u001a\u00020\n2\u0006\u0010\u0013\u001a\u00020\bJ\u0006\u0010\u0014\u001a\u00020\bJ\u000e\u0010\u0015\u001a\u00020\n2\u0006\u0010\u0016\u001a\u00020\nJ\u000e\u0010\u0017\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nR\u0014\u0010\u0003\u001a\u0004\u0018\u00010\u00048\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\u0004\u0018\u00010\u00068\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0007\u001a\u00020\b8\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\t\u001a\u00020\n8\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000b\u001a\u00020\f8\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\r\u001a\u0004\u0018\u00010\u000eX\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000f\u001a\u00020\b8\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000¨\u0006\u0018"}, mo36738d2 = {"Lokio/Buffer$UnsafeCursor;", "Ljava/io/Closeable;", "()V", "buffer", "Lokio/Buffer;", "data", "", "end", "", "offset", "", "readWrite", "", "segment", "Lokio/Segment;", "start", "close", "", "expandBuffer", "minByteCount", "next", "resizeBuffer", "newSize", "seek", "jvm"}, mo36739k = 1, mo36740mv = {1, 1, 11})
    /* compiled from: Buffer.kt */
    ...
    @Metadata(mo36736bv = {1, 0, 2}, mo36737d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo36738d2 = {"Lokio/Buffer$Companion;", "", "()V", "DIGITS", "", "jvm"}, mo36739k = 1, mo36740mv = {1, 1, 11})
    /* compiled from: Buffer.kt */
