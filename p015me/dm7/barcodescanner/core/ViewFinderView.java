...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private static final int[] SCANNER_ALPHA = {0, 64, 128, C1662R2.attr.buttonBarStyle, 255, C1662R2.attr.buttonBarStyle, 128, 64};
    private static final String TAG = "ViewFinderView";
    protected int mBorderLineLength;
    protected Paint mBorderPaint;
    private float mBordersAlpha;
    private final int mDefaultBorderColor = getResources().getColor(C2957R.C2958color.viewfinder_border);
    private final int mDefaultBorderLineLength = getResources().getInteger(C2957R.integer.viewfinder_border_length);
    private final int mDefaultBorderStrokeWidth = getResources().getInteger(C2957R.integer.viewfinder_border_width);
    private final int mDefaultLaserColor = getResources().getColor(C2957R.C2958color.viewfinder_laser);
    private final int mDefaultMaskColor = getResources().getColor(C2957R.C2958color.viewfinder_mask);
    ...
    public synchronized void updateFramingRect() {
        ...
        int i4 = (point.x - i2) / 2;
        int i5 = (point.y - i) / 2;
        int i6 = this.mViewFinderOffset;
        this.mFramingRect = new Rect(i4 + i6, i5 + i6, (i4 + i2) - i6, (i5 + i) - i6);
    }
}
