...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private Point convertSizeToLandscapeOrientation(Point point) {
        if (getDisplayOrientation() % C1662R2.attr.boxCornerRadiusTopStart == 0) {
            return point;
        }
    ...
    public int getDisplayOrientation() {
        ...
        if (rotation != 0) {
            if (rotation == 1) {
                ...
                i = C1662R2.attr.boxCornerRadiusTopStart;
            } else if (rotation == 3) {
                i = C1662R2.attr.circleCrop;
            }
        }
        if (cameraInfo.facing == 1) {
            return (360 - ((cameraInfo.orientation + i) % C1662R2.attr.contentInsetEndWithActions)) % C1662R2.attr.contentInsetEndWithActions;
        }
        return ((cameraInfo.orientation - i) + C1662R2.attr.contentInsetEndWithActions) % C1662R2.attr.contentInsetEndWithActions;
    }
