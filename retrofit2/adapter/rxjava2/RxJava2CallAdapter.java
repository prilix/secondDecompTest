...
final class RxJava2CallAdapter<R> implements CallAdapter<R, Object> {
    ...
    public java.lang.Object adapt(retrofit2.Call<R> r2) {
        ...
        L_0x002c:
            ...
            io.reactivex.BackpressureStrategy r2 = p012io.reactivex.BackpressureStrategy.LATEST
        ...
        L_0x0049:
            ...
            return r2
        L_0x0052:
            io.reactivex.Observable r2 = p012io.reactivex.plugins.RxJavaPlugins.onAssembly(r0)
            return r2
        */
