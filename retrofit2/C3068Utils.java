...
final class C3068Utils {
    ...
    static java.lang.reflect.Type resolve(java.lang.reflect.Type r8, java.lang.Class<?> r9, java.lang.reflect.Type r10) {
        ...
        L_0x00cb:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: retrofit2.C3068Utils.resolve(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type):java.lang.reflect.Type");
    }
    ...
    static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        ParameterizedTypeImpl(@Nullable Type type, Type type2, Type... typeArr) {
            ...
            for (Type type3 : typeArr) {
                ...
                C3068Utils.checkNotPrimitive(type3);
            }
            this.ownerType = type;
            this.rawType = type2;
        ...
        public boolean equals(Object obj) {
            return (obj instanceof ParameterizedType) && C3068Utils.equals(this, (ParameterizedType) obj);
        }
        ...
        public String toString() {
            ...
            if (typeArr.length == 0) {
                return C3068Utils.typeToString(this.rawType);
            }
            StringBuilder sb = new StringBuilder((typeArr.length + 1) * 30);
            sb.append(C3068Utils.typeToString(this.rawType));
            sb.append("<");
            sb.append(C3068Utils.typeToString(this.typeArguments[0]));
            for (int i = 1; i < this.typeArguments.length; i++) {
                sb.append(", ");
                sb.append(C3068Utils.typeToString(this.typeArguments[i]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    private static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public boolean equals(Object obj) {
            return (obj instanceof GenericArrayType) && C3068Utils.equals(this, (GenericArrayType) obj);
        }
        ...
        public String toString() {
            return C3068Utils.typeToString(this.componentType) + HttpUrl.PATH_SEGMENT_ENCODE_SET_URI;
        }
    }
    ...
    private static final class WildcardTypeImpl implements WildcardType {
        ...
        WildcardTypeImpl(Type[] typeArr, Type[] typeArr2) {
            if (typeArr2.length > 1) {
                ...
                C3068Utils.checkNotPrimitive(typeArr2[0]);
                ...
                C3068Utils.checkNotPrimitive(typeArr[0]);
        ...
        public Type[] getLowerBounds() {
            ...
            if (type == null) {
                return C3068Utils.EMPTY_TYPE_ARRAY;
            }
            return new Type[]{type};
        }

        public boolean equals(Object obj) {
            return (obj instanceof WildcardType) && C3068Utils.equals(this, (WildcardType) obj);
        }
        ...
        public String toString() {
            if (this.lowerBound != null) {
                return "? super " + C3068Utils.typeToString(this.lowerBound);
            } else if (this.upperBound == Object.class) {
                return "?";
            } else {
                return "? extends " + C3068Utils.typeToString(this.upperBound);
            }
        }
    }
